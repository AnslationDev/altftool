...
// `slug` arrives as a prop from the server page (which needs it anyway to build
// the page's JSON-LD) instead of useParams, so the two never disagree.
export default function StudioToolClient({ slug }) {
