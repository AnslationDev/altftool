...
export default function ResultsPage() {
  ...
  useEffect(() => {
    ...
    if (!results.length) {
      router.replace("/tripfindbox/search/no-results");
    }
    ...
    <main className="results-found-page">
      ...
      <section className="results-shell">
        <aside className="results-filter-panel">
          <Link href="/tripfindbox" className="results-modify-link"><ArrowLeft size={16} /> Modify Search</Link>
                  ...
                  <div className="found-price-panel">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        router.push("/tripfindbox/travel/details");
                      }}
                    >
                      Select
                    </button>
