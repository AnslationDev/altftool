...
import { loadSelectedTravel } from "@/app/tripfindbox/lib/searchSession";
  ...
  return (
    <main className="flow-page booking-page">
      <header className="flow-header">
        <Link href="/tripfindbox/travel/details" className="flow-back"><ArrowLeft size={18} /> Back to details</Link>
        <div>
