...
//
// TripFindBox is integrated into AltFTool as a sub-route under "/tripfindbox".
...
//
// tfbPath() rewrites internal absolute paths to live under /tripfindbox, while
...
export const TFB_BASE = "/tripfindbox";
