...
import { closeAllBookingPopups } from "@/app/tripfindbox/lib/bookingPopupBus";
import { saveSearchCriteria } from "@/app/tripfindbox/lib/searchSession";
...
export default function FlightSearchBox({ compact = false, initialCriteria = null, onSearchSubmit }) {
  ...
  const handleSearch = async () => {
    ...
    router.push("/tripfindbox/search/loading");
  };
