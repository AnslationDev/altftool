import { Expand, Minus, Move, Plus } from "lucide-react";

export default function BottomBar({ zoom, tool, onZoomOut, onZoomIn, onFitToScreen, onToggleSelectMode, onFullscreen }) {
  return (
