...
export default function EventCarousel() {
  ...
  return (
    <section className="section bg-[var(--background)] text-[var(--foreground)] animate-scale-up">
      ...
      {/* Slider */}
      <div className="relative mt-4 md:mt-6 lg:mt-8 xl:mt-10 animate-slide-right">
