        ...
        <section className="section animate-slide-up">
            ...
            <div className="mb-8">
                ...
                <p className="section-subtitle !mx-0 text-left">
                    Behind our recommendations is a team of experienced professionals with deep knowledge across the industries we cover. </p>
            </div>
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    <div className="flex gap-1">
                                        {Array.from({ length: 5 }).map((_, i) => (
                                            <Star
                                                key={i}
                                                className={`w-4 h-4 sm:w-3 sm:h-3 xl:w-5 xl:h-5 ${i < item.rating
