...
export default function HtmlToPdf() {
  ...
  const handleFileChange = (e) => {
    ...
    if (!selectedFile.name.match(/\.html?$/i)) {
      resetResult();
      setResult({ error: "Please select a valid .html or .htm file." });
      return;
    }
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setProgress(30);
      setStatusText("Preparing layout and compiling resources...");
      ...
      if (isFullHtml) {
        ...
        fullHtml = `
          ...
          <html>
            ...
            <body>
              <div style="padding: 24px; box-sizing: border-box; line-height: 1.5;">
                ${htmlContent}
              </div>
            </body>
          </html>
      ...
      // Wait a bit to ensure styles and scripts run/apply
...
<div
          ...
          >
            ...
            <p className="dz-hint">
              Convert local HTML files or pasted HTML code into a PDF document
            </p>
...
<input
      ...
      {(file || rawHtml.trim()) && (
        ...
        >
          ...
          >
            <div className="cg">
              <label className="lbl">Paper Format Size:</label>
            ...
            <div className="cg">
              <label className="lbl">Orientation Style:</label>
