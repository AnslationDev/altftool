...
export default async function BlogDetailPage({ params }) {
  ...
  // Keep structured data aligned with the meta description. Otherwise an
  // overridden post would ship authored metadata beside the old, truncated
  // body fragment in BlogPosting and HowTo JSON-LD.
  const seoOverride = getBlogSeoOverride(slug);
  const articleDescription =
    seoOverride?.description || getBlogDescription(initialBlog);
