...
function HeroArticle({ post }) {
  ...
  return (
    <Link
      ...
      prefetch={false}
      className="group grid overflow-hidden rounded-[var(--anslation-ds-radius-lg)] border border-(--border) bg-(--card) shadow-[var(--anslation-ds-shadow-md)] lg:grid-cols-[1.16fr_0.84fr]"
    >
      <div className="relative min-h-[280px] overflow-hidden bg-(--muted) sm:min-h-[340px] lg:min-h-[430px]">
        <Image
          src={post.image}
      ...
      <div className="flex flex-col justify-between gap-8 p-5 sm:p-7 lg:p-8">
        <div>
          <div className="mb-4 flex flex-wrap items-center gap-2 text-xs font-medium text-(--muted-foreground)">
            <span className="inline-flex h-7 items-center rounded-[var(--anslation-ds-radius)] bg-(--muted) px-2.5 text-(--primary)">
              {post.category}
            </span>
  ...
  return (
    <main className="bg-(--background) text-(--foreground)">
      ...
      <div className="mx-auto w-full max-w-[1500px] px-3 py-6 sm:px-5 md:py-8 lg:px-8">
          ...
          <div className="mb-4 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-(--muted-foreground) sm:text-base">
                Clean, practical articles for tools, deals, students, creators, and digital productivity. Built to load fast first, then quietly refresh from Firebase.
              </p>
            </div>
        ...
        <section className="mt-10 rounded-[var(--anslation-ds-radius-lg)] border border-(--border) bg-(--card) p-4 shadow-[var(--anslation-ds-shadow-sm)] md:p-5">
          <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 text-xs font-medium text-(--muted-foreground)">
              ...
              Search, filter, and auto-load in chunks
            </div>
          </div>
