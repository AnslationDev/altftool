          ...
          {categories.map((category) => {
            ...
            return (
              <Link
                key={category.href}
                href={category.href}
                className="group flex min-h-36 items-start gap-4 rounded-lg border border-border bg-card p-4 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-primary hover:shadow-md motion-reduce:transform-none focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/30"
              >
