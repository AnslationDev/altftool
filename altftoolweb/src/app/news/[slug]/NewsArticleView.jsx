...
import {
  Heart, Bookmark, Clock, MapPin, ArrowLeft, Link2,
...
export default function NewsArticleView({ article, relatedNews }) {
  ...
  // Use local component dynamically loaded from data.json or fallback
