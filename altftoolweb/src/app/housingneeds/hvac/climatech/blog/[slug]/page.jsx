...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `/housingneeds/hvac/climatech/blog/${article.slug}` },
  };
}
...
export default async function BlogPage({ params }) {
  ...
  const relatedServices = [
    { title: "AC Repair", href: "/housingneeds/hvac/climatech#services" },
    { title: "Heating Installation", href: "/housingneeds/hvac/climatech#services" },
    { title: "Air Duct Cleaning", href: "/housingneeds/hvac/climatech#services" },
    { title: "HVAC Maintenance", href: "/housingneeds/hvac/climatech#services" },
    { title: "Smart Thermostat Setup", href: "/housingneeds/hvac/climatech#services" },
    { title: "Emergency HVAC Service", href: "/housingneeds/hvac/climatech#services" },
  ];
  ...
  return (
    <main className="bg-[#F7F3EB] min-h-screen text-[#1a1a1a] overflow-x-hidden font-sans">
            ...
            <aside className="space-y-8 lg:sticky lg:top-28">
              ...
              <div className="bg-[#EFE6D6] border border-[#D4C9B5]/60 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                  <Link
                    href="/housingneeds/hvac/climatech#contact"
      ...
      <section
        ...
        style={{ backgroundImage: `url('${hvacMedia.feature}')` }}
      >
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="font-serif-display text-lg font-medium text-[#1a1a1a] mb-4 line-clamp-2 hover:text-[#5a6f8a] transition-colors duration-200">
                    <Link href={`/housingneeds/hvac/climatech/blog/${blog.slug}`}>
                      {blog.title}
                    </Link>
                  </h3>
