...
export default function Services() {
  return (
    <section id="services" className="relative pb-6 pt-4 lg:pb-8 lg:pt-6 bg-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((s, i) => (
            <motion.article
              ...
              className="group relative rounded-2xl overflow-hidden bg-white border border-slate-100 shadow-[0_4px_20px_rgba(13,59,102,0.06)] hover:shadow-premium transition-all"
            >
              <div className="relative h-56 overflow-hidden">
                ...
                <span className="absolute top-4 left-4 px-3 py-1 rounded-full bg-white/90 backdrop-blur text-[10px] font-bold tracking-wider uppercase text-[#0D3B66]">
                  {s.tag}
                </span>
              </div>
              <div className="p-6 lg:p-7">
                <h3 className="font-display font-bold text-xl text-[#0D3B66]">{s.title}</h3>
