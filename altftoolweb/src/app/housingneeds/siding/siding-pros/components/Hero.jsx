    ...
    <section id="home" className="relative min-h-screen overflow-hidden bg-[#0D3B66]">
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 pt-36 pb-24 lg:pt-44 lg:pb-32 flex items-center justify-center text-center">
        ...
        >
          ...
          {/* Mini trust row */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-5 text-white/80 text-sm">
            ...
            <div className="flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-[#00AEEF]" /> BBB A+ Accredited</div>
            <div className="h-4 w-px bg-white/25" />
            <div className="flex items-center gap-2"><Award className="w-4 h-4 text-[#00AEEF]" /> Licensed & Insured</div>
          </div>
        </motion.div>
