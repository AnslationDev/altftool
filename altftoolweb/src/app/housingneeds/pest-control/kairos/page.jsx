...
const certificationStandards = [
  {
    name: "Inspection first",
    detail: "Identify the pest and affected area before selecting treatment.",
    icon: Search,
  },
  {
    name: "Safety review",
    detail: "Review products, access requirements, pets, and re-entry guidance.",
    icon: ShieldCheck,
  },
  {
    name: "Written plan",
    detail: "Document treatment scope, follow-up timing, and prevention steps.",
    icon: Award,
  },
];
    ...
    <main className="kairos-page">
      <header className="kairos-header">
        <a className="kairos-logo" href="#top" aria-label="ANSROS PEST CONTROL home">
          <span className="kairos-logo-mark">
            <ShieldCheck size={28} aria-hidden="true" />
            <span>ANSROS <strong>Pest Control</strong></span>
          </span>
        </a>
      ...
      <section className="kairos-warning-section" id="warning">
        <div className="kairos-warning-inner">
          <div className="kairos-warning-visual" aria-hidden="true">
            <Image
              src={termiteInspectionImage}
              alt="Termite damage inspection"
              width={1448}
              height={1086}
              className="kairos-warning-generated-image"
            />
            <span className="kairos-warning-badge" aria-label="Inspection-led treatment">
      ...
      <section className="kairos-certifications" aria-label="Certifications">
        ...
        <p>
          A useful pest-control quote should explain the inspection, treatment approach, safety guidance, and follow-up plan before work starts.
        </p>
        <div className="kairos-certification-grid">
          {certificationStandards.map((item) => {
            const Icon = item.icon;
            return (
            <div className="kairos-certification-logo-card" key={item.name}>
              <div className="kairos-certification-logo-inner">
                <Icon size={42} aria-hidden="true" />
              </div>
              <strong>{item.name}</strong>
              <span className="kairos-cert-name">{item.detail}</span>
            </div>
            );
          })}
        </div>
        ...
        <div className="kairos-footer-top">
          <div className="kairos-footer-brand">
            <div className="kairos-footer-logo-wrapper">
              <span className="kairos-footer-logo-img">ANSROS <strong>Pest Control</strong></span>
            </div>
