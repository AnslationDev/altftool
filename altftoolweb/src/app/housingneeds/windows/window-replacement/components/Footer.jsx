      ...
      <Container className="pb-10">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-stone-800 pt-7 text-xs text-stone-500 sm:flex-row">
          ...
          <div className="flex items-center gap-6">
            <NextLink href="/policypages/privacy" className="transition-colors hover:text-bronze-300">Privacy Policy</NextLink>
            <NextLink href="/policypages/termsandconditions" className="transition-colors hover:text-bronze-300">Terms of Service</NextLink>
            <Link to="/#services" className="transition-colors hover:text-bronze-300">Service details</Link>
          </div>
        </div>
      </Container>
    </footer>
