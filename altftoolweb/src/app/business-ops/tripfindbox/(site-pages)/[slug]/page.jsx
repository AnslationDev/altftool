import FlightSearchBox from "@/app/business-ops/tripfindbox/components/FlightSearchBox";
import FloatingCallIcon from "@/app/business-ops/tripfindbox/components/FloatingCallIcon";
...
import RouteBottomSlider from "@/app/business-ops/tripfindbox/components/RouteBottomSlider";
import SeoRouteDealsGrid from "@/app/business-ops/tripfindbox/components/SeoRouteDealsGrid";
import { getTripFindBoxContactInfo, telHref } from "@/app/business-ops/tripfindbox/lib/contactInfo";
import { getSitemapPage, sitemapPages } from "@/app/business-ops/tripfindbox/lib/sitemapPages";
...
export async function generateMetadata({ params }) {
  ...
  return createPageMetadata({
    ...
    path: `/business-ops/tripfindbox/${slug}`,
  });
}
      ...
      <section className="site-route-content">
        {!isSimpleUtilityPage ? (
          <nav className="site-route-breadcrumb" aria-label="Breadcrumb">
            <Link href="/business-ops/tripfindbox">Home</Link>
            <span>›</span>
            <Link href="/business-ops/tripfindbox/site-map">{category}</Link>
            <span>›</span>
