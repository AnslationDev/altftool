...
import { loadSearchCriteria, loadSearchResults, saveSearchCriteria, saveSearchResults, saveSelectedTravel } from "@/app/business-ops/tripfindbox/lib/searchSession";
import { searchTravelResults } from "@/app/business-ops/tripfindbox/lib/travelResults";
...
export default function ResultsPage() {
  ...
  useEffect(() => {
    ...
    if (!criteria) {
      router.replace("/business-ops/tripfindbox");
      return;
    }
    if (!results.length) {
      router.replace("/business-ops/tripfindbox/search/no-results");
    }
    ...
    <main className="results-found-page">
      ...
      <section className="results-shell">
        <aside className="results-filter-panel">
          <Link href="/business-ops/tripfindbox" className="results-modify-link"><ArrowLeft size={16} /> Modify Search</Link>
                  ...
                  <div className="found-price-panel">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        router.push("/business-ops/tripfindbox/travel/details");
                      }}
                    >
                      Select
                    </button>
