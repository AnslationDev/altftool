...
import { loadSearchCriteria, saveSearchResults } from "@/app/business-ops/tripfindbox/lib/searchSession";
...
export default function SearchLoadingPage() {
  ...
  useEffect(() => {
    ...
    const runSearch = async () => {
      ...
      router.replace(results.length ? "/business-ops/tripfindbox/search/results" : "/business-ops/tripfindbox/search/no-results");
    };
