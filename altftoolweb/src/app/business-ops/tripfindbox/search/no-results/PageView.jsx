...
import { loadSearchCriteria, saveSearchCriteria, saveSearchResults } from "@/app/business-ops/tripfindbox/lib/searchSession";
...
export default function NoResultsPage() {
  ...
  const runInlineSearch = async (nextCriteria) => {
    ...
    if (nextResults.length) {
      router.replace("/business-ops/tripfindbox/search/results");
    }
  };
