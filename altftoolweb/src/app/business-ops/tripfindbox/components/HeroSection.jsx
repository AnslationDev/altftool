...
import { fetchBlogPosts } from "@/app/business-ops/tripfindbox/lib/blogData";
import { fetchHomeContent, DEFAULT_HOME_CONTENT } from "@/app/business-ops/tripfindbox/lib/homeContent";
import { telHref } from "@/app/business-ops/tripfindbox/lib/contactInfo";
...
function Header({ header }) {
  ...
  return (
    <header className="nova-header">
      {/* Byline is a sibling of the brand link, not nested inside it. */}
    ...
    <>
      <footer id="support" className="nova-footer">
        <div className="tripnest-footer-newsletter">
          ...
          <small>{data.consentText} I have read and agree to the <Link href="/business-ops/tripfindbox/terms-and-conditions">Terms and Conditions</Link> and <Link href="/business-ops/tripfindbox/privacy-policy">Privacy Policy</Link>.</small>
        </div>
      ...
      <div className="tripnest-mobile-legal">
        ...
        <Link href="/business-ops/tripfindbox/terms-and-conditions">Terms of Use</Link>
      </div>
    </>
  );
}
