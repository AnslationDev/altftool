...
import { loadSearchCriteria, loadSelectedTravel } from "@/app/business-ops/tripfindbox/lib/searchSession";
  ...
  return (
    <main className="flow-page details-page">
      <header className="flow-header">
        <Link href="/business-ops/tripfindbox/search/results" className="flow-back"><ArrowLeft size={18} /> Back to results</Link>
        <div>
      ...
      <section className="details-layout">
        ...
        <aside className="fare-summary-card">
          ...
          <Link href="/business-ops/tripfindbox/booking" className="primary-flow-button">Continue booking</Link>
        </aside>
