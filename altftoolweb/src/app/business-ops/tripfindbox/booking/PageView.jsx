...
import { loadSelectedTravel } from "@/app/business-ops/tripfindbox/lib/searchSession";
  ...
  return (
    <main className="flow-page booking-page">
      <header className="flow-header">
        <Link href="/business-ops/tripfindbox/travel/details" className="flow-back"><ArrowLeft size={18} /> Back to details</Link>
        <div>
