...
export const travelInsurance = {
  ...
  seo: {
    ...
    description:
      "Compare travel insurance plans from trusted providers in minutes. Cover trip cancellation, emergency medical care abroad, lost baggage and delays — free to compare.",
  },
};
