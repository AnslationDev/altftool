...
import HnReveal from "@/app/housingneeds/_components/HnReveal";
import HnFaq from "@/app/housingneeds/_components/HnFaq";
import HnHeadline from "@/app/housingneeds/_components/HnHeadline";
import HnImage from "@/app/housingneeds/_components/HnImage";
...
export default function InsurancePage({ slug }) {
  ...
  const breadcrumbJsonLd = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Business Ops", item: `${SITE_ORIGIN}/business-ops` },
