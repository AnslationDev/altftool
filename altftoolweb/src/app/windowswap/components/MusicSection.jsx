...
export default function MusicSection() {
  return (
    <section id="music" className="windowswap-music w-full bg-windowswap-teal py-20 px-6 sm:px-12 md:px-16 lg:px-20">
      <div className="max-w-[1360px] mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.56fr)] gap-12 lg:gap-14 items-start">
        ...
        <div className="windowswap-music-frame relative w-full max-w-[860px] aspect-[16/9] rounded-none overflow-hidden shadow-2xl bg-zinc-950 select-none">
          <iframe
        ...
        <div className="windowswap-music-copy flex flex-col items-start text-left lg:pt-10 lg:pl-4 max-w-[320px]">
          ...
          <span className="text-xs tracking-[0.3em] font-semibold text-white/90 uppercase mb-3">WINDOWSWAP PLAYLISTS</span>
          <div className="h-[1px] w-16 bg-white/30 mb-8" />

          <p className="font-serif text-[22px] md:text-[28px] text-windowswap-peach leading-[1.08] font-light mb-4 max-w-[250px]">
