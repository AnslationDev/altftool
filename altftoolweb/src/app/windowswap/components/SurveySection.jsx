  ...
  return (
    <section className="windowswap-survey windowswap-section w-full py-16 px-6 flex flex-col items-center text-center">
      ...
      <div className="windowswap-survey-illustration mb-6">
        <svg className="w-24 h-24 text-windowswap-peach" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Coffee Cup */}
          ...
          <path d="M84 45C86 43 89 43 91 45C93 47 93 50 91 52L84 59L77 52C75 50 75 47 77 45C79 43 82 43 84 45Z" fill="currentColor" className="text-windowswap-cream opacity-80" />
        </svg>
      </div>
