...
export default function DesignToolCardHorizontal({ tool, index = 0, onClick, className = "" }) {
  ...
  return (
    <div
      className={`group relative flex w-full gap-4 sm:gap-5 rounded-2xl bg-gradient-to-b from-white/70 to-[#fbfaff]/70 dark:from-[#1b1733]/85 dark:to-[#15122a]/85 p-4 sm:p-5 transition-shadow ${CARD_SHADOW} ${className}`}
    >
