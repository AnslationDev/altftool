...
export default function SequenceMemory({ onComplete, beep }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <StatsChart data={DIST} xLabel="Sequence length reached" title="Population Score Distribution" subtitle="Illustrative example distribution, not measured from real users" />
      <AboutCard {...ABOUT} />
    </div>
  );
}
