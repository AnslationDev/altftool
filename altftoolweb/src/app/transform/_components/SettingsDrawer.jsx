        ...
        >
          {checked ? (
            <svg viewBox="0 0 20 20" fill="none" className="h-3.5 w-3.5">
              <path d="M5 10.5l3.2 3.2L15 6.5" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ) : null}
        </span>
        {option.label}
      ...
      <label className="flex items-center gap-2.5 text-sm font-medium text-(--foreground)">
        ...
        <div className="relative">
          <select
            ...
            suppressHydrationWarning
            className="appearance-none rounded-xl border border-(--border) bg-(--card) py-2 pl-3.5 pr-9 text-sm font-medium text-(--foreground) shadow-sm outline-none transition focus:border-(--primary) focus:ring-2 focus:ring-(--primary)/20"
          >
  ...
  return (
    <label className="flex items-center gap-2.5 text-sm font-medium text-(--foreground)">
      ...
      <input
        ...
        suppressHydrationWarning
        className="rounded-xl border border-(--border) bg-(--card) px-3.5 py-2 text-sm font-medium text-(--foreground) shadow-sm outline-none transition focus:border-(--primary) focus:ring-2 focus:ring-(--primary)/20"
      />
    </label>
  );
}
