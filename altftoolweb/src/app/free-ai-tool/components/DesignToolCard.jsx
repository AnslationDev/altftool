...
export default function DesignToolCard({ tool, index = 0, onClick, className = "" }) {
  ...
  return (
    <div
      className={`group relative flex w-full flex-col overflow-hidden rounded-[28px] bg-gradient-to-b from-white/70 to-[#fbfaff]/70 transition-shadow ${CARD_SHADOW} ${className}`}
