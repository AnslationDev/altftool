...
export default function AppCard({ app, compact = false, descriptionFullWidth = false }) {
  ...
  return (
    <article className={`flex flex-col rounded-lg border border-[var(--home-border)] bg-[var(--card)] shadow-sm transition duration-150 hover:-translate-y-1 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none ${compact ? "min-h-[270px] p-5" : "min-h-[244px] p-4"}`}>
