...
const services = [
  { icon: Zap, title: 'Emergency Repair', desc: 'Burst pipes, floods, and active leaks handled fast with clean damage control.', detail: 'Immediate shutoff, temporary control, water removal guidance, and permanent repair options.', badge: '24/7', image: '/assets/og-default.png' },
  { icon: Droplets, title: 'Drain Cleaning', desc: 'Hydro-jetting and snaking clear slow drains, grease buildup, and repeat clogs.', detail: 'We remove grease, hair, sludge, and root intrusion without harsh chemicals.', image: '/assets/og-default.png' },
  ...
  { icon: Wrench, title: 'Pipe Repair', desc: 'From pinhole leaks to full repipes, we repair water lines with minimal disruption.', detail: 'Copper, PEX, PVC, and drain piping repaired with clean wall access.', image: '/assets/og-default.png' },
  { icon: Bath, title: 'Bathroom Plumbing', desc: 'Toilets, tubs, showers, valves, and bathroom rough-ins installed correctly.', detail: 'Fixture swaps, drain repairs, valve upgrades, and leak-free finish work.', image: '/assets/og-default.png' },
  { icon: Settings, title: 'Faucet & Fixtures', desc: 'Repair or replace faucets, showerheads, valves, cartridges, and shutoffs.', detail: 'Stops drips, pressure problems, loose handles, and worn cartridges.', image: '/assets/og-default.png'},
  { icon: GitBranch, title: 'Sewer Line', desc: 'Camera inspection, cleaning, and repair for main sewer line problems.', detail: 'Finds bellies, cracks, roots, offsets, and blockages before digging starts.', image: '/assets/og-default.png' },
  { icon: Flame, title: 'Gas Line', desc: 'Licensed gas line installation, leak checks, and appliance hookups.', detail: 'Code-compliant pressure tests, shutoff valves, and safe connections.', badge: 'Licensed', image: '/assets/og-default.png'},
  { icon: Filter, title: 'Water Filtration', desc: 'Whole-house filters, softeners, and RO systems for cleaner daily water.', detail: 'Protects fixtures, appliances, drinking water, and bathing comfort.', image: '/assets/og-default.png' },
  { icon: Wind, title: 'Hydro Jetting', desc: 'High-pressure cleaning restores pipe flow by washing the full drain wall.', detail: 'Ideal for grease, roots, sludge, scale, and stubborn commercial clogs.', image: '/assets/og-default.png' },
  { icon: Eye, title: 'Camera Inspection', desc: 'See exactly what is inside your pipes before repairs are recommended.', detail: 'Video diagnosis helps avoid guesswork and unnecessary repairs.', image: '/assets/og-default.png' },
  ...
  { icon: ShieldCheck, title: 'Backflow Prevention', desc: 'Certified testing and repair for backflow prevention devices.', detail: 'Protects drinking water with annual testing, repair, and documentation.', image: '/assets/og-default.png' },
  { icon: ChefHat, title: 'Kitchen Plumbing', desc: 'Kitchen sinks, disposals, dishwasher lines, and shutoff valves installed neatly.', detail: 'Leak-free sink setups, supply lines, drains, disposal swaps, and shutoffs.', image: '/assets/og-default.png' },
  { icon: CheckCircle, title: 'Preventive Maintenance', desc: 'Annual inspections help catch hidden leaks before they become emergencies.', detail: 'Catch corrosion, slow drains, weak valves, and hidden leaks early.', image: '/assets/og-default.png' },
  { icon: HardHat, title: 'Remodeling', desc: 'Rough-in and finish plumbing for bathrooms, kitchens, and whole-home upgrades.', detail: 'Layout planning, fixture placement, inspections, and clean final trim.', image: '/assets/og-default.png' },
];
