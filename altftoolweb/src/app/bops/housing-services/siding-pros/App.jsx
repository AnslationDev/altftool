    ...
    <AnimatePresence>
      {state !== "hidden" && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex items-center justify-center bg-[#eef2ff]/80 px-4 py-6 backdrop-blur-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        >
          <motion.div
            ...
            aria-modal="true"
            aria-live="polite"
            className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-[#d8ddf0] bg-white px-5 py-8 text-center shadow-[0_24px_80px_rgba(49,52,151,0.16)] sm:px-8 sm:py-10"
          ...
          >
            <button
              type="button"
              onClick={onClose}
              className="absolute right-5 top-5 rounded-full border border-slate-200 bg-white p-2 text-slate-500 transition hover:border-[#30339a] hover:text-[#30339a]"
            ...
            {state === "loading" ? (
              <div className="flex min-h-[300px] flex-col items-center justify-center gap-5">
                <div className="h-16 w-16 animate-spin rounded-full border-[6px] border-[#dfe3ff] border-t-[#30339a]" />
                <div>
                  <h2 className="font-display text-2xl font-extrabold text-[#11122d] sm:text-3xl">
                    Searching...
                  </h2>
              ...
              <div className="relative mx-auto max-w-xl">
                <div className="pointer-events-none absolute left-0 top-24 h-4 w-4 rounded-full border-4 border-[#dfe3f6]" />
                <div className="pointer-events-none absolute bottom-8 left-10 h-6 w-6 rounded-full border-4 border-[#dfe3f6]" />
                <div className="pointer-events-none absolute right-10 top-28 h-2.5 w-2.5 rounded-full bg-[#9aa8ee]" />

                <h2 className="font-display text-3xl font-extrabold leading-tight text-[#11122d] sm:text-4xl">
                  Sorry! No Result Found.
                </h2>
                <p className="mx-auto mt-4 max-w-lg text-base font-medium leading-relaxed text-[#17182f] sm:text-lg">
                  Let our agents help you find the best siding option for your home exterior.
                </p>

                <div className="mx-auto mt-7 flex h-24 w-24 items-center justify-center rounded-full bg-[#eef1ff] text-[#30339a] shadow-[0_18px_45px_rgba(49,52,151,0.12)] sm:h-28 sm:w-28">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="mx-auto mt-4 inline-flex items-center justify-center gap-2 rounded-full bg-[#30339a] px-6 py-3 text-base font-bold text-white shadow-[0_18px_36px_rgba(49,52,151,0.2)] transition hover:bg-[#24277e]"
                >
