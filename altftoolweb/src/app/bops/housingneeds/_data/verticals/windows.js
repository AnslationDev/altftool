...
const windows = {
  ...
  "seo": {
    "title": "Window Replacement Guide: Glass, Frames, Cost",
    "description": "Learn how double vs triple pane, low-E coatings, argon fill, U-factor and SHGC affect window performance, plus full-frame vs insert replacement."
  },
  "services": [
    {
      "icon": "AppWindow",
