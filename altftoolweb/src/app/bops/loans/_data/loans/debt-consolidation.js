...
export const debtConsolidation = {
  ...
  seo: {
    title: "Debt Consolidation — One Fixed Payment | AltFTool",
    description:
      "Combine high-interest credit cards and loans into one fixed-rate payment. Compare personalised debt consolidation offers with no impact to your credit.",
  },
};
