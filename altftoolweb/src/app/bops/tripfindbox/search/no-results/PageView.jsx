...
import { loadSearchCriteria, saveSearchCriteria, saveSearchResults } from "@/app/bops/tripfindbox/lib/searchSession";
...
export default function NoResultsPage() {
  ...
  const runInlineSearch = async (nextCriteria) => {
    ...
    if (nextResults.length) {
      router.replace("/bops/tripfindbox/search/results");
    }
  };
