...
//
// TripFindBox is integrated into AltFTool as a sub-route under "/bops/tripfindbox".
...
//
// tfbPath() rewrites internal absolute paths to live under /bops/tripfindbox, while
...
export const TFB_BASE = "/bops/tripfindbox";
