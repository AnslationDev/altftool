  ...
  return (
    <header className="results-brand-header">
      ...
      <span className="altf-brandlock">
        <Link href="/bops/tripfindbox" className="results-logo">
          <Image
      ...
      <nav aria-label="Results navigation">
        <Link href="/bops/tripfindbox">Flights</Link>
        <Link href="/bops/tripfindbox">Deals</Link>
        <Link href="/bops/tripfindbox">Support</Link>
      </nav>
