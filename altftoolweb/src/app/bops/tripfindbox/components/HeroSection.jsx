...
import { fetchBlogPosts } from "@/app/bops/tripfindbox/lib/blogData";
import { fetchHomeContent, DEFAULT_HOME_CONTENT } from "@/app/bops/tripfindbox/lib/homeContent";
import { telHref } from "@/app/bops/tripfindbox/lib/contactInfo";
    ...
    <>
      <footer id="support" className="nova-footer">
        <div className="tripnest-footer-newsletter">
          ...
          <small>{data.consentText} I have read and agree to the <Link href="/bops/tripfindbox/terms-and-conditions">Terms and Conditions</Link> and <Link href="/bops/tripfindbox/privacy-policy">Privacy Policy</Link>.</small>
        </div>
      ...
      <div className="tripnest-mobile-legal">
        ...
        <Link href="/bops/tripfindbox/terms-and-conditions">Terms of Use</Link>
      </div>
    </>
  );
}
