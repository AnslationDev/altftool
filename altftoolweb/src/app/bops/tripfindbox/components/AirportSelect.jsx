...
import { announceBookingPopupOpen, useBookingPopupCoordinator } from "@/app/bops/tripfindbox/lib/bookingPopupBus";
import { getFloatingLayerStyle, prepareBookingPopup } from "@/app/bops/tripfindbox/lib/bookingInteraction";
import { airports as fallbackAirports } from "@/app/bops/tripfindbox/lib/travelApi";
...
export default function AirportSelect({ label, value, onChange, error }) {
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(async () => {
      ...
      try {
        const response = await fetch(`/bops/tripfindbox/api/travel/airports?q=${encodeURIComponent(term)}`, {
