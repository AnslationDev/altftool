...
import RouteBottomSlider from "@/app/bops/tripfindbox/components/RouteBottomSlider";
import SeoRouteDealsGrid from "@/app/bops/tripfindbox/components/SeoRouteDealsGrid";
import { getTripFindBoxContactInfo, telHref } from "@/app/bops/tripfindbox/lib/contactInfo";
      ...
      <section className="site-route-content">
        {!isSimpleUtilityPage ? (
          <nav className="site-route-breadcrumb" aria-label="Breadcrumb">
            <Link href="/bops/tripfindbox">Home</Link>
            <span>›</span>
            <Link href="/bops/tripfindbox/site-map">{category}</Link>
            <span>›</span>
