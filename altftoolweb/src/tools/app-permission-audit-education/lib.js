/**
 * Education App Permission Audit — pure logic.
 *
 * Scores a student learning, tuition or exam app. Camera, microphone and screen
 * capture are legitimate for a live class or an invigilated exam but should be
 * session-scoped, so they score as optional. Accessibility control and overlay
 * permissions have no teaching use and score as full exposure.
 *
...
export const NECESSITY_LABEL = {
  ...
  unnecessary: "Not needed by a learning app",
};
...
/**
 * Permissions and privacy settings a learning app can hold.
...
export const PERMISSIONS = [
  {
    ...
    "tier": "minimal",
    "necessity": "core",
    "why": "Class start, assignment deadline and result alerts.",
  ...
  },
  {
    ...
    "label": "Save lessons for offline use",
    "android": "App-private storage (no permission)",
    "ios": "On-device downloads",
    "tier": "minimal",
    "necessity": "core",
    "why": "Keeps videos and notes in the app's own sandbox for offline study.",
    "risk": "None — app-private storage is not shared with anything else.",
    "recommend": "Keep. It needs no storage permission at all on Android 10+.",
    "aliases": [
      "offline",
      "downloads",
      "save lessons",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Your video in a live class, and photographing handwritten work.",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Speaking in a live class or recording a spoken-answer exercise.",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "optional",
    "why": "Shares your screen in class, or is used by exam proctoring.",
    "risk": "Captures everything on screen, including notifications from other apps that arrive mid-session.",
    "recommend": "Grant it per session only. Never leave a standing grant, and turn on Do Not Disturb first.",
    "aliases": [
      "screen recording",
      "screen capture",
      "screen share",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Uploading a photo of completed homework.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Puts the class timetable into your own calendar.",
    "risk": "Read access exposes every other event too, not just the classes.",
    "recommend": "Deny read access and subscribe to the timetable feed instead where the app offers one.",
    "aliases": [
      "calendar",
      "read calendar",
      "timetable",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "optional",
    "why": "Proctoring uses it to look for screen-mirroring or cheating apps during an exam.",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "unnecessary",
    "why": "Class groups work from a roster the school already has.",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "unnecessary",
    "why": "Geofenced attendance should be a per-session check-in, not a standing grant.",
    "risk": "Street-level position, and a home address the moment the app sees you overnight.",
    "recommend": "Revoke it, and ask the school what location data is retained.",
    "aliases": [
      "precise location",
      "fine location",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "unnecessary",
    "why": "Homework uploads go through the system picker.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "unnecessary",
    "why": "Occasionally used for classroom attendance beacons.",
    "risk": "Bluetooth scanning shows which other devices, and therefore which people, are around a student.",
    "recommend": "Revoke it unless attendance genuinely depends on it.",
    "aliases": [
      "nearby devices",
      "bluetooth",
      "beacon"
  ...
  },
  {
    ...
    "tier": "low",
    "necessity": "unnecessary",
    "why": "An advertising ID inside a children's learning app is a compliance problem, not just a privacy one.",
...
export function resultToText(result, appName = "Education app") {
  if (!result || result.error) return "";
  const name = String(appName || "Education app").trim() || "Education app";
  const lines = [
