const seo = {
  ...
  benefits: [
    ["Per-role, per-day arithmetic", "Applies each role's own basis — per person or per group, per day or per event — instead of one blanket percentage."],
    ["Trip styles built in", "Escorted coach, private car, trekking crew, safari and day tours each come with their own roles and published ranges."],
    ["Tells you what to withdraw", "Converts the total into whole notes so you land with the right cash rather than an awkward remainder."],
  ],
  faqs: [
    [
