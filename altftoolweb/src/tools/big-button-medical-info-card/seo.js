const seo = {
  title: "Big-Button Emergency Medical Info Card",
  metaDescription:
  ...
  benefits: [
    ["Sized for someone else to read", "The card renders at large body text with a bold heading and a heavy border rather than shrinking everything to fit."],
    ["Print or plain text, your choice", "Print through the browser dialog for a paper card, or copy a labelled plain-text block to paste into a phone note or a message."],
    ["Nothing is stored", "The fields live in the page only — there is no account, no upload and no saved copy left behind on a shared computer."],
  ],
  faqs: [
    [
