  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Kolkata CCU Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Netaji Subhas Chandra Bose International through the boarding gate, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-journey">
              Flight type
            </label>
            <select
              id="ccu-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-bags">
              Baggage
            </label>
            <select
              id="ccu-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-area">
              Starting from
            </label>
            <select
              id="ccu-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-traffic">
              Road conditions
            </label>
            <select
              id="ccu-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-queue">
              Terminal queues
            </label>
            <select
              id="ccu-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ccu-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="ccu-buffer">
