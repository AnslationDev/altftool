const seo = {
  ...
  benefits: [
    ...
    ["Age rule built in", "Under-14s and over-79s are counted out of the biometrics fee automatically."],
    ["Shows the saving", "A separate figure for how much the family maximums actually cut."],
  ],
  faqs: [
    [
