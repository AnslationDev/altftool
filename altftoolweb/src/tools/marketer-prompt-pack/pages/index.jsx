...
import { Check, Copy, Megaphone, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Marketing prompts",
  title: "Marketer Prompt Pack",
  intro:
    "Pick a funnel stage, fill in the blanks, and copy a prompt that already fixes the audience, the offer and the measurable outcome so the model writes copy you can test.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="ad, email, positioning"
                value={query}
