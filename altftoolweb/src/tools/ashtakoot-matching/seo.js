const seo = {
  ...
  benefits: [
    ["Full eight-koota breakdown", "Every koota is shown with its own score and maximum, so a total is traceable to the categories that produced it rather than presented as a bare number."],
    ["Moon position is computed, not looked up", "Nakshatra, pada and Moon rashi are derived from the birth date and time through a sidereal longitude calculation, so you do not need to know your nakshatra in advance."],
    ["Shows both charts side by side", "Each person's nakshatra, pada, Moon rashi and Sun rashi are listed, which is the context that makes an individual koota score interpretable."],
  ],
  faqs: [
    [
