        ...
        <div className="space-y-3">
          <div>
            <div className="flex gap-2 mb-2">
              ...
              />
              <Button variant="primary" size="sm" onClick={handleManualUrl} disabled={!url.trim()}>
          ...
          <div>
            <textarea
              ...
              className="w-full h-28 px-3 py-2 text-sm rounded-lg border border-(--border) bg-(--card) text-(--foreground) resize-none focus:outline-none focus:ring-2 focus:ring-(--primary) font-mono"
            />
            <div className="flex gap-2 mt-2">
              <Button variant="primary" size="sm" onClick={handlePaste} disabled={!text.trim()}>
              ...
              <label className="flex-1">
                ...
                <input ref={fileRef} type="file" accept=".json,.csv,.txt,.html" onChange={handleFile} className="hidden" />
              </label>
            </div>
          </div>
        </div>
