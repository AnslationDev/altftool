        ...
        <div className="space-y-3">
          <div>
            <div className="flex gap-2 mb-2">
              ...
              />
              <Button variant="primary" size="sm" className="active:scale-[0.98] motion-reduce:active:scale-100 focus-visible:ring-[3px] focus-visible:ring-(--primary)/35" onClick={handleManualUrl} disabled={!url.trim()}>
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2">
              <Button variant="primary" size="sm" className="active:scale-[0.98] motion-reduce:active:scale-100 focus-visible:ring-[3px] focus-visible:ring-(--primary)/35" onClick={handlePaste} disabled={!text.trim()}>
