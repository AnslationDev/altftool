const seo = {
  ...
  benefits: [
    ["Based on a published model", "Uses the NN/g four-dimension tone framework rather than invented personality labels."],
    ["Rules, not adjectives", "Every dial produces testable do and don't lines a writer can check copy against."],
    ["Measurable targets", "Outputs a sentence-length and reading-grade target you can verify with any readability checker."],
  ],
  faqs: [
    [
