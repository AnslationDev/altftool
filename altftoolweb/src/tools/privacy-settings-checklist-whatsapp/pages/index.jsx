    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          WhatsApp privacy audit
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">WhatsApp Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          WhatsApp encrypts the messages but leaves your photo, last seen, online status and group membership open by default. These 27 controls close the gaps, ranked by how much each one actually hides.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Assuming end-to-end encryption covers the cloud backup &mdash; it does not, unless encrypted backup is switched on separately.</li>
          <li>Hiding last seen but leaving the online indicator on Everyone, which shows the same thing in real time.</li>
          <li>Leaving a WhatsApp Web session linked on a computer someone else uses; it keeps mirroring messages for 30 days of inactivity.</li>
          <li>Setting a two-step PIN with no recovery email, then being locked out of your own number for days.</li>
          <li>Treating view-once as protection when a second phone can photograph the screen in a second.</li>
        </ul>
      </section>
