...
import { Check, Copy, RotateCcw, Globe } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Turkey Visa Rejection Reason Explainer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Turkey refuses on two tracks: an automated e-Visa eligibility check with no appeal, and a consular decision that comes with a written remedy. Pick what applies to see the rule behind it and what to change.
        </p>
      </header>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        wording on your own refusal notice and check the official Presidency of Migration Management pages, or speak to a
