...
/**
 * The Canadian dollar. The Bank of Canada's polymer Frontier series runs
 * $5, $10, $20, $50 and $100 — there is no $1 or $2 note, because both were
 * replaced by coins (the loonie in 1987 and the toonie in 1996), and the $1000
 * note was withdrawn from circulation in 2000.
 *
 * One Canadian quirk worth carrying in your head: the one-cent coin was
 * withdrawn in 2013, so cash totals are rounded to the nearest five cents at
 * the till while card and electronic totals are still charged to the cent.
 *
 * CAD floats against the rupee, so `defaultInrPerUnit` is only a starting
 * point — it sits inside the band the pair has traded in over recent years and
 * is meant to be replaced with the rate you actually see on the day.
 */
export const CURRENCY = {
  ...
  pricePoints: [
    { amount: 2.5, note: "Coffee at Tim Hortons" },
    { amount: 3.75, note: "Single transit fare" },
    { amount: 12, note: "Supermarket lunch" },
    { amount: 25, note: "Casual restaurant main" },
    { amount: 60, note: "Dinner for two" },
    { amount: 100, note: "Day of food and transit" },
    { amount: 250, note: "Mid-range hotel night" },
    { amount: 500, note: "Weekend of spending" },
    { amount: 1200, note: "Month of shared rent" },
  ],
};
