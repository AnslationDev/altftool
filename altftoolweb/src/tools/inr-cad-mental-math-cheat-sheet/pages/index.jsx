  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">INR to CAD Mental Math Cheat Sheet</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Type today&rsquo;s rupees-per-dollar rate and this works out the shortcut that gets you closest to the exact answer without a phone &mdash; a whole-number multiplier, a percentage nudge or a simple fraction &mdash; and tells you the percentage it is out by.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-[var(--muted-foreground)]">The rupee&ndash;dollar rate floats. Check the day&rsquo;s mid-market rate; a card will settle a little above it.</p>
          </div>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Nothing here is fetched live &mdash; the sheet is built from the rate you type in, so re-check it before a trip. Cash totals in Canada are rounded to the nearest five cents because the penny was withdrawn in 2013, and card totals carry your bank&rsquo;s foreign-transaction markup on top of the mid-market rate.
      </p>
    </main>
  );
}
