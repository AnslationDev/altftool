    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Bestu Varas and January greetings in Gujarati script with Roman transliteration, the
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-occasion">
              Occasion
            </label>
            <select
              id="nyg-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-tone">
              Tone
            </label>
            <select
              id="nyg-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-relationship">
              Who is it for
            </label>
            <select
              id="nyg-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-script">
              Script
            </label>
            <select
              id="nyg-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyg-from">
              Your name (optional)
            </label>
            <input
              id="nyg-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Gujarati new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Gujarati words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Gujarati script is billed at 70 characters
