const seo = {
  title: "Canada Visa Refusal Reasons: IRCC Checkbox",
  metaDescription:
  ...
  benefits: [
    ["Checkbox to regulation", "Each ticked factor is mapped to the IRPA or IRPR provision it comes from, so you can read the source."],
    ["Points you at the GCMS notes", "The template letter says little; the officer's Global Case Management System notes say everything, and this explains how to get them."],
    ["A scored fix list", "Tick off each remedy and see how much of the refusal you have actually closed before paying the fee again."],
  ],
  faqs: [
    [
