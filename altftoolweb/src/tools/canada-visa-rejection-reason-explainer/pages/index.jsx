...
import { Check, Copy, RotateCcw, ClipboardCheck } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Canada Visa Rejection Reason Explainer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          IRCC refusal letters are built from a fixed set of checkboxes. Pick the ones ticked on yours to see the regulation behind each, how serious it is, and what evidence answers it.
        </p>
      </header>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        wording on your own refusal notice and check the official IRCC pages, or speak to a
