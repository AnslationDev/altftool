    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Puthuvatsaraashamsakal
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Malayalam New Year Wishes
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Vishu, Chingam 1 and January greetings in Malayalam script with Roman transliteration, the
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-occasion">
              Occasion
            </label>
            <select
              id="nyml-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-tone">
              Tone
            </label>
            <select
              id="nyml-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-relationship">
              Who is it for
            </label>
            <select
              id="nyml-relationship"
              className={`mt-2 ${INPUT_CLASS}`}
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-script">
              Script
            </label>
            <select
              id="nyml-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyml-from">
              Your name (optional)
            </label>
            <input
              id="nyml-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Malayalam new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Malayalam words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Malayalam script is billed at 70 characters
        per part while plain Roman text gets 160.
      </p>
    </main>
  );
}
