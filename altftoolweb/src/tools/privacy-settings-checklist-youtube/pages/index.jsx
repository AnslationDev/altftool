...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Youtube } from "lucide-react";
...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    if (!hasScore) return "";
    const lines = [
      "YouTube Privacy Settings Checklist",
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">YouTube Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Most people have a YouTube channel without knowing it, and by default it publishes their subscriptions, playlists and every comment they have ever left. These 26 controls decide what your channel shows and how long YouTube keeps your history.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Ticking &lsquo;keep all my saved playlists private&rsquo; and assuming it covered playlists you created yourself &mdash; it does not.</li>
          <li>Hiding subscriptions and playlists while leaving a decade of comments, each carrying your real name and photo, fully public.</li>
          <li>Treating Unlisted as private; anyone with the link can open an unlisted playlist or video and links get shared.</li>
          <li>Looking for ad settings inside YouTube, when personalisation is controlled in My Ad Center at the Google account level.</li>
          <li>Turning on Restricted Mode on one device and assuming it applies to the account; it is set per browser and per device.</li>
        </ul>
      </section>
