const seo = {
  ...
  useCases: [
    "Setting up shared access to bills and subscriptions when you move in together, without handing over personal banking.",
    "Making sure a partner could reach the insurance policy and the school portal if you were in hospital for a week.",
    "Cleaning up after years of sending the wi-fi and streaming passwords by message.",
    "Deciding what a teenager should hold themselves and what stays under a family group.",
  ],
  benefits: [
    [
  ...
  faqs: [
    ...
    [
      "How should couples share bills and utility accounts?",
    ...
    [
      "Should I share my bank password with my spouse?",
