    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Ready-to-send Poila Boishakh and January greetings in Bengali script, with Roman
          transliteration, the English meaning and the exact SMS length of every message.
        </p>
      </header>
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-occasion">
              Occasion
            </label>
            <select
              id="nyb-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-tone">
              Tone
            </label>
            <select
              id="nyb-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-relationship">
              Who is it for
            </label>
            <select
              id="nyb-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-script">
              Script
            </label>
            <select
              id="nyb-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyb-from">
              Your name (optional)
            </label>
            <input
              id="nyb-from"
