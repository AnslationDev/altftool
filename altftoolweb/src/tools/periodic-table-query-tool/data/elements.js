/**
 * Raw element data for the Periodic Table Query Tool.
 *
 * 118 confirmed elements with the property set published by NIST and IUPAC:
 * atomic mass in unified atomic mass units, Pauling electronegativity, first ionisation
 * energy and electron affinity in kJ/mol, radii in picometres, melting and boiling points
 * in kelvin, density in g/cm3. An empty value means the property has not been measured
 * (mostly the superheavy synthetic elements).
 *
 * Held as a JavaScript module rather than JSON so it imports identically in the browser
 * bundle and in a plain Node check.
 */
