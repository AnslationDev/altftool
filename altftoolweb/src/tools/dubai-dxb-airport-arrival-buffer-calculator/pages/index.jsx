  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Dubai DXB Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Dubai International through the boarding gate, passport control, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-journey">
              Flight profile
            </label>
            <select
              id="dxb-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-bags">
              Baggage
            </label>
            <select
              id="dxb-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-area">
              Starting from
            </label>
            <select
              id="dxb-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-traffic">
              Road conditions
            </label>
            <select
              id="dxb-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-queue">
              Terminal queues
            </label>
            <select
              id="dxb-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="dxb-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="dxb-buffer">
