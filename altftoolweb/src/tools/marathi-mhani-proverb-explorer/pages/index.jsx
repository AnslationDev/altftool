  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Marathi Mhani Explorer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          {TOTAL_PROVERBS} Marathi mhani, each with a transliteration, a strictly literal
          translation, the figurative sense it actually carries, a Marathi gloss and — where one
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy the Marathi proverb of the day with its meaning"
              className={GHOST_BTN}
        ...
        <dl className="mt-5 divide-y divide-[var(--border)] text-sm">
          {[
            ...
            ["अर्थ", dailyError ? DASH : daily.marathiGloss],
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        ...
        <div className="mt-3">
          <label className={LABEL_CLASS} htmlFor="mm-theme">
            Theme
          </label>
          <select
            id="mm-theme"
        ...
        <label className={`mt-4 ${LABEL_CLASS}`} htmlFor="mm-search">
          ...
          <>
            ...
            {revealed ? (
              ...
              >
                ...
                <p className="mt-1">{quiz.marathiGloss}</p>
                {quiz.equivalent ? (
        ...
        <ul className="mt-3 divide-y divide-[var(--border)]">
          {list.map((entry) => (
            <li key={entry.proverb} className="py-4">
              ...
              <p className="mt-1 text-sm text-[var(--muted-foreground)]">{entry.marathiGloss}</p>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        written Marathi. The forms here follow the versions most commonly printed in proverb
