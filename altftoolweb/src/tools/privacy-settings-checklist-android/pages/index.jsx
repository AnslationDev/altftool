...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Smartphone } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Android Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Twenty-seven Android settings, ranked by how much exposure each one actually closes. Pick the profile that matches why you are doing this, tick what you have already changed, and the score shows what your phone is still handing out.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="and-profile">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="and-target">
              Target score (%)
            </label>
            <input
              id="and-target"
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]" aria-labelledby="and-score">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p id="and-score" className="text-xs font-semibold uppercase tracking-wide text-[var(--muted-foreground)]">
              Protection score
            </p>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Resetting the advertising ID instead of deleting it. A reset just starts a fresh profile; deleting returns zeros to every app that asks.</li>
          <li>Turning location off in quick settings while leaving Wi-Fi and Bluetooth scanning on, which is how the phone is still positioned.</li>
          <li>Granting an app &ldquo;Allow all the time&rdquo; location for one feature, then never noticing it traces your movements permanently.</li>
          <li>Ignoring the manufacturer&rsquo;s account. Samsung, Xiaomi and others run a second data pipeline that no Google setting touches.</li>
          <li>Using a pattern lock. It is readable from the smudge on the screen and from one glance over your shoulder &mdash; and it protects your cloud backup too.</li>
          <li>Leaving Quick Share visible to everyone, so your device name &mdash; usually your real first name &mdash; shows up to every phone in range.</li>
          <li>Assuming a phone past its support window is fine because it still works. Once security patches stop, no setting on this list closes the gap.</li>
        </ul>
      </section>
