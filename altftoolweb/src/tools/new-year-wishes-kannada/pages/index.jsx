    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Kannada New Year Wishes
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Yugadi and January greetings in Kannada script with Roman transliteration, the English
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-occasion">
              Occasion
            </label>
            <select
              id="nyk-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-tone">
              Tone
            </label>
            <select
              id="nyk-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-relationship">
              Who is it for
            </label>
            <select
              id="nyk-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-script">
              Script
            </label>
            <select
              id="nyk-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyk-from">
              Your name (optional)
            </label>
            <input
              id="nyk-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Kannada new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Kannada words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Kannada script is billed at 70 characters
