...
const NUM2 = new Intl.NumberFormat("en-AE", { maximumFractionDigits: 2 });
const NUM0 = new Intl.NumberFormat("en-AE", { maximumFractionDigits: 0 });
const DASH = "—";
...
const PRESETS = [
  ...
  { label: "Travel iron", minV: "220", maxV: "240", freq: "50", watts: "1200" },
];
...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    if (hasError) return "";
    return [
      "Plug and Voltage Guide for UAE",
      `UAE mains: ${MAINS_VOLTAGE_V} V, ${MAINS_FREQUENCY_HZ} Hz, type G sockets with legacy C and D outlets`,
  ...
  const rows = [
    ...
    [
      "Fits the standard BS 1363 socket",
      hasError ? DASH : result.conditionalFit ? "No — legacy round-pin outlets only" : result.adapterNeeded ? "No" : "Yes",
    ],
    [
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Plug and Voltage Guide for UAE</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Dubai, Abu Dhabi and the rest of the UAE run {MAINS_VOLTAGE_V} V at {MAINS_FREQUENCY_HZ} Hz on the British
          BS 1363 type G socket, with round-pin type C and D fittings surviving in older buildings. Enter your device
          to see whether an adapter is enough and which fuse belongs in the plug.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="ae-plug">
              Plug on your device
            </label>
            <select
              id="ae-plug"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ae-minv">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ae-maxv">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ae-freq">
              Label frequency
            </label>
            <select
              id="ae-freq"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ae-watts">
              Rated power (W)
            </label>
            <input
              id="ae-watts"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              onClick={copyResult}
              disabled={hasError}
              aria-label="Copy the UAE plug and voltage verdict"
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <h2 className="text-lg font-semibold">Outlets you will meet in the UAE</h2>
