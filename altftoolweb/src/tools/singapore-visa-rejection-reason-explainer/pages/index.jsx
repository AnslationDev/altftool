...
import { Check, Copy, RotateCcw, BadgeAlert } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Singapore Visa Rejection Reason Explainer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          ICA never states why an entry visa application failed. Work backwards through the areas an application is assessed on - form compliance, local contact, funds, purpose, ties and record - and see what to close before reapplying.
        </p>
      </header>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        wording on your own refusal notice and check the official ICA pages, or speak to a
