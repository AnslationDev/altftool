const seo = {
  ...
  benefits: [
    ["Cost per year, not per visit", "Divides the ownership period by each treatment's real durability and counts the repeat applications."],
    ["Size-adjusted pricing", "Applies a body-size multiplier so an SUV quote is not compared against a hatchback price."],
    ["Honest durability figures", "Uses realistic service life rather than marketing claims, and flags that machine polish is not protection at all."],
  ],
  faqs: [
    [
