    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Nua barsara shubhechha
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Odia New Year Wishes</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Pana Sankranti and January greetings in Odia script with Roman transliteration, the
          English meaning and the exact SMS length of every message.
        </p>
      </header>
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-occasion">
              Occasion
            </label>
            <select
              id="nyo-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-tone">
              Tone
            </label>
            <select
              id="nyo-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-relationship">
              Who is it for
            </label>
            <select
              id="nyo-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-script">
              Script
            </label>
            <select
              id="nyo-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyo-from">
              Your name (optional)
            </label>
            <input
              id="nyo-from"
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Odia new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
        ...
        <dl className="mt-5 divide-y divide-[var(--border)] text-sm">
          {[
            ["Greetings matched", featured ? NUM.format(result.count) : DASH],
      ...
      {featured ? (
        <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-base font-semibold">All matching greetings</h2>
          <ul className="mt-3 space-y-3">
            {result.items.map((item) => (
              ...
              >
                <p className="whitespace-pre-line text-base leading-relaxed">{item.message}</p>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Odia words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Odia script is billed at 70 characters per
        part while plain Roman text gets 160.
      </p>
    </main>
  );
}
