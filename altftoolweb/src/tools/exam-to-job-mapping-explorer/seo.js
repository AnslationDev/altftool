const seo = {
  ...
  benefits: [
    ["Pay levels made concrete", "Every CPC-scale post shows its 7th CPC level and the entry basic pay behind it, from Rs 18,000 at Level 1 to Rs 56,100 at Level 10."],
    ["Job profiles, not just titles", "Each post carries a one-line description of the actual work — desk, field, shift or command."],
    ["Cross-exam comparison", "Search by post name or sector to see every exam that leads to that kind of job in one view."],
  ],
  faqs: [
    [
