const seo = {
  title: "Brand Deal Rate Calculator: Sponsorship Pricing",
  metaDescription:
  ...
  useCases: [
    "A brand asks for your rate for two Reels to 50,000 expected views and you need a number in the reply within the hour, with a floor you will not go below.",
    "The contract adds three months of paid whitelisting and category exclusivity after you already quoted, and you need to price the change rather than absorb it.",
    "You are quoting through a manager who takes a percentage and want the fee sitting on top of your rate rather than eating into it.",
  ],
  benefits: [
    ["Prices rights separately from content", "Usage and exclusivity are applied as uplifts on the media plus production subtotal, which makes it obvious that a longer licence or a category lock-out costs money the shoot did not."],
    ["Itemised, so it survives scrutiny", "The breakdown returns media value, production, combined usage and exclusivity, management fee and deliverable count as separate lines you can paste into a quote."],
    ["Gives a band, not a single number", "Alongside the calculated quote you get a range from 85% to 125% of it, which is what an actual negotiation looks like."],
  ],
  faqs: [
    [
      "How is a sponsored post rate calculated from CPM?",
    ...
    [
      "Why do paid usage and exclusivity add to the price?",
    ...
    [
      "Does the agency fee come out of my rate?",
