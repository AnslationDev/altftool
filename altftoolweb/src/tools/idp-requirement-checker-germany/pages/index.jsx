    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Answer six questions and see whether Germany expects an International Driving Permit
          alongside your own licence, how long that licence keeps working, and what to carry in the
          car. Based on Sections 7, 28 and 29 of the Fahrerlaubnis-Verordnung.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="de-idp">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="de-purpose">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="de-arrival">
              Date you arrive
            </label>
            <input
              id="de-arrival"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="de-departure">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy the IDP verdict for Germany"
              className={GHOST_BTN}
              disabled={hasError}
            >
              {copied ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        own case with a German Fuehrerscheinstelle or your embassy before you drive.
      </p>
    </main>
  );
}
