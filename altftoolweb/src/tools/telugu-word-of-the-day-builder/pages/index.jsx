...
const STORAGE_KEY = "altft-wotd-te";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Telugu Word of the Day</h1>
      ...
      {entry.error ? (
        ...
        <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
          ...
          <div className="mt-5 rounded-md bg-[var(--muted)] px-3 py-3">
            ...
            <p className="mt-2 text-lg leading-8" lang="te" dir="ltr">
              {word.ex}
            </p>
                ...
                {preview.list.map((item) => (
                  <tr key={item.date} className="border-b border-[var(--border)] last:border-0">
                    ...
                    <td className="py-2 pr-3">
                      <span className="font-semibold" lang="te" dir="ltr">
                        {item.word.w}
                      </span>
