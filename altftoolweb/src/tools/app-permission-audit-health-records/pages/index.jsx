...
import { FileHeart, Check, Copy, RotateCcw } from "lucide-react";
...
export default function ToolHome() {
  const [appName, setAppName] = useState("My health records app");
  ...
  const reset = () => {
    setAppName("My health records app");
    setMode("checklist");
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Health Records App Permission Audit</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Health records are the most sensitive category of personal data there is, and the risk in a records app is rarely one dramatic permission — it is a default sharing toggle and an analytics SDK. This audit scores permissions and settings together.
        </p>
      </header>
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="hr-app-name">
        ...
        {mode === "paste" ? (
          <div className="mt-4">
            <label className={LABEL_CLASS} htmlFor="hr-paste">
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Informational only and not medical or legal advice. India's DPDP Act 2023 and the ABDM Health Data Management Policy both require your specific consent before health data is shared, and consent can be withdrawn — check the app's consent ledger, and speak to your provider before changing anything clinical.
      </p>
    </main>
  );
}
