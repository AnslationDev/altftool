...
/**
 * The Nepalese rupee. Unlike every other pair in this family, NPR is not
 * floating against INR: Nepal Rastra Bank has maintained a fixed peg of
 * NPR 1.60 = INR 1 since 12 February 1993. That makes the exact conversion a
 * constant — 1 NPR = 0.625 INR, which is exactly 5/8 — rather than a number
 * that has to be looked up each morning.
 *
 * Nepal Rastra Bank issues notes of 1000, 500, 100, 50, 20, 10 and 5 rupees.
 * Indian currency is widely handled in the border districts and by traders,
 * but Nepal permits Indian notes only in the smaller denominations — the
 * ₹500 note is not accepted, so carry ₹100 notes or exchange properly.
 *
 * `defaultInrPerUnit` is therefore the peg itself rather than a guess. It is
 * still editable, because the peg can be revised by Nepal Rastra Bank and a
 * money changer will not give you the peg rate exactly.
 */
export const CURRENCY = {
  ...
  symbol: "NRs ",
  country: "Nepal",
  defaultInrPerUnit: 0.625,
  notes: [1000, 500, 100, 50, 20, 10, 5],
  pricePoints: [
    { amount: 30, note: "Bottle of water" },
    { amount: 60, note: "Cup of milk tea" },
    { amount: 200, note: "Plate of momos" },
    { amount: 450, note: "Dal bhat set" },
    { amount: 600, note: "Taxi across Kathmandu" },
    { amount: 1600, note: "Tourist bus seat to Pokhara" },
    { amount: 2500, note: "Guesthouse night in Thamel" },
    { amount: 8000, note: "Week of meals" },
    { amount: 16000, note: "Domestic flight leg" },
  ],
};
