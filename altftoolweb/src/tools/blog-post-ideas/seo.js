const seo = {
  ...
  benefits: [
    ...
    ["Reshuffles for a fresh five", "Regenerating draws a different subset from the eight templates, so you can keep pulling until an angle clicks rather than accepting the first list."],
