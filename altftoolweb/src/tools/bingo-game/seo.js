const seo = {
  ...
  benefits: [
    ["Named win patterns, not just a beep", "When a line completes it tells you exactly which one — Row 3, Column G, a diagonal, Four Corners or Full House — so disputed calls are settled instantly."],
    ["Draws without replacement", "The 75 numbers are shuffled once per game and consumed in order, so no ball is ever called twice and the pool genuinely runs out."],
    ["Pace and marking are yours to set", "Call manually or run auto-call at your chosen interval, and switch auto-mark off if players should spot their own numbers."],
  ],
  faqs: [
    [
