const seo = {
  ...
  benefits: [
    ["Even coverage", "Time is split across zones, so the side you always rush gets the same seconds as the side you do first."],
    ["Technique, not just time", "Each zone carries a modified Bass cue — 45° to the gum line, short strokes, light pressure."],
    ["Age-correct fluoride", "Amount and ppm follow the published bands for under-3s, 3 to 6 year olds and everyone older."],
  ],
  faqs: [
    [
