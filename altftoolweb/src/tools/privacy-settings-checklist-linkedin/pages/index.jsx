...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Linkedin } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">LinkedIn Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          LinkedIn is the one network where a privacy slip has a direct professional cost: a broadcast profile edit tells your manager you are looking. These 29 settings close that and the quieter leaks around it.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Updating the headline first and switching off update broadcasts afterwards &mdash; the notification has already gone out and cannot be recalled.</li>
          <li>Turning on the green Open to Work frame for all members, which announces the search to your current employer.</li>
          <li>Leaving the connections list visible, which is the single easiest way for a competitor to lift your client and colleague map.</li>
          <li>Turning off contact sync without deleting the contacts already uploaded; they are separate actions.</li>
          <li>Assuming private browsing mode is free &mdash; it also removes your own list of who viewed your profile.</li>
        </ul>
      </section>
