    ...
    <main className="min-h-screen bg-[var(--background)] px-4 py-8 text-[var(--foreground)] sm:px-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-6 shadow-[var(--anslation-ds-shadow-sm)] lg:p-8">
          ...
          <h1 className="text-4xl font-semibold leading-tight">YouTube Thumbnail Downloader</h1>
        ...
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--anslation-ds-shadow-sm)]">
          ...
          <p className="mt-3 text-sm font-semibold text-[var(--muted-foreground)]">Video ID: {videoId || "Not detected"}</p>
            ...
            <div key={label} className="overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--card)] shadow-[var(--anslation-ds-shadow-sm)]">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-4">
                ...
                <div className="flex gap-2">
                  <button type="button" disabled={!url} onClick={() => copyUrl(label, url)} className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-3 py-2 text-sm font-semibold hover:bg-[var(--muted)] disabled:opacity-50">
                    <Copy className="h-4 w-4" />
                    Copy
                  </button>
                  <a href={url || "#"} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-[var(--primary)] px-3 py-2 text-sm font-semibold text-white">
