const seo = {
  ...
  benefits: [
    ["Names the right party", "Terrace, façade, common stacks and tanks go to the society; internal plumbing and floor waterproofing go to the flat above."],
    ["Dated, provable deadline", "Adds your chosen number of days to the letter date so the demand has a specific compliance date, not 'at the earliest'."],
    ["Escalation that matches the stage", "A first complaint stays civil; a final notice cites Section 91, the Consumer Protection Act 2019 and municipal nuisance provisions."],
  ],
  faqs: [
    [
