...
import { Check, Copy, Calculator, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Accounting prompts",
  title: "Accountant Prompt Pack",
  intro:
    "Pick an accounting task, fill in the blanks, and copy a prompt that already states the period, the framework and the format — with a standing rule that the model never invents figures.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="reconciliation, variance, email"
                value={query}
