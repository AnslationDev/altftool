...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, IndianRupee } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">PhonePe Security Setup Guide</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Most PhonePe losses are not hacks: someone is talked into entering their UPI PIN or installing a screen-sharing app. Tick each control as you set it; the score weights the habits that stop that, not just the settings.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Entering the UPI PIN because a caller said it is needed to &ldquo;accept&rdquo; a refund &mdash; the PIN only ever authorises money going out.</li>
          <li>Installing a remote-desktop app because &ldquo;customer care&rdquo; asked, which hands over both the screen and the keyboard.</li>
          <li>Letting the registered mobile number lapse, so the SIM is reissued with your UPI binding still attached to the bank account.</li>
          <li>Approving an autopay mandate during a free trial and never checking the Autopay list again.</li>
        </ul>
      </section>
