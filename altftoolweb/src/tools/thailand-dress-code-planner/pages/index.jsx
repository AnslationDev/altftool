...
const DEFAULTS = {
  ...
  tripDays: 10,
  laundryEveryDays: 4,
  venueIds: ["grand-palace", "wat", "beach", "mall"],
  headCover: false,
};
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Thailand Dress Code Planner for Travellers
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Pick the month and the places you plan to visit. The planner applies the actual entry
          rules for each site, checks them against Bangkok&rsquo;s monthly climate normals, and
          turns the result into a counted packing list.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="th-month">
              Month of travel
            </label>
            <select
              id="th-month"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="th-days">
              Trip length (days)
            </label>
            <input
              id="th-days"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="th-laundry">
              Laundry every (days)
            </label>
            <input
              id="th-laundry"
            ...
            <p className="mt-1 text-xs text-[var(--muted-foreground)]">
              Guesthouse laundry across Thailand is usually same-day or next-day by the kilo.
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy the Thailand packing plan"
              className={GHOST_BTN}
              disabled={hasError}
            >
              {copied ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Climate figures are long-run Bangkok normals — the north (Chiang Mai, Pai) is several
        degrees cooler in December and January, and the Andaman and Gulf coasts have opposite
        monsoons. Site rules can tighten for royal ceremonies and religious holidays; check the
