const seo = {
  ...
  steps: [
    "Choose Kilograms or Pounds, then enter Body weight (kg) or Body weight (lb) and Protein meals per day.",
    "Pick from Activity and goal — Sedentary, General fitness, Endurance training, Build muscle, Fat loss or Adult over 65 — and tick Base the target on lean body mass instead to add Body fat (%).",
    "Read Suggested daily protein in g/day with its sensible range, plus the Per-kilogram band, Per meal and Calories from protein rows, then press Copy result.",
  ],
