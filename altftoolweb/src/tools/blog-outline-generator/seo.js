const seo = {
  ...
  benefits: [
    ["Output is markdown you can paste straight in", "Headings come back as # and ## lines, so they drop into a markdown editor, a CMS or a Google Doc and immediately become real heading levels."],
    ["The angle order is deliberate", "Sections progress from why it matters through steps and mistakes to advanced strategies, which is the sequence most how-to readers actually want."],
    ["Length is a dial, not a guess", "Choosing between 2 and 8 body sections gives you a total of 6 to 12 headings, so you can match the outline to a target word count before writing a word."],
  ],
  faqs: [
    [
