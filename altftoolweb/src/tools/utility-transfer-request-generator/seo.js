const seo = {
  ...
  benefits: [
    ["Statutory date, not a hopeful one", "Electricity applications carry the Rule 4(3) cap for the area and the resulting completion date."],
    ["Checklist follows the reason", "Purchase adds the sale deed, tenancy adds the registered agreement and owner NOC, inheritance adds the death certificate and succession proof."],
    ["Warns about inherited arrears", "Flags the no-dues certificate, because under Section 56 of the Electricity Act 2003 dues attach to the connection."],
  ],
  faqs: [
    [
