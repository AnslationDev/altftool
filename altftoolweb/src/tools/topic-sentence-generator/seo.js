const seo = {
  ...
  benefits: [
    ["Subject plus controlling idea", "Forces the two parts a topic sentence must have, so it cannot come out as a bare topic."],
    ["Position-aware wording", "Middle paragraphs get a linking opener; the last one gets an emphatic shape."],
    ["Seven-point checker", "Scores your own sentence on length, form, filler, evidence placement and announcement phrasing."],
  ],
  faqs: [
    [
