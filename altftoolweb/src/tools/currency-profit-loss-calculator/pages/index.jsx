...
const SLUG = "currency-profit-loss-calculator";
const PASCAL = "CurrencyProfitLossCalculator";
const ICON = "Calculator";
const ICON_COLOR = "text-(--primary)";
const NAME = "Currency Profit/Loss Calculator";

export default function CurrencyProfitLossCalculator() {
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-(--border) bg-(--background)/50 p-8 text-center">
        ...
        <p className="mt-1 text-xs text-(--muted-foreground)/60">
          Get detailed projections for currency profit/loss calculator
        </p>
      </div>
    );
  }
