...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    ...
    return [
      "WhatsApp Two-Step Verification Guide",
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--muted-foreground)] sm:text-base">
              Set up the WhatsApp two-step PIN, recovery email, passkey, linked-device cleanup,
              encrypted backup and SIM-swap resilience checklist. This page is local guidance only;
              it never asks for your PIN, OTP or backup password.
            </p>
          </div>
          <div className="rounded-lg border border-[var(--warning)] bg-[var(--warning-soft)] p-4 lg:max-w-sm">
            <p className="font-bold">Do not paste secrets</p>
            <p className="mt-1 text-sm leading-6 text-[var(--muted-foreground)]">
              Keep OTPs, two-step PINs and backup keys out of this page. Tick controls only after
              completing them inside WhatsApp or your carrier/email settings.
            </p>
          </div>
        </div>
      </header>
