  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">INR to VND Mental Math Cheat Sheet</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Vietnamese prices carry a lot of zeros, so the trick is to strip them first and then apply one small multiplier. Type today&rsquo;s rupees-per-dong rate and this finds the shortcut that lands closest &mdash; and tells you the percentage it is out by.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-[var(--muted-foreground)]">Rupees per single dong, so the number is small &mdash; around 0.003. If you know dong per rupee instead, divide 1 by it.</p>
          </div>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Nothing here is fetched live &mdash; the sheet is built from the rate you type in. Check the 20,000₫ and 500,000₫ notes carefully before paying: both are blue-toned polymer and are the most commonly confused pair in Vietnam. Card settlements add your bank&rsquo;s foreign-currency markup on top of the mid-market rate.
      </p>
    </main>
  );
}
