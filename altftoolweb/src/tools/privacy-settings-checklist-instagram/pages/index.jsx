...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Instagram } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Instagram Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Thirty settings, ranked by how much exposure each one actually closes. Pick the profile that matches why you are doing this, tick what you have already changed, and the score shows where you are still open.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Going private and assuming old posts are safe &mdash; existing followers, screenshots and search-engine caches keep what was public while it was public.</li>
          <li>Turning off contact upload without also deleting the contacts already uploaded, which is a separate button.</li>
          <li>Using SMS two-factor on a valuable handle, when a SIM swap defeats it in an afternoon.</li>
          <li>Locking down the main story while leaving highlights, which never expire, pinned to the profile.</li>
          <li>Blocking someone instead of restricting them, which tells them immediately and often escalates the situation.</li>
        </ul>
      </section>
