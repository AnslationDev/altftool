  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Amsterdam AMS Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Schiphol through the boarding gate, passport control, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-journey">
              Flight type
            </label>
            <select
              id="ams-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-bags">
              Baggage
            </label>
            <select
              id="ams-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-area">
              Starting from
            </label>
            <select
              id="ams-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-traffic">
              Road conditions
            </label>
            <select
              id="ams-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-queue">
              Terminal queues
            </label>
            <select
              id="ams-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="ams-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="ams-buffer">
