...
import { Check, Copy, RotateCcw, FileSearch } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">USA Visa Rejection Reason Explainer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Every US consular refusal names a section of the Immigration and Nationality Act. Pick the one on your slip to see what the officer decided, whether a waiver exists, and what evidence changes the answer.
        </p>
      </header>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        wording on your own refusal notice and check the official US Department of State pages, or speak to a
