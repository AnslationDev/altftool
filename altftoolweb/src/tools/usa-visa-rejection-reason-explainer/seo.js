const seo = {
  title: "US Visa Refusal: INA 214(b), 221(g) & More",
  metaDescription:
  ...
  benefits: [
    ["Keyed to the statute", "Each ground carries its INA citation, so you can look up the primary source rather than trusting a forum post."],
    ["Tells you which refusals expire", "214(b) is a judgement that can be reversed at the next interview; 212(a)(6)(C)(i) is permanent. The difference decides your whole strategy."],
    ["A checklist you can score", "Tick off each fix and see how much of the refusal reason you have really closed before you pay the fee again."],
  ],
  faqs: [
    [
