/**
 * Departure planning for Kempegowda International Airport (BLR / VOBL).
 *
...
export const AIRPORT = {
  ...
  city: "Bengaluru",
  terminals: [
    "T1 - domestic and some international services",
    "T2 - the garden terminal, international plus selected domestic",
    "A single integrated campus, but the walk between T1 and T2 landside is about 10 minutes",
  ],
};
...
/** Baseline queue times at BLR in normal conditions, before the queue factor. */
...
/** Multiplier applied to the free-flow drive time. Almost the whole journey is city arterial road plus the Bellary Road corridor, where a single incident adds 30 minutes with no alternative route. */
export const TRAFFIC_LEVELS = [
  { id: "clear", label: "Clear (night / early morning)", multiplier: 1 },
  { id: "typical", label: "Typical daytime", multiplier: 1.3 },
  { id: "heavy", label: "Heavy (rush hour)", multiplier: 1.8 },
  { id: "severe", label: "Severe (rain, accident, Hebbal flyover jam)", multiplier: 2.4 },
];
...
export const QUEUE_LEVELS = [
  ...
  { id: "peak", label: "Peak bank (05:00-09:00, 19:00-23:00)", multiplier: 1.5 },
];

/**
 * Bengaluru road rush-hour windows, as minutes from midnight. Used only to SUGGEST a
...
/**
 * Indicative free-flow (no-traffic) road times to BLR from common starting
 * points. They are starting estimates only - replace the minutes with a live maps
 * estimate for your own address.
 */
export const AREA_PRESETS = [
  { id: "yelahanka", label: "Yelahanka / Jakkur", driveMinutes: 30 },
  { id: "hebbal", label: "Hebbal / Manyata Tech Park", driveMinutes: 40 },
  { id: "malleswaram", label: "Malleswaram / Sadashivanagar", driveMinutes: 50 },
  { id: "mgroad", label: "MG Road / Indiranagar", driveMinutes: 60 },
  { id: "marathahalli", label: "Marathahalli / Bellandur", driveMinutes: 65 },
  { id: "koramangala", label: "Koramangala / HSR Layout", driveMinutes: 70 },
  { id: "whitefield", label: "Whitefield", driveMinutes: 75 },
  { id: "jayanagar", label: "Jayanagar / JP Nagar", driveMinutes: 75 },
  { id: "electroniccity", label: "Electronic City", driveMinutes: 90 },
