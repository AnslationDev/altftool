    ...
    <main className="min-h-screen bg-[var(--background)] px-4 py-8 text-[var(--foreground)] sm:px-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-6 shadow-[var(--anslation-ds-shadow-sm)] lg:p-8">
          ...
          <h1 className="text-4xl font-semibold leading-tight">Online Notepad</h1>
        ...
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--anslation-ds-shadow-sm)]">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <input value={title} onChange={(event) => setDraft((current) => ({ ...current, title: event.target.value }))} className="min-w-0 flex-1 rounded-lg border border-[var(--border)] bg-[var(--background)] px-4 py-3 text-xl font-semibold outline-none focus:border-[var(--primary)]" />
            <button type="button" onClick={downloadNote} className="inline-flex items-center gap-2 rounded-lg bg-[var(--primary)] px-4 py-3 text-sm font-semibold text-white">
              <Download className="h-4 w-4" />
              Export
            </button>
            <button type="button" onClick={() => setDraft((current) => ({ ...current, note: "" }))} className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-4 py-3 text-sm font-semibold hover:bg-[var(--muted)]">
          ...
          <textarea
            ...
            className="mt-5 min-h-[560px] w-full resize-y rounded-lg border border-[var(--border)] bg-[var(--background)] p-5 text-base leading-8 outline-none focus:border-[var(--primary)]"
