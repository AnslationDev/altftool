...
import { Check, Copy, Users, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "People ops prompts",
  title: "HR Prompt Pack",
  intro:
    "Pick a people-ops task, fill in the blanks, and copy a prompt that already carries the structure, the fairness guardrails and the output format an HR document needs.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-8 text-[var(--foreground)] sm:px-6">
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="interview, onboarding, policy"
                value={query}
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Drafting aid only, not legal advice. Employment law differs by country and state — have any policy, contract or termination document reviewed by a qualified employment lawyer before it is used.
      </p>
    </main>
  );
}
