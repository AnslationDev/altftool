const seo = {
  ...
  benefits: [
    ["Songs, not hours", "Off-the-floor time is priced separately so the total is not inflated two or three times over."],
    ["Style-specific intensity", "Bachata, class drills, social on1/on2, rueda and performance work each use their own MET value."],
    ["Per-song figure", "Shows what a single track is worth, which is easier to sanity-check than a session total."],
  ],
  faqs: [
    [
