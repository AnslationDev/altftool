    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Navvarshachya shubhechha
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Marathi New Year Wishes
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Gudhi Padwa and January greetings in Devanagari with Roman transliteration, the English
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-occasion">
              Occasion
            </label>
            <select
              id="nym-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-tone">
              Tone
            </label>
            <select
              id="nym-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-relationship">
              Who is it for
            </label>
            <select
              id="nym-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-script">
              Script
            </label>
            <select
              id="nym-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nym-from">
              Your name (optional)
            </label>
            <input
              id="nym-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Marathi new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Marathi words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Devanagari is billed at 70 characters per
