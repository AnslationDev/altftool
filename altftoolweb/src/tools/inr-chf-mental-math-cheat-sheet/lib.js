...
/**
 * The Swiss franc. The Swiss National Bank's ninth series runs 10, 20, 50,
 * 100, 200 and 1000 francs — there is no 500 note, and the 1000-franc note is
 * one of the highest-value notes in general circulation anywhere. Coins go
 * down to 5 rappen (0.05 francs), and Switzerland is not in the euro area, so
 * euros are accepted only informally and at a poor rate with change given
 * back in francs.
 *
 * At recent levels the franc sits near the round figure of ₹100, which makes
 * "add two zeros, then nudge" the natural mental rule. CHF floats, so
...
export const CURRENCY = {
  ...
  symbol: "CHF ",
  country: "Switzerland",
  defaultInrPerUnit: 107,
  notes: [1000, 200, 100, 50, 20, 10],
  pricePoints: [
    { amount: 5, note: "Espresso in a café" },
    { amount: 9, note: "Supermarket lunch" },
    { amount: 25, note: "Casual restaurant plate" },
    { amount: 45, note: "Dinner main in Zurich" },
    { amount: 100, note: "Day of food and transport" },
    { amount: 250, note: "Mountain railway return" },
    { amount: 300, note: "Mid-range hotel night" },
    { amount: 500, note: "Weekend of spending" },
    { amount: 1000, note: "Week of ground costs" },
  ],
};
