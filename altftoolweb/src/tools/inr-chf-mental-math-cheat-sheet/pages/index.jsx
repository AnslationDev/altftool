  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">INR to CHF Mental Math Cheat Sheet</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">The franc sits close to a round hundred rupees, so the base move is to add two zeros and then nudge. Type today&rsquo;s rate and the sheet works out the exact size of that nudge, plus how far each shortcut is out.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-[var(--muted-foreground)]">The franc floats and is one of the strongest currencies against the rupee &mdash; check the day&rsquo;s mid-market rate.</p>
          </div>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Nothing here is fetched live &mdash; the sheet is built from the rate you type in. Switzerland is outside the euro area: shops may take euros informally but the rate is poor and change comes back in francs. Card settlements add your bank&rsquo;s foreign-currency markup on top of the mid-market rate.
      </p>
    </main>
  );
}
