...
import { Eye, Volume2, VolumeX, Sparkles, Compass, Search, X } from "lucide-react";
...
export default function AmbiguousFigureViewer() {
  ...
  const categories = useMemo(() => {
    return ["All", "People", "Animals", "Objects", "Motion", "Perspective", "Negative Space", "Impossible Shapes", "Gestalt", "Hidden Images", "Colors"];
  }, []);
  ...
  const userStats = useMemo(() => {
    ...
    const streak = Math.min(solvedCount, 7);
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-6 sm:px-6 md:py-10 lg:gap-10">
        ...
        <header className="flex items-center justify-between border-b border-slate-200/80 pb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleSound}
              className={`flex h-10 w-10 items-center justify-center rounded-2xl border transition ${soundEnabled
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1">
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`shrink-0 rounded-xl px-3.5 py-1.5 text-xs font-bold transition ${selectedCategory === cat
                    ? "chip-active bg-[#14b8a6] text-white shadow-xs"
              ...
              <div className="flex items-center gap-2 overflow-x-auto">
                ...
                {difficulties.map((diff) => (
                  <button
                    ...
                    className={`shrink-0 rounded-xl px-3 py-1.5 text-xs font-bold transition ${selectedDifficulty === diff
              ...
              <div className="flex items-center gap-2 overflow-x-auto">
                ...
                {statuses.map((st) => (
                  <button
                    ...
                    className={`shrink-0 rounded-xl px-3 py-1.5 text-xs font-bold transition ${selectedStatus === st
