...
import { Check, Copy, Briefcase, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Freelance prompts",
  title: "Freelancer Prompt Pack",
  intro:
    "Pick a client situation, fill in the blanks, and copy a prompt that already carries your scope, your rate and the firm-but-polite tone that keeps the relationship intact.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="proposal, scope, invoice"
                value={query}
