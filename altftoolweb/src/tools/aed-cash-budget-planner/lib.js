...
/**
 * The United Arab Emirates dirham. The dirham has been pegged to the US dollar
 * at AED 3.6725 since 1997, so the rupee–dirham rate moves only as far as the
 * rupee moves against the dollar. Notes run AED 5, 10, 20, 50, 100, 200, 500
 * and 1000.
 *
 * The UAE is heavily card-enabled, including taxis and the metro, but the old
 * souks, abra crossings and small cafeterias still run on notes, which is what
 * the default cash share reflects.
 */
export const CURRENCY = {
  ...
  cashRoundingStep: 50,
  defaultCashSharePct: 20,
  defaultCashMarkupPct: 1.5,
  defaultOneOffCash: 0,
  defaultAtmWithdrawal: 2000,
  spendStyles: [
    { id: "budget", label: "Budget", perDay: 120 },
    { id: "mid", label: "Mid-range", perDay: 300 },
    { id: "comfort", label: "Comfortable", perDay: 700 },
  ],
  cashFacts: [
    "The dirham is pegged to the US dollar at AED 3.6725, unchanged since 1997, so day-to-day movement against the rupee is really the rupee moving against the dollar.",
    "Cards work in taxis, malls, restaurants and on the metro through a Nol card, so the card share can be high.",
    "Notes still matter in the Deira and Bur Dubai souks, at abra crossings that cost a few dirhams, in small cafeterias, and for tipping valets and porters.",
    "VAT of 5% applies to most goods and services, and hotel bills carry municipality and service charges on top of the quoted room rate.",
    "Exchange houses in the UAE are competitive and often beat Indian counters, so many travellers carry a smaller float and change the rest on arrival.",
  ],
};
