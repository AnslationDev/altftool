const seo = {
  ...
  benefits: [
    ...
    ["Real Indian costs", "The GST slab on buying currency and the 18% GST on a card markup are both applied, so the rupee figure is the one you actually pay."],
    ["Splits by denomination", "Tells you which notes to ask for, which matters where an abra crossing costs a couple of dirhams."],
  ],
  faqs: [
    [
      "How much cash should I carry to Dubai from India?",
    ...
    [
      "What is the AED to INR exchange rate based on?",
    ...
    [
      "Is it better to exchange money in India or in the UAE?",
    ...
    [
      "How much foreign currency can I carry to the UAE?",
