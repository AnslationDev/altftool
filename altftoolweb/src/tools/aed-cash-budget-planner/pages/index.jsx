  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">AED Cash Budget Planner</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Works out how many dirhams to carry as notes for a UAE trip, what they cost once the changer&rsquo;s markup and GST are added, and how that compares with putting the same spend on a card.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Abra fares, souk bargaining money, desert-safari tips, or a hotel deposit the property wants in cash.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>The UAE is strongly card-enabled. Around 20% covers souks, small cafeterias, abras and tips.</p>
          </div>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className={HINT_CLASS}>The dirham is pegged to the dollar at 3.6725, so this rate tracks the rupee&ndash;dollar rate almost exactly.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>UAE machines commonly dispense up to AED 5,000 per transaction, though your own bank&rsquo;s per-withdrawal limit is usually the binding one.</p>
          </div>
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
          ...
          <p className={HINT_CLASS}>Keep small notes for abras, taxis and tips. AED 500 and AED 1,000 notes are awkward outside malls and hotels.</p>
        </section>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        accountant before a large purchase of foreign exchange. Exchange houses in the UAE are often cheaper than Indian counters, so a smaller float plus changing on arrival can beat the figure above &mdash; the trade-off is carrying less of a known rate.
      </p>
    </main>
  );
}
