...
import { Check, Copy, Utensils, RotateCcw } from "lucide-react";
...
const DEFAULT_BILL = "84";
const DEFAULT_UNITS = "2";
const DEFAULT_PARTY = "2";
const DEFAULT_ADD_ON = "8";
...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    if (failed) return "";
    const lines = [
      `Tipping in the USA — ${result.category.label}`,
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Tipping Guide Calculator for USA</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works out the customary US tip on the pre-tax subtotal, splits it across your party, and shows the going rate for bars, taxis, housekeeping, porters, valets and guides.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <h2 className="text-base font-semibold">What is customary in the USA</h2>
