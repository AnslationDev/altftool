...
import { Check, Copy, Code2, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Engineering prompts",
  title: "Developer Prompt Pack",
  intro:
    "Pick an engineering task, fill in the blanks, and copy a prompt that already carries the language, the constraints and the output format a reviewable answer needs.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="debug, review, tests"
                value={query}
