const seo = {
  title: "Wedding Trip Packing List with Baggage Weights",
  metaDescription:
  ...
  benefits: [
    ["Event-driven, not day-driven", "Outfits track functions, because functions are what get photographed."],
    ["Shoes counted by tier", "One formal pair, one dancing pair, one daytime pair — not one pair per event."],
    ["Weight checked before the airport", "Shows the overage in kilograms and measures the wear-it-on-the-plane workaround."],
  ],
  faqs: [
    [
