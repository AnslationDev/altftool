          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-surface-soft text-primary group-hover:bg-primary/10 transition-colors duration-300">
                <PieChart className="h-5 w-5 text-primary group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  <h1 className="text-xl font-bold text-foreground leading-none">Campaign Budget Planner</h1>
                ...
                <p className="text-xs text-muted-foreground mt-1 max-w-xl leading-relaxed">
                  Allocate your marketing budget across multiple channels, project acquisition metrics, plan milestones, and track tasks.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-1.5 text-[10px] font-semibold text-muted-foreground shrink-0 self-start md:self-auto">
              {["Budget Allocation", "Channel Planning", "Milestone Tracking"].map((item) => (
