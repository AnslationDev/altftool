    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Nave saal diyan vadhaiyan
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Punjabi New Year Wishes
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Vaisakhi, Nanakshahi and January greetings in Gurmukhi with Roman transliteration, the
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-occasion">
              Occasion
            </label>
            <select
              id="nyp-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-tone">
              Tone
            </label>
            <select
              id="nyp-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-relationship">
              Who is it for
            </label>
            <select
              id="nyp-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-script">
              Script
            </label>
            <select
              id="nyp-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nyp-from">
              Your name (optional)
            </label>
            <input
              id="nyp-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Punjabi new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Punjabi words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Gurmukhi is billed at 70 characters per
