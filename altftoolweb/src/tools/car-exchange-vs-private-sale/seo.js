const seo = {
  ...
  benefits: [
    ["Same date, same footing", "Private proceeds are discounted back to the day the exchange would have paid out."],
    ["Break-even price, not a gut feel", "Solves for the exact private price that matches the dealer, so you know your walk-away number."],
    ["Counts the costs people forget", "Detailing, listing fees, RTO transfer, holding cost and your own hours all appear as line items."],
  ],
  faqs: [
    [
