const seo = {
  title: "Voiceover Rate Calculator: Session + Usage Fee",
  metaDescription:
  ...
  benefits: [
    ["Session and usage separated", "The quote shows the recording fee and the licence fee as distinct lines, which is how buyers expect to see it."],
    ["Term comparison built in", "Every licence term is priced side by side so renewals and buyouts can be discussed with numbers."],
    ["Editable multipliers", "Every media, territory, term and exclusivity factor is visible and adjustable to your own market."],
  ],
  faqs: [
    [
