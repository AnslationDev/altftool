...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    if (failed) return "";
    const lines = [
      `Tipping in Spain — ${result.category.label}`,
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Tipping Guide Calculator for Spain</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works out the small Spanish propina locals actually leave — coins after a menú del día, around 5% after dinner — plus taxis, hotels and guides.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <h2 className="text-base font-semibold">What is customary in Spain</h2>
