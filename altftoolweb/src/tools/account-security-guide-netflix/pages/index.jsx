...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Tv } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Netflix Account Security Guide</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Netflix has no authenticator-app second factor, so the password and the device list do all the work. Tick each control as you set it; the score weights the ones that actually eject an intruder.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Changing the password without ticking the box that forces every device to sign in again.</li>
          <li>Assuming an old smart TV forgot the account when it was sold &mdash; it stays signed in until the session is ended.</li>
          <li>Paying a &ldquo;billing update&rdquo; link from an SMS, which is the most common Netflix scam and takes card details straight to the attacker.</li>
          <li>Treating a strange title in the viewing history as a glitch rather than as evidence of another viewer.</li>
        </ul>
      </section>
