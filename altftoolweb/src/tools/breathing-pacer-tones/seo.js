const seo = {
  ...
  benefits: [
    ["Audio, not just visuals", "A rising and falling tone means you can close your eyes instead of watching an animation."],
    ["Any ratio you like", "Inhale, both holds and exhale are set independently, and the tool shows the breath rate that results."],
    ["Honest numbers", "Breaths per minute, cycle length and session totals are calculated from your counts, not rounded to a preset."],
  ],
  faqs: [
    [
