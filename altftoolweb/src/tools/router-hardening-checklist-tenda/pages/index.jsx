...
const TOOL_TITLE = "Tenda Router Hardening Checklist";
const DASH = "—";
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Eighteen steps for a budget Tenda router, weighted by how much damage each gap causes. Two
          things make Tenda different: the setup wizard reuses your Wi-Fi password as the admin
          login, and the firmware has a long record of bugs that need no login at all. Both are
          treated as critical here. Nothing you tick leaves this page.
        </p>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Informational only. Menu labels move between Tenda firmware builds. Flash firmware over
        Ethernet and never cut power mid-update. If your model no longer receives firmware, no
        setting on this page substitutes for replacing it.
      </p>
    </main>
  );
}
