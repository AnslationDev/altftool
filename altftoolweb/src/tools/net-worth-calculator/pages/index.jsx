...
const PASCAL = "NetWorthCalculator";
const ICON = "Calculator";
const ICON_COLOR = "text-(--primary)";
const NAME = "Net Worth Calculator";
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 md:py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-(--muted-foreground)">
            Track your total assets minus liabilities. Add properties, investments, cash, loans, and credit card debt for a complete financial picture.
          </p>
        </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-(--border) bg-(--background)/50 p-8 text-center">
        ...
        <p className="mt-1 text-xs text-(--muted-foreground)/60">
          Get detailed projections for net worth calculator
        </p>
      </div>
    );
  }
