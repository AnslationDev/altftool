/**
 * Shopping App Permission Audit — pure logic.
 *
 * Scores an e-commerce or marketplace app. The test is whether a permission is
 * needed to browse, pay and receive a delivery: address entry, payment and order
 * tracking. Contacts, SMS, call logs and calendar fail that test outright.
 *
...
export const NECESSITY_LABEL = {
  ...
  unnecessary: "Not needed by a shopping app",
};
...
/**
 * Permissions and privacy settings a shopping app can hold.
...
export const PERMISSIONS = [
  {
    ...
    "tier": "minimal",
    "necessity": "core",
    "why": "Order confirmations, dispatch and delivery-window alerts.",
  ...
  },
  {
    ...
    "tier": "minimal",
    "necessity": "core",
    "why": "Locks checkout and saved cards behind your fingerprint or face.",
    "risk": "None — the biometric never leaves the phone's secure hardware; the app only gets a yes or no.",
    "recommend": "Keep it on. This one reduces your risk rather than adding to it.",
    "aliases": [
      "biometric",
      "fingerprint",
      "face id",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Drops an accurate pin on your delivery address and checks stock at a nearby store.",
    "risk": "Street-level position, and a home address the moment the app sees you overnight.",
    "recommend": "Set it to 'While using the app', or type the address and skip it entirely.",
    "aliases": [
      "precise location",
      "fine location",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "City-level position is enough for delivery estimates and serviceability checks.",
    "risk": "Still a movement record, but roughly neighbourhood-sized rather than street-level.",
    "recommend": "Prefer this over precise location — turn 'Use precise location' off in the permission screen.",
    "aliases": [
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Barcode scanning, virtual try-on and photographing an item for a return.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Attaching a photo to a review or a return request.",
  ...
  },
  {
    ...
    "why": "Pitched as 'refer a friend' — the referral works from a share link.",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "unnecessary",
    "why": "Nothing about browsing or ordering happens when the app is closed.",
    "risk": "Continuous location history is the single most re-identifying data an app can hold.",
    "recommend": "Revoke it. Set the permission to 'Allow only while using the app'.",
    "aliases": [
      "background location",
      "all the time",
      "location always",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "unnecessary",
    "why": "Reviews and returns upload one photo at a time through the picker.",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Voice search on the product catalogue.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "unnecessary",
    "why": "Offered as 'add the sale to your calendar' — a one-off event insert needs no read access.",
    "risk": "Your calendar reveals your employer, doctors, travel and personal life in plain text.",
    "recommend": "Revoke it and add reminders yourself.",
    "aliases": [
      "calendar",
      "read calendar",
      "events"
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "unnecessary",
    "why": "Used for in-store beacons that log which aisle you stand in.",
    "risk": "Bluetooth scanning maps the devices and beacons around you, which is indoor location by another name.",
    "recommend": "Revoke it unless you pair a device with this app.",
    "aliases": [
      "nearby devices",
      "bluetooth",
      "beacon"
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "unnecessary",
    "why": "Reading your full app list tells a shopping app nothing it needs to sell you a kettle.",
  ...
  },
  {
    ...
    "tier": "low",
    "necessity": "unnecessary",
    "why": "This is how the same product follows you into other apps.",
...
export function resultToText(result, appName = "Shopping app") {
  if (!result || result.error) return "";
  const name = String(appName || "Shopping app").trim() || "Shopping app";
  const lines = [
