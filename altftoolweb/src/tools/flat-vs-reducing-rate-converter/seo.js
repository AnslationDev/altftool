const seo = {
  ...
  useCases: [
    ...
    "Work out the true rate before signing, using just the loan amount, tenure and the flat rate the lender quoted.",
  ],
  benefits: [
    ...
    ["Works out the EMI for you", "Computes the instalment from the principal, tenure and quoted rate, then solves for the equivalent basis — no separate EMI figure needed."],
  ],
  faqs: [
    [
      "Is a flat rate the same as a reducing rate?",
      "No, and the difference is large. A flat rate is charged on the original principal every month even though you have already repaid part of it, so a flat rate is usually close to twice its reducing-balance equivalent — roughly 8% flat behaves like about 14% reducing over five years.",
    ],
    [
    ...
    [
      ...
      "Because the number looks smaller. A dealer quoting 8% flat is offering roughly the same deal as a bank quoting 14% reducing, but the flat figure reads as the better offer to anyone comparing headline rates.",
    ],
    [
