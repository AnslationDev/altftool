const seo = {
  ...
  benefits: [
    ["Coaching classified correctly", "Section 44ADA does not cover coaching, so the tool applies 44AD at 6%/8% of turnover, which is the route actually available."],
    ["Both regimes, fully computed", "Slabs, 87A rebate, surcharge bands and cess are applied with marginal relief at each boundary, not approximated."],
    ["Compliance thresholds flagged", "Books under 44AA, tax audit under 44AB, the 20 lakh GST services threshold and advance tax are all checked against your numbers."],
  ],
  faqs: [
    [
