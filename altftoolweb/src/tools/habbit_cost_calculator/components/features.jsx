...
const Features = () => {
  const features = [
    {
      title: "Accurate Habbit Cost Calculation",
      description:
        "Calculate the exact cost of your habits based on your usage patterns and expenses.",
    },
    {
      title: "Instant Results",
      description:
        "Get your habit costs calculated immediately with real-time processing. No delays, just quick and accurate output.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Minimal, distraction-free design that makes calculating your habit costs easy and user-friendly.",
    },
    {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-(--foreground) mb-4">
            Why Choose Our Habbit Cost Calculator?
          </h2>
          <p className="text-base sm:text-lg text-(--muted-foreground) max-w-2xl mx-auto leading-relaxed">
            Simple, fast, and accurate habit cost calculation for everyone
          </p>
        </div>
