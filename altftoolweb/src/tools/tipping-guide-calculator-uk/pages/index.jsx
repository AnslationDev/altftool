...
const DEFAULT_BILL = "90";
const DEFAULT_UNITS = "2";
const DEFAULT_PARTY = "2";
const DEFAULT_ADD_ON = "12.5";
...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    if (failed) return "";
    const lines = [
      `Tipping in the UK — ${result.category.label}`,
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Tipping Guide Calculator for UK</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works out the customary UK tip, tells you when a 12.5% discretionary service charge already covers it, and shows the going rate for cabs, hotels, salons and guides.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <h2 className="text-base font-semibold">What is customary in the UK</h2>
