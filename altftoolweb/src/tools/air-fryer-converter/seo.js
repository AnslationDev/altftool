const seo = {
  title: "Oven to Air Fryer Converter — Time & Temp",
  metaDescription:
  ...
  benefits: [
    ["Shows the rule, not just the answer", "Every result states the −25°C and ×0.8 arithmetic so you can adjust it yourself for a thicker cut."],
    ["Warns when the setting is out of range", "Flags conversions above the 200°C/400°F ceiling most basket air fryers have and suggests adding 2-3 minutes at max instead."],
    ["Ties timing to doneness", "Gives a shake/flip point at the halfway mark, a check-early time, and the safe internal temperature for each food group."],
  ],
  faqs: [
    [
