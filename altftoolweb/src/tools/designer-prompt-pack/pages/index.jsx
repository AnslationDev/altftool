...
const PACK = {
  kicker: "Design prompts",
  title: "Designer Prompt Pack",
  intro:
    "Pick a design task, fill in the blanks, and copy a prompt that already carries the constraints, the output format and the guardrails a good brief needs.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="critique, tokens, empty state"
                value={query}
