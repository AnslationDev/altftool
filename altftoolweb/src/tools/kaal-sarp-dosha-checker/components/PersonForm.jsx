...
export default function PersonForm({ data, onChange }) {
  ...
  return (
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-sm">
      <div className="flex items-center gap-2 border-b border-[var(--border)] px-5 py-3.5 bg-violet-500/5">
        <User className="h-4 w-4 text-violet-600" />
        <h3 className="text-sm font-bold text-[var(--foreground)]">Birth Details</h3>
      </div>
