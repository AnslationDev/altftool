/**
 * Pune airport transfer time planner — Pune International Airport (PNQ / VAPO).
 *
 ...
 *
 * PNQ at Lohegaon is a civil enclave inside an Air Force station with a compact
 * terminal and a small forecourt, so it is close to the eastern suburbs but the last
 * kilometre can be slow when several flights bank together.
 *
...
export const AIRPORT = {
  ...
  city: "Pune",
  terminals: "a single compact terminal at Lohegaon, a civil enclave inside an Air Force station",
};
...
export const COPY = {
  ...
  footnote:
    "PNQ is a compact civil enclave at Lohegaon with a small forecourt, so the drop-off itself can be slow when several departures bank together — that is what the personal buffer is for. Distances are short from the eastern suburbs and long from Hinjawadi, and Pune's peaks are steep, so the hour you leave matters more than the kilometres do. The congestion profile is a typical-weekday approximation, not a live traffic feed: check a live map before leaving. Airline bag-drop and gate closing times are the ones printed on your booking.",
};
 ...
 * trip starting in that hour. Pune's peaks are steep for a city of its size, driven by
 * the IT commute along the Hinjawadi and Kharadi corridors — a morning peak around
 * 08:00-10:00 and an evening one from about 17:00 to 20:00. It is a typical-day
...
export const TRAFFIC_PROFILE = [
  ...
  1.2, 1.45, 1.7, 1.85, 1.75, 1.5, // 06:00-11:59
  1.4, 1.35, 1.35, 1.45, 1.65, 1.85, // 12:00-17:59
  1.85, 1.7, 1.45, 1.25, 1.1, 1.0, // 18:00-23:59
];
...
/**
 * Typical road distance from the area to the terminal at Lohegaon. Enter your own
 * figure if you are starting somewhere else; these are only quick-fill values.
 */
export const ORIGINS = [
  { id: "viman-nagar", label: "Viman Nagar", km: 4 },
  { id: "kalyani-nagar", label: "Kalyani Nagar", km: 6 },
  { id: "koregaon-park", label: "Koregaon Park", km: 8 },
  { id: "kharadi", label: "Kharadi", km: 8 },
  { id: "pune-junction", label: "Pune Junction", km: 10 },
  { id: "hadapsar", label: "Hadapsar", km: 13 },
  { id: "baner", label: "Baner", km: 16 },
  { id: "hinjawadi", label: "Hinjawadi", km: 24 },
];
 ...
 * parking and the walk in, or the wait at the bus stop.
 */
export const MODES = [
  {
    id: "app-cab",
  ...
  },
  {
    ...
    freeFlowKmh: 38,
    trafficSensitive: true,
    fixedOverheadMinutes: 16,
    note: "Includes parking and the walk to departures. The car park at Lohegaon is small, so allow for a full one at peak departure banks.",
  },
  {
    id: "auto",
    label: "Auto rickshaw",
    ...
    note: "Practical from the eastern suburbs, where the airport is only a few kilometres away.",
  },
  {
    id: "bus",
    label: "PMPML or city bus",
    freeFlowKmh: 22,
    trafficSensitive: true,
    fixedOverheadMinutes: 15,
    note: "Slower free-flow speed for stops, plus the wait at the bus stop.",
  },
];
