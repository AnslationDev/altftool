const seo = {
  title: "Money Habit Score: 11 Checks Against Real",
  metaDescription:
  ...
  useCases: [
    "A first-time earner checking whether the money going out each month leaves any room, before taking a car loan.",
    "A couple reviewing cover and nominations once a year and wanting a single number to compare against last year's.",
    "Someone who feels behind but does not know which of savings, debt or protection is actually the problem.",
  ],
  benefits: [
    ["Named benchmarks", "Every check states the standard it measures against instead of scoring on vibes."],
    ["Rupee-specific gaps", "Tells you the shortfall in rupees, not just that a number is low."],
    ["Ranked actions", "Sorts the weak spots by how much they drag the score down, so you fix the biggest one first."],
  ],
  faqs: [
    [
