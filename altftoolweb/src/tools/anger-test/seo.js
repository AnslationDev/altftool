const seo = {
  ...
  benefits: [
    ["Scenarios, not adjectives", "You pick what you would actually do in a specific situation, which is harder to flatter yourself on than rating your own temper out of ten."],
    ["Names the style, not just the size", "The same total also maps to a response pattern — constructive, passive, reactive, suppressed or chronic — because bottled-up anger and explosive anger need different responses."],
    ["Suggestions matched to the band", "The Moderate band gets 4-7-8 breathing and the STOP technique; the High band leads with getting a licensed professional involved."],
  ],
  faqs: [
    [
