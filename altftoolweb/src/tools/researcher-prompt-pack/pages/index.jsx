...
import { Check, Copy, Microscope, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Research prompts",
  title: "Researcher Prompt Pack",
  intro:
    "Pick a research task, fill in the blanks, and copy a prompt that treats the model as a critical colleague — every one demands verifiable claims and flags where citations must be checked by hand.",
};
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="literature, methods, abstract"
                value={query}
