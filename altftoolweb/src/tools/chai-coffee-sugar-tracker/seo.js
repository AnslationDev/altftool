const seo = {
  ...
  benefits: [
    ["Sugar separated from milk", "Base drink calories and added sugar are counted apart, so you can see which one is the problem."],
    ["Measured against WHO guidance", "Both the 10% ceiling and the 5% further-benefit level are computed for your own calorie intake."],
    ["Scaled to a year", "Daily grams become kilograms a year, which is what makes a two-spoon habit visible."],
  ],
  faqs: [
    [
