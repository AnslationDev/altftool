const seo = {
  ...
  benefits: [
    ["Readiness, not page count", "A chapter is only complete once it has been revised and its previous-year questions solved."],
    ["Pace maths built in", "Divides the chapters still open by the days left and reports a weekly target you can hold yourself to."],
    ["Marks context on every subject", "Shows the CBSE theory and practical or internal-assessment split, so 30-mark practicals are not forgotten."],
  ],
  faqs: [
    [
