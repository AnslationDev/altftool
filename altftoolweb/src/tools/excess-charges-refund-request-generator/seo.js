const seo = {
  ...
  benefits: [
    ["GST handled correctly", "Adds 18% GST on the fee, or strips it out when you paste the GST-inclusive statement figure."],
    ["Escalation dates pre-filled", "Shows the 30-day bank reply deadline and the Ombudsman filing cut-off derived from your letter date."],
    ["Itemised annexure", "Each disputed debit is listed with date, description, base amount, GST and total so the branch can trace it."],
  ],
  faqs: [
    [
