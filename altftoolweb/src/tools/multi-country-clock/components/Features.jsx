...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Switch between 12-hour and 24-hour time formats for a personalized experience.",
    },
    {
      title: "Perfect for Remote Teams",
      description:
        "Coordinate meetings and manage global collaborations efficiently across different time zones.",
    },
    {
