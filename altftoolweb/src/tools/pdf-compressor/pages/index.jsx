...
async function getPdfJs() {
  ...
  // Resolve the worker from the installed pdfjs-dist package itself (rather
  // than the shared /altflovepdf/pdf.worker.min.mjs static asset) so the
  // worker's API version always matches whatever pdfjs-dist version this
  // tool actually bundles.
