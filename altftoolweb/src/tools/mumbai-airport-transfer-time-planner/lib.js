/**
 * Mumbai airport transfer time planner — Chhatrapati Shivaji Maharaj International Airport (BOM / VABB).
 *
 ...
 *
 * Mumbai's geography matters here: the island city funnels almost all northbound
 * traffic onto a handful of arterial roads, so the penalty for leaving during a peak
 * is unusually large from the southern suburbs.
 *
...
export const AIRPORT = {
  ...
  city: "Mumbai",
  terminals: "T1 at Santacruz (domestic) and T2 at Sahar (international plus full-service domestic)",
};
...
export const COPY = {
  ...
  footnote:
    "T1 at Santacruz and T2 at Sahar are separate buildings several kilometres apart with no airside connection, so check which one your flight uses and enter the distance to that terminal — arriving at the wrong one costs 20 to 30 minutes. The congestion profile is a typical-weekday approximation, not a live traffic feed: check a live map before leaving, and add time for monsoon flooding, roadworks or a diversion. Airline bag-drop and gate closing times are the ones printed on your booking.",
};
 ...
 * report for Mumbai — a sharp morning peak around 08:00-10:00, a long evening peak
 * from about 17:00 to 21:00, and near free-flow conditions overnight. It is a
...
export const TRAFFIC_PROFILE = [
  ...
  1.2, 1.45, 1.7, 1.8, 1.7, 1.5, // 06:00-11:59
  1.4, 1.35, 1.35, 1.45, 1.6, 1.8, // 12:00-17:59
  1.8, 1.65, 1.45, 1.25, 1.1, 1.0, // 18:00-23:59
];
...
/**
 * Typical road distance from the area to Terminal 2 at Sahar. Enter your own figure if
 * you are starting somewhere else; these are only quick-fill values.
 */
export const ORIGINS = [
  { id: "andheri-east", label: "Andheri East", km: 4 },
  { id: "bkc", label: "Bandra Kurla Complex", km: 6 },
  { id: "powai", label: "Powai", km: 10 },
  { id: "dadar", label: "Dadar", km: 15 },
  { id: "borivali", label: "Borivali", km: 22 },
  { id: "vashi", label: "Navi Mumbai (Vashi)", km: 22 },
  { id: "colaba", label: "Colaba / Churchgate", km: 26 },
  { id: "thane", label: "Thane", km: 26 },
];
...
export const MODES = [
  ...
  {
    id: "metro-aqua",
    label: "Metro Line 3 (Aqua Line)",
    freeFlowKmh: 33,
    trafficSensitive: false,
    fixedOverheadMinutes: 25,
    note: "Runs underground with stations at both terminals, so road congestion does not touch it. Overhead covers the ticket, the platform wait and the walk into the terminal — add your time to reach the Aqua Line to the personal buffer.",
  },
  {
    id: "bus",
