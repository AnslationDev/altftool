...
const DEFAULTS = {
  ...
  tripDays: 6,
  laundryEveryDays: 3,
  venueIds: ["sultan-mosque","hindu-temple","marina-bay","mall-mrt"],
  headCover: false,
};
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Singapore Dress Code Planner for Travellers
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Pick the month and the places you plan to visit. The planner applies the house rules
          at each site, checks them against Changi&rsquo;s 1991&ndash;2020 climate normals, and turns
          the result into a counted packing list.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="sg-month">
              Month of travel
            </label>
            <select
              id="sg-month"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sg-days">
              Trip length (days)
            </label>
            <input
              id="sg-days"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sg-laundry">
              Laundry every (days)
            </label>
            <input
              id="sg-laundry"
            ...
            <p className="mt-1 text-xs text-[var(--muted-foreground)]">
              Coin laundrettes sit in most HDB blocks; hotel laundry is charged per piece.
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy the Singapore packing plan"
              className={GHOST_BTN}
              disabled={hasError}
            >
              {copied ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Climate figures are Meteorological Service Singapore normals for Changi and barely vary
        by month &mdash; what changes is the rain. House rules at places of worship tighten during
        Ramadan, Deepavali and Vesak; check the venue before you travel.
      </p>
    </main>
  );
}
