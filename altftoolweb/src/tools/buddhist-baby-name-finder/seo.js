const seo = {
  ...
  benefits: [
    ["Sourced meanings", "Each entry gives the literal sense of the Pali, Sanskrit or Tibetan word, not a marketing gloss."],
    ["Canonical context", "Names tied to a disciple, a brahmavihara or a bodhisattva carry a short note saying who or what."],
    ["Filter by shape", "Cap the letter count, fix the starting letter or search the meaning text to narrow a long list fast."],
  ],
  faqs: [
    [
