const seo = {
  title: "Emergency Fund Calculator India: Months & Target",
  metaDescription:
  ...
  useCases: [
    "You are a freelancer with two dependants and no personal health policy, and want to know whether six months of cover is enough.",
    "Both partners work in stable listed companies with a 10 lakh floater policy, and you suspect you are holding too much idle cash.",
    "You have 1.5 lakh saved and can add 15,000 a month, and want the month in which your fund will be fully funded.",
  ],
  benefits: [
    ["Risk-adjusted, not one-size", "Government service, a startup job and self-employment produce genuinely different targets from the same expenses."],
    ["EMIs counted properly", "Committed loan instalments are part of the outgo you must keep paying with no income, so they sit inside the target."],
    ["A date, not just a number", "Compounding on the parked money is included, so the time-to-goal reflects a sweep FD or liquid fund rather than a plain division."],
  ],
  faqs: [
    [
    ...
    [
      "Is it a mistake to hold more than 12 months of expenses in cash?",
