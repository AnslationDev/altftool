...
const PRONOUN_LABEL = {
  timi: "तिमी (timi) — casual",
  tapai: "तपाईं (tapai) — polite",
  neutral: "Works with either pronoun",
};
...
export default function ToolHome() {
  ...
  const isDevanagari = script === "nepali";
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Nepali Birthday Wishes Generator
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Get complete Nepali birthday messages in Devanagari or Roman letters. Casual tones use
          तिमी (timi) and formal tones use तपाईं (tapai), with the verb endings changed to match.
        </p>
      </header>
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="np-name">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="np-relation">
              Your relationship
            </label>
            <select
              id="np-relation"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="np-tone">
              Tone
            </label>
            <select
              id="np-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="np-script">
              Script
            </label>
            <select
              id="np-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="np-age">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="np-count">
              How many wishes
            </label>
            <select
              id="np-count"
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            ...
            className={GHOST_BTN}
            aria-label="Show a different set of Nepali birthday wishes"
          >
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <button
            ...
            aria-label="Copy all Nepali birthday wishes"
          ...
          <>
            <dl className="mt-5 divide-y divide-[var(--border)] text-sm">
              {[
                ...
                ["Script", isDevanagari ? "Devanagari" : "Roman (Latin letters)"],
                ["Politeness level", PRONOUN_LABEL[result.pronoun] ?? EM_DASH],
            ...
            <ul className="mt-5 space-y-3">
              {result.wishes.map((wish) => (
                ...
                >
                  <p
                    lang={result.lang}
                    className={`leading-9 ${isDevanagari ? "text-lg" : "text-base"}`}
                  >
                    {wish.text}
                  </p>
                  <button
                    ...
                    aria-label="Copy this Nepali birthday wish"
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Using timi with an elder, or tapai with a close friend, both sound wrong to a Nepali speaker.
        Pick the tone that matches the relationship rather than the one you like the sound of.
      </p>
    </main>
  );
}
