...
/**
 * The Thai baht. Bank of Thailand notes run 20, 50, 100, 500 and 1000 baht.
 *
 * Thailand is the cash-heavy end of this family: street kitchens, songthaews,
 * tuk-tuks, markets and many island guesthouses take notes only, which is why
 * the default cash share is well above half.
 *
 * The number that dominates the arithmetic is the flat fee Thai banks charge a
 * foreign card for an ATM withdrawal — around THB 220 per transaction, on top
 * of whatever your own bank charges. Fewer and larger withdrawals therefore
 * cost materially less than several small ones.
 */
export const CURRENCY = {
  ...
  spendStyles: [
    ...
    { id: "comfort", label: "Comfortable", perDay: 4500 },
  ],
  cashFacts: [
    "Thai banks charge a foreign card a flat fee of roughly ฿220 for each ATM withdrawal, on top of your own bank's charge — so make fewer, larger withdrawals.",
    "Street food, songthaews, tuk-tuks, markets, temple donations and many island guesthouses are cash-only.",
    "The ฿1,000 note is hard to break at a small stall. Split it at a 7-Eleven or supermarket and keep ฿20s and ฿100s for daily spending.",
    "Malls, hotels, chain restaurants, trains and airport transfers take cards without trouble.",
    "Decline any terminal or ATM that offers to bill you in rupees; paying in baht is almost always cheaper.",
  ],
};
