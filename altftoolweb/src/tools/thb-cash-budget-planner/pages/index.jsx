  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">THB Cash Budget Planner</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Thailand still runs largely on notes. This works out how much baht to carry, what it costs once the changer&rsquo;s markup and GST are added, and whether buying in India beats the ฿220-a-time ATM fee at the other end.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Visa-on-arrival fee if one applies to you, scooter or guesthouse deposits, island boat transfers and national park entry.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Thailand is cash-heavy outside malls and hotels. Around 55% is realistic for street food, transport and markets.</p>
          </div>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className={HINT_CLASS}>The baht floats against the rupee &mdash; use the day&rsquo;s mid-market rate rather than a counter&rsquo;s quote.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Thai machines usually cap a single withdrawal at ฿20,000 to ฿30,000. Because the ฿220 fee is per transaction, withdraw the maximum each time.</p>
          </div>
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
          ...
          <p className={HINT_CLASS}>Ask for ฿100s and ฿500s rather than a stack of ฿1,000s &mdash; small vendors often cannot change the largest note.</p>
        </section>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        accountant before a large purchase of foreign exchange. The Thai per-withdrawal ATM fee is set by the local bank, not yours, and has been around ฿220 for several years; confirm it before relying on the comparison above.
      </p>
    </main>
  );
}
