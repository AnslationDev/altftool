/**
 * Departure planning for Hamad International Airport (DOH / OTHH).
 *
...
export const AIRPORT = {
  ...
  city: "Doha",
  terminals: [
    "One passenger terminal with Concourses A to E, plus the newer D and E extensions",
    "Central check-in hall for all airlines, with dedicated Qatar Airways premium check-in",
    "Trains and long moving walkways serve the far ends of Concourses D and E",
  ],
};
...
/** Baseline queue times at DOH in normal conditions, before the queue factor. */
...
/**
 * Every departure from DOH is international. Qatar Airways advises passengers to
 * be at the airport 3 hours before departure, which is the reporting time used for
 * both options here. The options differ in the walk to the gate: the far ends of
 * Concourses D and E are a long way past passport control. Check-in closing 60
 * minutes before departure and the boarding gate closing 20 minutes before
 * departure follow the published Qatar Airways rules; other carriers can differ.
 */
export const JOURNEY_TYPES = [
  {
    ...
    immigrationMinutes: 15,
    immigrationLabel: "Passport control (e-gates or counters)",
    gateWalkMinutes: 18,
...
/** Multiplier applied to the free-flow drive time. Doha is compact and the expressway network is fast, so even peak factors stay modest compared with South Asian metros. */
export const TRAFFIC_LEVELS = [
  { id: "clear", label: "Clear (night / early morning)", multiplier: 1 },
  { id: "typical", label: "Typical daytime", multiplier: 1.15 },
  { id: "heavy", label: "Heavy (rush hour)", multiplier: 1.45 },
  { id: "severe", label: "Severe (sandstorm, event closure, major incident)", multiplier: 1.8 },
];
...
export const QUEUE_LEVELS = [
  ...
  { id: "peak", label: "Peak wave (early-morning and evening departure banks)", multiplier: 1.5 },
];

/**
 * Doha road rush-hour windows, as minutes from midnight. Used only to SUGGEST a
...
/**
 * Indicative free-flow (no-traffic) road times to DOH from common starting
 * points. They are starting estimates only - replace the minutes with a live maps
 * estimate for your own address.
 */
export const AREA_PRESETS = [
  { id: "msheireb", label: "Msheireb / Souq Waqif / Old Doha", driveMinutes: 12 },
  { id: "westbay", label: "West Bay / Diplomatic Area", driveMinutes: 15 },
  { id: "alwakrah", label: "Al Wakrah / Al Wukair", driveMinutes: 18 },
  { id: "pearl", label: "The Pearl / Lusail Marina", driveMinutes: 25 },
  { id: "educationcity", label: "Education City / Al Rayyan", driveMinutes: 25 },
  { id: "lusail", label: "Lusail city centre", driveMinutes: 28 },
  { id: "alkhor", label: "Al Khor", driveMinutes: 50 },
  { id: "dukhan", label: "Dukhan", driveMinutes: 75 },
