  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Doha DOH Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Hamad International through the boarding gate, passport control, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-journey">
              Flight profile
            </label>
            <select
              id="doh-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-bags">
              Baggage
            </label>
            <select
              id="doh-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-area">
              Starting from
            </label>
            <select
              id="doh-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-traffic">
              Road conditions
            </label>
            <select
              id="doh-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-queue">
              Terminal queues
            </label>
            <select
              id="doh-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="doh-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="doh-buffer">
