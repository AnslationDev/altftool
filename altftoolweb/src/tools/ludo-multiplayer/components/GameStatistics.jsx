...
import { Button, Modal } from "@altftool/ui";
import {
  Trophy, RotateCcw, Clock, Zap, TrendingUp, BarChart3, Target, Activity,
} from "lucide-react";

export default function GameStatistics({ stats, open, onClose, onReset }) {
  const items = [
  ...
  return (
    <Modal open={open} onClose={onClose} title="Statistics" size="md">
      <motion.div
