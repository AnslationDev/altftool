...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    ...
    return [
      ...
      `Services completed so far: ${result.completed}`,
      "",
      ...result.services.map(
        (service) =>
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Map out every free and paid service on a Hero motorcycle. Each milestone is dated at
          whichever comes first, the kilometre figure or the month, and priced with the consumables
          that fall due at that visit.
        </p>
      </header>
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-date">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-odo">
              Current odometer (km)
            </label>
            <input
              id="hero-odo"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-monthly">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-count">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-free">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-first">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-labour">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="hero-index">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy Hero service schedule"
              className={GHOST_BTN}
              disabled={hasError}
            >
              {copied ? (
