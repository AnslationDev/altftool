            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${settings.darkMode ? "bg-(--primary)" : "bg-(--muted)"}`}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${settings.autoSave ? "bg-(--primary)" : "bg-(--muted)"}`}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${settings.animations ? "bg-(--primary)" : "bg-(--muted)"}`}
                >
              ...
              <div className="border-t border-(--border) pt-4">
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-xl border border-(--danger)/30 px-4 py-3 text-sm font-semibold text-(--danger) transition-all hover:bg-(--danger)/10"
                >
