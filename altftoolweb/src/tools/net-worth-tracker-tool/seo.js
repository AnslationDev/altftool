const seo = {
  title: "Net Worth Tracker: Debt-to-Asset Ratio",
  metaDescription:
  ...
  useCases: [
    ...
    "Seeing how much of a balance sheet that looks healthy is locked in a flat, jewellery and a depreciating car.",
  ],
  benefits: [
    ["Liquidity made visible", "EPF, PPF and property are counted as assets but not as money you can reach this week."],
    ["Ratios, not just a total", "Debt-to-asset and months-of-expenses liquidity say more about resilience than the headline figure."],
    ["Private by construction", "The statement is calculated locally in your browser; no figures leave the page."],
  ],
  faqs: [
    [
    ...
    [
      "Should I include my house and EPF in net worth?",
