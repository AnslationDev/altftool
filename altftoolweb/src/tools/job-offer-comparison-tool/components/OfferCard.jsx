  ...
  return (
    <div className="job-offer-card">
      <div className="job-offer-header">
        <div>
          <h3 className="job-offer-company">
      ...
      <div className="job-slider-group">
        ...
        <input
          ...
          value={offer.bonus}
          onChange={(e) =>
            handleChange("bonus", parseFloat(e.target.value) || 0)
          }
          style={{
            width: "100%",
            padding: "8px 12px",
      ...
      <div className="job-slider-group">
        ...
        <input
          ...
          value={offer.esop}
          onChange={(e) =>
            handleChange("esop", parseFloat(e.target.value) || 0)
          }
          style={{
            width: "100%",
            padding: "8px 12px",
      ...
      <div className="job-slider-group">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("joiningBonus", parseFloat(e.target.value) || 0)
          }
          style={{
            width: "100%",
            padding: "8px 12px",
        ...
        <>
          ...
          <div className="job-slider-group">
            <div className="job-slider-label">
              ...
              <span className="job-slider-value">
                {offer.workLifeBalance}/10
              </span>
            </div>
            <input
              type="range"
              ...
              onChange={(e) =>
                handleChange("workLifeBalance", parseFloat(e.target.value))
              }
          ...
          <div className="job-slider-group">
            <div className="job-slider-label">
              <span className="job-slider-label-text">
                Growth Opportunities
              </span>
              <span className="job-slider-value">
                {offer.growthOpportunities}/10
              </span>
            </div>
            <input
              type="range"
              ...
              onChange={(e) =>
                handleChange("growthOpportunities", parseFloat(e.target.value))
              }
              className="job-slider"
            />
          </div>
          ...
          <div className="job-slider-group">
            <div className="job-slider-label">
              ...
              <span className="job-slider-value">
                {offer.learningOpportunities}/10
              </span>
            </div>
            <input
              type="range"
          ...
          <div className="job-slider-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("companyStability", parseFloat(e.target.value))
              }
              className="job-slider"
            />
          </div>
      ...
      <div className="job-offer-actions">
        <button
          ...
          onClick={() => {
            const label = offer.companyName
              ? `the offer from ${offer.companyName}`
              : "this offer";
            if (
