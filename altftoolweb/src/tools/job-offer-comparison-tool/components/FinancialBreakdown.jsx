...
const FinancialBreakdown = ({ offers }) => {
    ...
    return (
        <div className="job-comparison-section">
            ...
            >
                <div style={{ background: 'var(--job-surface-hover)', padding: '16px', borderRadius: '12px' }}>
                    <div
                        style={{
                            fontSize: '12px',
                            fontWeight: 600,
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        <div className="job-financial-item">
                            ...
                            <span className="job-financial-value">₹{(financials.inHandMonthly / 100000).toFixed(1)}L</span>
                        </div>
                        <div className="job-financial-item">
                            <span className="job-financial-label">Monthly ESOP Value</span>
                            <span className="job-financial-value">₹{(financials.esopValue / 100000).toFixed(1)}L</span>
                        </div>
                        <div className="job-financial-item">
                            <span className="job-financial-label">Joining Bonus (Monthly Avg)</span>
                            <span className="job-financial-value">₹{(financials.joiningMonthly / 100000).toFixed(1)}L</span>
                        </div>
                        <div
                        ...
                        <div className="job-financial-item">
                            ...
                            <span className="job-financial-value">₹{(financials.estimatedTax / 100000).toFixed(1)}L</span>
                        </div>
                        <div className="job-financial-item">
                            <span className="job-financial-label">Estimated Annual Savings</span>
                            <span className="job-financial-value job-financial-highlight">
                                ₹{(financials.annualSavings / 100000).toFixed(1)}L
                            </span>
                        </div>
