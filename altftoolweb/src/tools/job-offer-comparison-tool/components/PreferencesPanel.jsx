    ...
    <div className="job-card">
      ...
      <div className="job-preference-item">
        <div className="job-preference-label">
          ...
          <span className="job-preference-value">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("salaryWeight", parseInt(e.target.value))
          }
      ...
      <div className="job-preference-item">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("remoteWeight", parseInt(e.target.value))
          }
          className="job-slider"
        />
      </div>
      ...
      <div className="job-preference-item">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("growthWeight", parseInt(e.target.value))
          }
          className="job-slider"
        />
      </div>
      ...
      <div className="job-preference-item">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("stabilityWeight", parseInt(e.target.value))
          }
          className="job-slider"
        />
      </div>
      ...
      <div className="job-preference-item">
        <div className="job-preference-label">
          <span className="job-preference-label-text">
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("learningWeight", parseInt(e.target.value))
          }
          className="job-slider"
        />
      </div>
