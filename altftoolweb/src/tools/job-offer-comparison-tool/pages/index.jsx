      ...
      <div className="job-main-content">
            ...
            {offers.length === 0 ? (
              <div className="job-empty-state">
                ...
                <p className="job-empty-text">
                  Add your first job offer to get started with the comparison
                  tool.
                </p>
              </div>
            ) : (
        ...
        {activeTab === "comparison" && (
          <>
            ...
            {offers.length < 2 ? (
              <div className="job-empty-state">
                <p className="job-empty-text">
                  Add at least 2 offers to compare them side by side.
                </p>
              </div>
            ) : (
              <>
        ...
        {activeTab === "saved" && (
          <>
            ...
            <div className="job-empty-state">
              <p className="job-empty-text">
                Your current comparison is automatically saved in your browser.
              </p>
              <p
                className="job-empty-text"
                style={{ marginTop: "12px", fontSize: "13px" }}
              >
                Use the Export option to save additional comparisons or download
                them.
              </p>
            </div>
          </>
          ...
          <>
            ...
            <div style={{ maxWidth: "600px" }}>
              {offers.length === 0 ? (
                <div className="job-empty-state">
                  <p className="job-empty-text">
                    Add offers first before exporting.
                  </p>
                </div>
              ) : (
                <>
        ...
        {activeTab === "help" && (
          <>
            ...
            <div
              className="job-comparison-section"
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Click "Add Offer" to add job offers. Fill in company name,
                    role, salary details, and optional information.
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    Go to Preferences and adjust weights based on what matters
                    most to you (salary, remote, growth, etc.).
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    Check the comparison table, charts, and recommendations. The
                    tool calculates scores based on your preferences.
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    Export as JSON, CSV, or save locally. Your data is stored
              ...
              >
                ...
                >
                  The overall score combines salary (20%), bonus (20%), ESOP
                  (15%), work-life balance (15%), growth (15%), stability (10%),
                  and learning (5%).
                </p>
              </div>
            </div>
