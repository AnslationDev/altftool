...
import { Check, Copy, TrendingUp, RotateCcw, Search } from "lucide-react";

import { CATEGORIES, PROMPTS, fillPrompt, searchPrompts } from "../lib";

const PACK = {
  kicker: "Sales prompts",
  title: "Sales Prompt Pack",
  intro:
    "Pick a step in the deal, fill in the blanks, and copy a prompt that already carries the framework, the word limits and the honesty rules that stop AI-written sales copy sounding like AI-written sales copy.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-8 text-[var(--foreground)] sm:px-6">
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                placeholder="cold email, discovery, objection"
                value={query}
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Drafting aid only. Cold outreach is regulated — the US CAN-SPAM Act requires a working opt-out and a valid postal address in commercial email, and EU/UK rules require a lawful basis for contacting people. Check your obligations before sending at volume.
      </p>
    </main>
  );
}
