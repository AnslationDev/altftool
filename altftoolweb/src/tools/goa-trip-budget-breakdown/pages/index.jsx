...
const BASE_DEFAULTS = {
  travellers: "2",
  nights: "4",
  entryFees: String(DEFAULT_ENTRY_FEES_PER_PERSON),
...
export default function ToolHome() {
  ...
  const [entryFees, setEntryFees] = useState(BASE_DEFAULTS.entryFees);
  ...
  const result = useMemo(
    () =>
      buildTripBudget({
        ...
        entryFeesPerPerson: toNumber(entryFees, 0),
    ...
    [travellers, nights, rates, entryFees, shopping, contingency, season, cap],
  );
  ...
  const reset = () => {
    ...
    setEntryFees(BASE_DEFAULTS.entryFees);
  ...
  const rateFields = [
    { id: "goa-fare", key: "fare", label: "Return flight or train per person (₹)", step: "500" },
    { id: "goa-stay", key: "stay", label: "Room rate per night (₹)", step: "250" },
    { id: "goa-food", key: "food", label: "Food per person per day (₹)", step: "100" },
    { id: "goa-transport", key: "transport", label: "Scooter or cab per person per day (₹)", step: "50" },
    { id: "goa-activities", key: "activities", label: "Activities per person per day (₹)", step: "100" },
    { id: "goa-ppr", key: "peoplePerRoom", label: "People sharing each room", step: "1" },
  ];
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Goa Trip Budget Breakdown</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Splits a Goa trip into travel, stay, food, scooter or cab, activities and a contingency
          buffer, then reports the number that matters when you split the bill — cost per person per
          day.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="goa-tier">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-season">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-travellers">
              Travellers
            </label>
            <input
              id="goa-travellers"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-nights">
              Nights in Goa
            </label>
            <input
              id="goa-nights"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-entry">
              Entry or permit fees per person (₹)
            </label>
            <input
              id="goa-entry"
              className={`mt-2 ${INPUT_CLASS}`}
              ...
              step="100"
              value={entryFees}
              onChange={(event) => setEntryFees(event.target.value)}
            />
          </div>

          <div>
            <label className={LABEL_CLASS} htmlFor="goa-shopping">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-contingency">
              Contingency buffer (%)
            </label>
            <input
              id="goa-contingency"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="goa-cap">
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              onClick={copyResult}
              disabled={!ok}
              aria-label="Copy the Goa trip budget breakdown"
        ...
        <dl className="mt-5 divide-y divide-[var(--border)] text-sm">
          {[
            ...
            ["Fixed costs (travel, fees, shopping)", ok ? money(result.fixedCosts) : DASH],
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Planning estimate only. The starting rates are shoulder-season reference points, not live
        prices — replace them with your own quotes before you commit money.
      </p>
    </main>
  );
}
