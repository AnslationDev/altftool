    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Natun bosoror xubhessa
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          Assamese New Year Wishes
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Bohag Bihu and January greetings in Assamese script with Roman transliteration, the
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-occasion">
              Occasion
            </label>
            <select
              id="nya-occasion"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-tone">
              Tone
            </label>
            <select
              id="nya-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-relationship">
              Who is it for
            </label>
            <select
              id="nya-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-script">
              Script
            </label>
            <select
              id="nya-script"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-to">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="nya-from">
              Your name (optional)
            </label>
            <input
              id="nya-from"
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              aria-label="Copy the selected Assamese new year greeting"
              className={GHOST_BTN}
            >
              {copiedId === "featured" ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Roman spellings of Assamese words vary by habit — adjust them to what your family uses. SMS
        lengths follow the 3GPP 140-byte payload rule, so Assamese script is billed at 70 characters
