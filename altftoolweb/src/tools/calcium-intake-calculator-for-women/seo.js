const seo = {
  ...
  benefits: [
    ["Published reference values", "Uses the IOM dietary reference intakes for both calcium and vitamin D, not rounded-off advice."],
    ["Food tally, not just a number", "Adds up servings so you can see where the day's calcium is really coming from."],
    ["Upper limits shown too", "Flags the 2000-3000 mg calcium ceiling and the 4000 IU vitamin D ceiling for your age band."],
  ],
  faqs: [
    [
