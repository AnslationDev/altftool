...
import { Check, Copy, Coins, RotateCcw } from "lucide-react";
...
const DEFAULT_BILL = "37.20";
const DEFAULT_UNITS = "2";
const DEFAULT_PARTY = "2";
const DEFAULT_ADD_ON = "0";
...
export default function ToolHome() {
  ...
  const [serviceChargeOnBill, setServiceChargeOnBill] = useState(false);
  ...
  const summary = useMemo(() => {
    if (failed) return "";
    const lines = [
      `Tipping in Germany — ${result.category.label}`,
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Tipping Guide Calculator for Germany</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works out German Trinkgeld as the round-up locals actually leave, shows the going rate for taxis, hotels, guides and even toilet attendants, and explains how to hand it over.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <h2 className="text-base font-semibold">What is customary in Germany</h2>
