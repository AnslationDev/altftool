const seo = {
  title: "Business Name Numerology: Chaldean Plus Domain",
  metaDescription:
  ...
  benefits: [
    ["Two systems, one pass", "Chaldean and Pythagorean numbers are computed from the same spelling so you can see where they disagree."],
    ["Real platform limits", "Handle and domain checks use published limits — 63 characters for a DNS label, 15 for X, 30 for Instagram."],
    ["Shortlist table", "Paste the whole list and compare totals, roots, domain length and checks passed in one view."],
  ],
  faqs: [
    [
