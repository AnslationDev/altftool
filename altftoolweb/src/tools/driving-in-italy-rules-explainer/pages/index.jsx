...
const CHECK_LABEL =
  "inline-flex min-h-11 w-full cursor-pointer items-center gap-3 rounded-md border border-[var(--border)] bg-[var(--background)] px-3 text-sm font-semibold";
const PRIMARY_BTN =
...
const ROW = "grid gap-1 py-2.5 sm:grid-cols-[minmax(0,14rem)_1fr] sm:gap-4";
...
export default function ToolHome() {
  ...
  const summary = useMemo(() => {
    ...
    return [
      ...
      `Minimum driving age: ${COUNTRY.minimumDrivingAgeYears}.`,
      `International Driving Permit needed: ${trip.permit.needsIdp ? "yes" : "no"}.`,
      "",
      "Speed limits under the conditions selected:",
      ...trip.speeds.map((row) => `  ${row.label}: ${row.kmh} km/h (${row.mph} mph)`),
      "",
      `Emergency: ${COUNTRY.emergencyNumbers.map(([n, w]) => `${n} (${w})`).join(", ")}`,
    ].join("\n");
  }, [trip]);
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Which side of the road, the Codice della Strada speed limits in km/h and mph including the
          wet-weather and neopatentato reductions, the alcohol limit that applies to you personally,
          and whether your licence needs an International Driving Permit in {COUNTRY.localName}.
        </p>
      </header>
      ...
      <section className={CARD} aria-labelledby="driver-details">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="it-age">
              Your age (years)
            </label>
            <input
              id="it-age"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-held">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="it-origin">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-stay">
              Length of stay (days)
            </label>
            <input
              id="it-stay"
          ...
          <div className="flex items-end">
            <label className={CHECK_LABEL} htmlFor="it-towing">
              <input
                id="it-towing"
                type="checkbox"
          ...
          <div>
            <label className={CHECK_LABEL} htmlFor="it-rain">
              <input
                id="it-rain"
                type="checkbox"
                className="h-5 w-5 accent-[var(--primary)]"
          ...
          <div>
            <label className={CHECK_LABEL} htmlFor="it-pro">
              <input
                id="it-pro"
                type="checkbox"
                className="h-5 w-5 accent-[var(--primary)]"
      ...
      <section className={`mt-6 ${CARD}`} aria-labelledby="speed-limits">
        <h2 id="speed-limits" className="text-base font-semibold">
          Speed limits for your situation
        </h2>
      ...
      <section className={`mt-6 ${CARD}`} aria-labelledby="alcohol-estimator">
        ...
        <p className="mt-1 text-sm text-[var(--muted-foreground)]">
          A Widmark-equation estimate of your blood alcohol, so you can see how long a long lunch in
          Chianti keeps you off the road. It is a rough model, never a green light to drive.
        </p>
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="it-drinks">
              Number of drinks
            </label>
            <input
              id="it-drinks"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-volume">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-abv">
              Strength (% ABV)
            </label>
            <input
              id="it-abv"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-weight">
              Body weight (kg)
            </label>
            <input
              id="it-weight"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-sex">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-hours">
        ...
        <dl className="mt-5 divide-y divide-[var(--border)] text-sm">
          {[
            ...
            ["Estimated blood alcohol now", bac.error ? DASH : `${BAC.format(bac.bacPercent)} % (${NUM.format(bac.gramsPerLitre)} g/l)`],
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Informational summary only, not legal advice. Italian traffic law and fine levels change,
        and signposted limits always override the defaults shown here. Confirm the current rules with
        your rental company, your insurer and an official source before you travel. The alcohol
