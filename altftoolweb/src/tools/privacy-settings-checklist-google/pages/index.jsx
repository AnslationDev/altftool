...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, CircleUser } from "lucide-react";
    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--muted)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          ...
          Google account privacy audit
        </div>
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Google Account Privacy Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          One Google account records your searches, your route to work, what you watch and what you asked an AI assistant. These 26 controls decide how much of that is kept, for how long, and who else can see it.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Pausing Web &amp; App Activity and assuming that deleted the history &mdash; pausing and deleting are two separate actions.</li>
          <li>Turning off Web &amp; App Activity but leaving YouTube History and Gemini Apps Activity running, since each has its own switch.</li>
          <li>Ignoring the audio and Chrome sub-toggles nested inside Web &amp; App Activity, which are the two most revealing parts of it.</li>
          <li>Changing the account-level location setting while the phone still grants the app precise background location.</li>
          <li>Leaving Drive files on &lsquo;Anyone with the link&rsquo; because the link feels private; those URLs get indexed once they are pasted anywhere public.</li>
        </ul>
      </section>
