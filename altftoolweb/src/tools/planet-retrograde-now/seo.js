const seo = {
  title: "Which Planets Are Retrograde Now? Station Dates",
  metaDescription:
  ...
  faqs: [
    ...
    [
      ...
      "The pre-retrograde shadow begins when the planet, still moving direct, first reaches the degree at which it will later station direct; the post-retrograde shadow ends when it climbs back to the degree at which it stationed retrograde. For loops computed between 2024 and 2028 each of Mercury's shadow legs runs about 14 to 20 days against a 20 to 24 day retrograde, Venus about 32 to 34 days against roughly 41 to 43, Mars about 63 to 67 days against roughly 80, and Saturn about 94 to 98 days against roughly 137. Across the whole span the planet crosses the same arc of the ecliptic three times.",
    ],
    [
