const seo = {
  title: "Section 44AA Books of Accounts Checker",
  metaDescription:
  ...
  benefits: [
    ["Both statutory tests", "Applies the all-three-years test for professions and the any-one-year test for businesses."],
    ["Correct entity limits", "Uses Rs 2,50,000 and Rs 25,00,000 for an individual or HUF, and Rs 1,20,000 and Rs 10,00,000 otherwise."],
    ["Names the registers", "Lists the Rule 6F(2) books, plus the Form 3C case register and drug inventory for doctors."],
  ],
  faqs: [
    [
