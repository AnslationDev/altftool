  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">CAD Cash Budget Planner</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Canada runs on cards more than almost anywhere, so the useful question is how little cash to carry. This sizes that float, prices it after the changer&rsquo;s markup and GST, and compares it with card spend.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Farmers&rsquo; market shopping, a parking meter that takes coins, or a tip you would rather hand over in notes.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Canada is card-first almost everywhere. Around 10% is usually enough, and terminals prompt for tips anyway.</p>
          </div>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className={HINT_CLASS}>The Canadian dollar floats against the rupee &mdash; use the day&rsquo;s mid-market rate.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Canadian machines commonly cap a single withdrawal near C$500, and non-bank &ldquo;white label&rdquo; ATMs in convenience stores charge the highest surcharges.</p>
          </div>
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
          ...
          <p className={HINT_CLASS}>C$20 notes are what ATMs dispense and what shops expect. There is little reason to hold C$100 notes.</p>
        </section>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        accountant before a large purchase of foreign exchange. Prices on shelves and menus exclude sales tax, which is added at the till and differs by province, so the rupee figure you estimate from a menu will run under the bill.
      </p>
    </main>
  );
}
