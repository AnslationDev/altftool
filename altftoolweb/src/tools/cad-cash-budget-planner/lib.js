...
/**
 * The Canadian dollar. Polymer notes run $5, $10, $20, $50 and $100; the $1
 * and $2 denominations are coins, and the one-cent coin was withdrawn in 2013,
 * so cash totals are rounded to the nearest five cents while card totals are
 * still charged to the cent.
 *
 * Canada is among the most card-driven countries in the world — Interac debit
 * and contactless cover almost everything — which is why the default cash share
 * here is the lowest in this family.
 */
export const CURRENCY = {
  ...
  symbol: "C$",
  country: "Canada",
  defaultInrPerUnit: 62,
  notes: [100, 50, 20, 10, 5],
  cashRoundingStep: 20,
  defaultCashSharePct: 10,
  defaultCashMarkupPct: 1.5,
  defaultOneOffCash: 0,
  defaultAtmWithdrawal: 300,
  spendStyles: [
    { id: "budget", label: "Budget", perDay: 70 },
    { id: "mid", label: "Mid-range", perDay: 140 },
    { id: "comfort", label: "Comfortable", perDay: 280 },
  ],
  cashFacts: [
    "Canada is one of the most card-driven countries anywhere; Interac debit and contactless cover cafés, transit and small shops.",
    "Cash is mostly for tips, farmers' markets, some food trucks and small-town parking meters.",
    "The penny was withdrawn in 2013, so cash totals are rounded to the nearest five cents while card totals are charged exactly.",
    "Sales tax is added at the till and differs by province — GST only in Alberta, HST in Ontario and the Atlantic provinces, GST plus PST elsewhere.",
    "Tipping is expected at sit-down restaurants and bars, usually 15% to 20%, and card terminals prompt for it — so it does not have to be cash.",
  ],
};
