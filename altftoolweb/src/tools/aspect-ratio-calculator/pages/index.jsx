    ...
    <main className="min-h-screen bg-[var(--background)] px-4 py-8 text-[var(--foreground)] sm:px-6">
      <div className="mx-auto max-w-6xl space-y-6">
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-6 shadow-[var(--anslation-ds-shadow-sm)] lg:p-8">
          ...
          <h1 className="text-4xl font-semibold leading-tight">Aspect Ratio Calculator</h1>
        ...
        <section className="grid gap-6 lg:grid-cols-[360px_1fr]">
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--anslation-ds-shadow-sm)]">
            ...
            <button type="button" onClick={() => { setWidth(1920); setHeight(1080); setTargetWidth(1280); }} className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-[var(--border)] px-4 py-3 text-sm font-semibold hover:bg-[var(--muted)]">
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--anslation-ds-shadow-sm)]">
            ...
            <div className="mt-6 rounded-lg border border-[var(--border)] bg-[var(--background)] p-5">
              ...
              <p className="mt-4 text-center text-sm font-semibold text-[var(--muted-foreground)]">
