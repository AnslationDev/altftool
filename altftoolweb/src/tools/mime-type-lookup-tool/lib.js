...
export const MIME_TABLE = [
  ...
  { mime: "image/svg+xml", extensions: ["svg"], kind: "Image", charset: "utf-8-recommended", compressible: true, note: "Text-based — compresses well. Can contain script: sanitise user uploads or serve with CSP." },
  { mime: "image/svg+xml", extensions: ["svgz"], kind: "Image", charset: "binary", compressible: false, note: "Pre-gzip-compressed SVG at rest — do not also apply Content-Encoding: gzip or wire-compress again." },
