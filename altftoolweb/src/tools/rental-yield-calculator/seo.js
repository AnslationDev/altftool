const seo = {
  ...
  intro:
    "Rental Yield Calculator works out what a let property actually returns: gross yield is annual rent after a vacancy allowance divided by the purchase price, and net yield subtracts every running cost — maintenance, property tax, insurance, HOA, repairs, utilities and a management fee charged as a percentage of collected rent — before dividing by the same price. It then layers on the loan, reporting monthly cash flow after EMI, cash-on-cash return against your down payment, total ROI including capital appreciation, and a five-year projection where rent grows 3% a year and expenses 2%. It is for landlords and buy-to-let investors comparing one property against another on returns rather than on rent alone.",
  useCases: [
  ...
  faqs: [
    ...
    [
      "What assumptions drive the five-year projection?",
