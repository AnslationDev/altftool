const seo = {
  title: "How Much USD Cash to Carry: RBI Limit, GST",
  metaDescription:
  ...
  benefits: [
    ["Statutory costs included", "The GST slab on buying currency and the 18% GST on a card markup are applied, not left as a footnote."],
    ["Tells you which route is cheaper", "Prices buying notes in India against withdrawing at destination ATMs, counting the flat fee on each withdrawal."],
    ["Denominations, not just a total", "Breaks the figure into the notes to ask for, which matters when tipping runs on singles."],
  ],
  faqs: [
    [
