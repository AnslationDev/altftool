    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Answer six questions and see whether Italy expects an International Driving Permit
          alongside your own licence, how long that licence keeps working, and what has to be in the
          car. Based on Articles 135 and 136 of the Codice della Strada.
        </p>
      </header>
      ...
      <section className={CARD}>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="it-idp">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="it-purpose">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-arrival">
              Date you arrive
            </label>
            <input
              id="it-arrival"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="it-departure">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={copyResult}
              aria-label="Copy the IDP verdict for Italy"
              className={GHOST_BTN}
              disabled={hasError}
            >
              {copied ? (
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        own case with the Motorizzazione Civile, your comune or your embassy before you drive.
      </p>
    </main>
  );
}
