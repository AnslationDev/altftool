    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Pick the relationship and the tone. Every wording is written out separately for तू and
          तुम्ही, so the possessive and the verb agreement are right — with romanisation, an English
      ...
      <section className="rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="mr-name">
              Their name (optional)
            </label>
            <input
              id="mr-name"
              ...
              placeholder="स्वप्निल"
            />
          </div>
          <div>
            <label className={LABEL_CLASS} htmlFor="mr-relationship">
              Who is it for?
            </label>
            <select
              id="mr-relationship"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="mr-register">
              Politeness
            </label>
            <select
              id="mr-register"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="mr-tone">
              Tone
            </label>
            <select
              id="mr-tone"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="mr-sender">
      ...
      <section className="mt-6 rounded-xl ring-1 ring-[var(--border)] bg-[var(--card)] p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <button
            ...
            aria-label="Copy every generated Marathi birthday message"
        ...
        {!hasError && result.registerOverridden ? (
          <p className="mt-4 rounded-md bg-[var(--muted)] px-3 py-2 text-sm text-[var(--muted-foreground)]">
            For a {result.relationship.label.toLowerCase()}, Marathi speakers would usually use the{" "}
            {result.autoRegister === "respectful" ? "तुम्ही" : "तू"} form.
          </p>
        ) : null}
      </section>
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <button
                  ...
                  aria-label="Copy this Marathi birthday message"
                  className={GHOST_BTN}
                >
                  {copiedId === item.id ? (
                    <Check className="h-4 w-4" aria-hidden="true" />
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        Devanagari text is sent over SMS as UCS-2, which allows 70 characters in a single message
        and 67 per part after that — so a long Marathi wish can cost two or three SMS. WhatsApp and
