const seo = {
  title: "Canada Visa Letter of Explanation Builder + Fee",
  metaDescription:
  ...
  benefits: [
    ["Fees calculated, not guessed", "Applies the per-person amounts and both family caps, so the total in your letter matches what you will actually pay."],
    ["Six-month rule made explicit", "Shows the date a standard six-month admission would end and warns when your plan runs past it."],
    ["Super visa rules built in", "Checks the CAD 100,000 insurance minimum and reminds you that the host must meet the minimum necessary income."],
  ],
  faqs: [
    [
