  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Singapore SIN Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Changi through the boarding gate, immigration, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-journey">
              Screening layout
            </label>
            <select
              id="sin-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-bags">
              Baggage
            </label>
            <select
              id="sin-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-area">
              Starting from
            </label>
            <select
              id="sin-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-traffic">
              Road conditions
            </label>
            <select
              id="sin-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-queue">
              Terminal queues
            </label>
            <select
              id="sin-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="sin-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="sin-buffer">
