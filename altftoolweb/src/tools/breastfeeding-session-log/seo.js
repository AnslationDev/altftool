const seo = {
  title: "Breastfeeding Session Log: Feeds, Gaps & Side",
  metaDescription:
  ...
  benefits: [
    ["Whole day at a glance", "Feed count, total minutes and average feed length from one list."],
    ["Gap tracking", "Start-to-start gaps, the longest daytime gap and the overnight stretch."],
    ["Side balance", "Left and right minute shares so one breast does not quietly fall behind."],
  ],
  faqs: [
    [
