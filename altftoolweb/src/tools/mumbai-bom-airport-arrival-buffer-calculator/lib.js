/**
 * Departure planning for Chhatrapati Shivaji Maharaj International Airport (BOM / VABB).
 *
...
export const AIRPORT = {
  ...
  city: "Mumbai",
  terminals: [
    "T1 (Santacruz) - domestic low-cost operations",
    "T2 (Sahar) - all international plus full-service domestic",
    "No airside link between T1 and T2; a self-transfer means leaving and re-entering",
  ],
};
...
/** Baseline queue times at BOM in normal conditions, before the queue factor. */
...
/** Multiplier applied to the free-flow drive time. Mumbai is a linear city on a peninsula, so a blocked arterial road has no easy detour and rush-hour delays are severe. */
export const TRAFFIC_LEVELS = [
  { id: "clear", label: "Clear (night / early morning)", multiplier: 1 },
  { id: "typical", label: "Typical daytime", multiplier: 1.3 },
  { id: "heavy", label: "Heavy (rush hour)", multiplier: 1.7 },
  { id: "severe", label: "Severe (monsoon flooding, waterlogging, accident)", multiplier: 2.3 },
];
...
/**
 * Mumbai road rush-hour windows, as minutes from midnight. Used only to SUGGEST a
...
/**
 * Indicative free-flow (no-traffic) road times to BOM from common starting
 * points. They are starting estimates only - replace the minutes with a live maps
 * estimate for your own address.
 */
export const AREA_PRESETS = [
  { id: "vileparle", label: "Vile Parle / Santacruz", driveMinutes: 10 },
  { id: "andheri", label: "Andheri East / MIDC", driveMinutes: 12 },
  { id: "bandra", label: "Bandra / Khar", driveMinutes: 20 },
  { id: "powai", label: "Powai / Vikhroli", driveMinutes: 25 },
  { id: "goregaon", label: "Goregaon / Malad", driveMinutes: 25 },
  { id: "dadar", label: "Dadar / Lower Parel / Worli", driveMinutes: 40 },
  { id: "borivali", label: "Borivali / Kandivali", driveMinutes: 40 },
  { id: "southmumbai", label: "South Mumbai (Colaba, Fort, Churchgate)", driveMinutes: 50 },
  { id: "navimumbai", label: "Navi Mumbai (Vashi, Nerul)", driveMinutes: 45 },
  { id: "thane", label: "Thane", driveMinutes: 50 },
