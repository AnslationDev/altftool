  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Mumbai BOM Airport Arrival Buffer Calculator</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Works backwards from your departure time at Chhatrapati Shivaji Maharaj International through the boarding gate, security, bag drop and the drive itself, so you get one answer: the time to walk out of the door.
        </p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-departure">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-journey">
              Flight type
            </label>
            <select
              id="bom-journey"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-bags">
              Baggage
            </label>
            <select
              id="bom-bags"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-area">
              Starting from
            </label>
            <select
              id="bom-area"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-drive">
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-traffic">
              Road conditions
            </label>
            <select
              id="bom-traffic"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-queue">
              Terminal queues
            </label>
            <select
              id="bom-queue"
          ...
          <div>
            <label className={LABEL_CLASS} htmlFor="bom-parking">
          ...
          <div className="sm:col-span-2">
            <label className={LABEL_CLASS} htmlFor="bom-buffer">
