  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl leading-tight font-semibold sm:text-4xl">IDR Cash Budget Planner</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">Indonesia runs on notes outside the malls. This sizes the rupiah float for your trip, prices it after the changer&rsquo;s markup and GST, and counts how many ATM trips the alternative would take.</p>
      </header>
      ...
      <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Visa on arrival if one applies to you, scooter hire deposit, temple entry and donations, or a driver hired for the day.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Indonesia is cash-heavy outside malls and chain hotels. Around 55% is realistic once warungs, transport and entry fees are counted.</p>
          </div>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p className={HINT_CLASS}>Rupees per single rupiah, so the number is small &mdash; around 0.005. If you know rupiah per rupee instead, divide 1 by it.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className={HINT_CLASS}>Ceilings depend on the note the machine holds &mdash; commonly Rp 1,250,000 from a Rp 50,000 machine and up to about Rp 2,500,000 to Rp 3,000,000 from a Rp 100,000 machine.</p>
          </div>
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <section className="rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
          ...
          <p className={HINT_CLASS}>Rp 100,000 notes are fine at hotels and supermarkets but hard to break at a warung. Keep a working set of Rp 10,000 and Rp 20,000 notes.</p>
        </section>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        accountant before a large purchase of foreign exchange. Indonesian customs requires a declaration for currency brought in or taken out above its own rupiah threshold, and worn or heavily marked foreign notes are often refused by Indonesian changers &mdash; carry clean notes if you plan to change money there.
      </p>
    </main>
  );
}
