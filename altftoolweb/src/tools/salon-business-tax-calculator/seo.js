const seo = {
  title: "Salon Break-Even and Tax Calculator on Chair",
  metaDescription:
  ...
  benefits: [
    ["Chair economics, not guesswork", "Revenue is derived from real capacity, so occupancy and ticket size can be tested separately."],
    ["Break-even in clients, not rupees", "The answer is expressed as clients per chair per day, which is a number a salon manager can actually act on."],
    ["44AD and both regimes computed", "Presumptive income sits next to real profit, each taxed with slabs, the 87A rebate, surcharge and cess."],
  ],
  faqs: [
    [
