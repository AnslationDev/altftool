const seo = {
  title: "Car Loan 20/4/10 Rule Check & Down Payment",
  metaDescription:
  ...
  benefits: [
    ["Affordability tested, not assumed", "Each leg of the 20/4/10 rule is checked separately, so you can see exactly which one the purchase fails."],
    ["Resale from a published schedule", "Depreciation follows the motor-tariff IDV table rather than a made-up percentage."],
    ["Running costs included", "Fuel derived from your annual kilometres and mileage, plus insurance and servicing, is where most of the surprise lives."],
  ],
  faqs: [
    [
