const seo = {
  ...
  benefits: [
    ["Written to be understood", "Flesch-Kincaid grading flags wording that has drifted above a grade 9 reading level."],
    ["Nothing quietly missing", "Each required element is checked off against the article of the GDPR that asks for it."],
    ["Scope you actually chose", "Permitted uses, territory, attribution and retention are stated explicitly rather than left as blanket consent."],
  ],
  faqs: [
    [
