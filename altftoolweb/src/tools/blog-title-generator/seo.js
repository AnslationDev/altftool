const seo = {
  ...
  benefits: [
    ["Tone is an explicit choice", "How-to, listicle and bold draw from separate template pools, so you compare genuinely different framings rather than four rewordings of one idea."],
    ["Sensible list numbers", "Listicle titles use an odd count from 5 to 13, matching how list posts are conventionally written, instead of an arbitrary round number."],
    ["Keyword sits in the headline", "Your term is capitalised and placed inside each title, so the phrase people search for stays in the H1 rather than being paraphrased away."],
  ],
  faqs: [
    [
