...
import { Check, Copy, RotateCcw, FileX } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Malaysia Visa Rejection Reason Explainer</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Malaysian eVISAs are decided on the uploaded file. Pick what applies to see the Immigration Act provision behind the rejection, and whether it is a same-week fix or a record that needs clearing first.
        </p>
      </header>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        ...
        wording on your own refusal notice and check the official Immigration Department of Malaysia pages, or speak to a
