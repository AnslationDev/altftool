const seo = {
  title: "Hair Care Routine Quiz: Morning & Night",
  intro:
  ...
  useCases: [
    "You have curly hair with split ends and cannot tell whether you need a protein treatment or more moisture",
    "Your scalp turns greasy by day two and you want to know how often to actually wash and where to stop applying conditioner",
    "You are growing your hair out and want a simple morning and night order to follow instead of a shelf of products used at random",
  ],
  benefits: [
    [
    ...
    [
      ...
      "Each routine names the wash-day steps and the overnight protection separately, so you know what belongs where.",
    ],
    [
      "Frequencies, not just products",
      "Tips carry the interval that matters — how often to clarify, deep condition or trim — which is usually what goes wrong.",
    ],
  ],
  faqs: [
    [
      "How often should I wash my hair?",
      "For most hair types two to three washes a week is the routine suggested here; oily scalps do better with a clarifying wash about three times a week, while coily hair is usually washed once a week because it dries out fastest. Adjust from there based on how your scalp feels by day two.",
    ],
    [
      "How often should I trim my hair?",
      "Every six to eight weeks for fine hair, eight to ten weeks for curly hair prone to split ends, and eight to twelve weeks as a general baseline. Trimming does not speed growth at the root — it removes split ends before they travel up the shaft and cost you length.",
    ],
    [
      "What is the LOC method?",
      "Leave-in, Oil, Cream — applying a water-based leave-in first, then an oil to seal it, then a cream to hold it in. It is the layering order recommended here for coily and very dry hair, because oil alone seals in whatever moisture is already there rather than adding any.",
    ],
    [
      "Can this tool tell me why I am losing hair?",
