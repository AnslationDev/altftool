const seo = {
  ...
  benefits: [
    ["Every board subject in one view", "Science, Mathematics, Social Science, English, Hindi and Computer Applications with their real chapter lists."],
    ["Revision-aware scoring", "Reading a chapter earns partial credit; only revision plus sample papers closes it out."],
    ["Pace, not just percentage", "Reports the weekly chapter target and the days you can afford per remaining chapter."],
  ],
  faqs: [
    [
