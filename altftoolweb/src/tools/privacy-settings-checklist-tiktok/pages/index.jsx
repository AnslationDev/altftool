...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Music } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">TikTok Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          TikTok's defaults let anyone download your video, stitch it into theirs and be suggested your profile from a contact list. These 28 controls decide who sees you and what they are allowed to do with what you post.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Going private and assuming the suggestion switches went with it &mdash; there are four of them and each has to be turned off separately.</li>
          <li>Turning off contact syncing without deleting the address book already uploaded.</li>
          <li>Leaving downloads on, which is what makes a video trivially re-uploadable on other platforms.</li>
          <li>Setting duet and stitch permissions on the account and forgetting that a per-video setting can override them.</li>
          <li>Turning off personalised ads while leaving the separate partner-data setting untouched.</li>
        </ul>
      </section>
