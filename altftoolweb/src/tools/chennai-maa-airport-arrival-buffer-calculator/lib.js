/**
 * Departure planning for Chennai International Airport (MAA / VOMM).
 *
...
export const AIRPORT = {
  ...
  terminals: [
    ...
    "T4 - domestic departures",
    "T2 - the new integrated terminal, handling both as operations move across",
  ],
};
...
/** Baseline queue times at MAA in normal conditions, before the queue factor. */
...
/** Multiplier applied to the free-flow drive time. The airport sits at Tirusulam on GST Road, so most journeys funnel through Guindy and the Kathipara junction. */
export const TRAFFIC_LEVELS = [
  ...
  { id: "severe", label: "Severe (northeast monsoon rain, flooding)", multiplier: 2.1 },
];
...
export const QUEUE_LEVELS = [
  ...
  { id: "peak", label: "Peak bank (05:00-08:00, 18:00-22:00)", multiplier: 1.5 },
];

/**
 * Chennai road rush-hour windows, as minutes from midnight. Used only to SUGGEST a
...
/**
 * Indicative free-flow (no-traffic) road times to MAA from common starting
 * points. They are starting estimates only - replace the minutes with a live maps
 * estimate for your own address.
 */
export const AREA_PRESETS = [
  { id: "guindy", label: "Guindy / Alandur / Pallavaram", driveMinutes: 15 },
  { id: "velachery", label: "Velachery / Madipakkam", driveMinutes: 25 },
  { id: "tnagar", label: "T Nagar / Saidapet", driveMinutes: 25 },
  { id: "porur", label: "Porur / Ramapuram", driveMinutes: 25 },
  { id: "tambaram", label: "Tambaram / Chromepet", driveMinutes: 25 },
  { id: "adyar", label: "Adyar / Besant Nagar", driveMinutes: 30 },
  { id: "annanagar", label: "Anna Nagar / Kilpauk", driveMinutes: 35 },
  { id: "central", label: "Chennai Central / Egmore / Mylapore", driveMinutes: 40 },
  { id: "omr", label: "OMR (Sholinganallur, Siruseri)", driveMinutes: 45 },
  { id: "ambattur", label: "Ambattur / Avadi", driveMinutes: 45 },
