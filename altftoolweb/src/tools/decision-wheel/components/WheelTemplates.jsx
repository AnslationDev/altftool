      ...
      <div className="grid grid-cols-2 gap-1.5">
        {TEMPLATES_LIST.map((template, i) => (
          <motion.button
            ...
            className="flex items-center gap-2 p-2 min-h-11 rounded-lg border border-(--border) bg-(--card) hover:bg-(--muted) hover:border-(--border-strong) transition text-left active:scale-[0.98] motion-reduce:active:scale-100 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-(--primary)"
          >
