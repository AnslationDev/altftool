...
import { Layout, Check, Shield, FileCode } from "lucide-react";

const faqItems = [
  {
    question: "What does JS Beautifier do?",
    answer:
      "It parses minified, unformatted, or messy JavaScript statements and formats them with consistent indentations, spacing, and structured bracket alignments.",
  },
  {
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-(--foreground) tracking-tight">
            Professional JS Formatter
          </h2>
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Clean up Javascript code instantly to enhance legibility and match clean codebase style guides.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          <div className="bg-(--surface) p-6 rounded-xl border border-(--border) shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Transform single-line minified scripts into well-organized code blocks with consistent rules.
            </p>
          </div>
          ...
          <div className="bg-(--surface) p-6 rounded-xl border border-(--border) shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Run conversions locally inside browser memory. None of your JS code or scripts are uploaded.
            </p>
          </div>
        </div>
