const seo = {
  intro:
    "The Freelance Hourly Rate Calculator works backwards from the take-home income you want to the hourly, day, project and monthly retainer rates you actually have to charge, by grossing your target up for tax, adding your annual business costs, and dividing by billable hours only. Billable hours come from working weeks times hours per week times your billable percentage — 48 weeks at 40 hours with 60% billable is 1,152 hours, not 1,920 — which is why the rate it returns is usually higher than people expect. It then checks that rate against editable junior, mid and senior market bands for development, design or writing so you can see whether the number is sellable.",
  useCases: [
