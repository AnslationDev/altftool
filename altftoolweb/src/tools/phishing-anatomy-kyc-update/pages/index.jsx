    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
          KYC Update Phishing Anatomy
        </h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          The &ldquo;your KYC has expired, the account will be blocked today&rdquo; message taken
          apart line by line, with a scanner that weighs the same tells against anything you paste
          and reads the real domain behind every link. Everything runs in this tab &mdash; nothing
      ...
      <section className={CARD} aria-labelledby="pa-scan">
        ...
        <div className="mt-3">
          ...
          <p className="mt-2 text-xs leading-5 text-[var(--muted-foreground)]">
            Defanged addresses work too &mdash; bad[.]xyz and hxxp:// are read as written. Never
            paste your own Aadhaar, PAN, OTP or UPI PIN anywhere, including here.
          </p>
        </div>
      ...
      <section className={`mt-6 ${CARD}`}>
        <h2 className="text-base font-semibold">How periodic KYC actually works</h2>
      ...
      <section className={`mt-6 ${CARD}`}>
        <h2 className="flex items-center gap-2 text-base font-semibold">
          ...
          If you already installed or approved something
        </h2>
      ...
      <p className="mt-6 text-xs leading-5 text-[var(--muted-foreground)]">
        The scanner looks for documented markers of the re-KYC family and weighs them. A high
        score means the message is built the way these scams are built; a zero is not a certificate
        that a message is genuine, because a careful forgery can avoid every marker. Periodic KYC
        updation is a real obligation &mdash; confirm yours with your own bank through its app,
        its branch or the number printed on your card. This page is general security education,
