const seo = {
  title: "Caste Certificate Checklist: SC, ST and OBC",
  metaDescription:
  ...
  benefits: [
    ["Bars checked before paperwork", "Religion, migration, marriage and creamy layer are tested first, with the authority for each."],
    ["Distinguishes SC from ST", "The religion condition applies to Scheduled Castes only, a distinction most guides skip."],
    ["Central format flagged", "Warns that a state-format OBC certificate will not serve for a central government post."],
  ],
  faqs: [
    [
