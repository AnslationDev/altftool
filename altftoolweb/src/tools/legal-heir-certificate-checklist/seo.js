const seo = {
  title: "Legal Heir vs Succession Certificate: Which You",
  metaDescription:
  ...
  steps: [
    "Pick the personal law that applied to the deceased and whether they were male or female, then tick what the estate included and whether there was a Will.",
    "Under Surviving heirs enter the counts of widows, sons, daughters and pre-deceased children leaving their own heirs, and tick whether the mother or the husband survives.",
    "Enter the value of deposits and securities, your state's ad valorem rate and its cap, then press Copy checklist for the instruments, Class I shares and document list.",
  ],
  intro:
  ...
  useCases: [
    "A family told by the bank that the legal heir certificate they obtained is not enough, and needing to know that a succession certificate from a civil court is the instrument for deposits and shares.",
    "Working out how a father's estate divides between a widow, two sons, a daughter, the surviving mother and the children of a pre-deceased son — six equal shares, one of them going to that branch collectively.",
    "Checking whether probate is compulsory for a Will covering a flat in Mumbai, where the former presidency-town rule under section 213 still applies.",
  ],
  benefits: [
    ["Matches instrument to asset", "Shows which of the four routes each class of property actually requires, and why."],
    ["Computes the statutory shares", "Applies section 10 for a male intestate and section 15 for a female, which distribute differently."],
    ["Prices the court fee", "Applies your state's ad valorem rate and cap to the value of the deposits and securities."],
  ],
  faqs: [
    [
    ...
    [
      "How is a Hindu man's property divided when he dies without a Will?",
    ...
    [
      "Does the nominee on a bank account or insurance policy become the owner?",
    ...
    [
      "When is probate of a Will compulsory in India?",
