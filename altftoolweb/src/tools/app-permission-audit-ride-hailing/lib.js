/**
 * Ride Hailing App Permission Audit — pure logic.
 *
 * Scores a cab-booking app. Precise location is genuinely core. Background
 * location, microphone (in-trip audio recording) and contacts (emergency
 * contacts, trip sharing) are safety features that many riders never enable, so
 * they are scored as optional: worth keeping only if you actually use them.
 *
...
export const NECESSITY_LABEL = {
  ...
  unnecessary: "Not needed by a cab app",
};
...
/**
 * Permissions and privacy settings a ride hailing app can hold.
...
export const PERMISSIONS = [
  {
    ...
    "tier": "high",
    "necessity": "core",
    "why": "Sets the pickup point, matches a nearby driver and follows the route.",
    "risk": "Street-level position, and a home address the moment the app sees you overnight.",
    "recommend": "Allow on 'While using the app'. That covers booking and an open trip screen.",
    "aliases": [
      "precise location",
      "fine location",
  ...
  },
  {
    ...
    "tier": "minimal",
    "necessity": "core",
    "why": "Driver assigned, arriving and trip receipt alerts.",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "optional",
    "why": "Keeps the trip tracked with the screen off; a foreground service with a visible notification does the same for an active ride.",
    "risk": "Continuous location history is the single most re-identifying data an app can hold.",
    "recommend": "Set it to 'While using the app' unless you rely on automatic trip tracking with the phone locked.",
    "aliases": [
      "background location",
      "all the time",
      "location always",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Picks emergency contacts and people to share a live trip with.",
    "risk": "Grants the whole address book to set up two or three trusted contacts.",
    "recommend": "Deny, then type those two numbers manually in the safety settings.",
    "aliases": [
      "contacts",
      "address book",
      "emergency contacts",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "In-trip audio recording, a safety feature you switch on per ride.",
  ...
  },
  {
    ...
    "tier": "high",
    "necessity": "optional",
    "why": "Uploading ID documents and the selfie check some cities require.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Calls the driver; platforms route this through a masked number that needs no permission.",
    "risk": "CALL_PHONE can start a call without you confirming it in the dialler.",
    "recommend": "Deny. The in-app masked call still works.",
    "aliases": [
      "place calls",
      "make calls",
      "call phone"
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Attaching a photo to a lost-item or complaint ticket.",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "optional",
    "why": "Detects that you are walking to the pickup point or that a ride has ended.",
    "risk": "A movement profile that continues between rides.",
    "recommend": "Deny unless the app clearly uses it for pickup walking directions.",
    "aliases": [
      "physical activity",
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "unnecessary",
    "why": "Pitched as 'ride to your next meeting' — that feature reads every event you have.",
    "risk": "Your calendar names your employer, clinics, interviews and personal plans.",
    "recommend": "Revoke it and book the ride yourself.",
    "aliases": [
      "calendar",
      "read calendar",
      "events"
  ...
  },
  {
    ...
    "tier": "moderate",
    "necessity": "unnecessary",
    "why": "Rarely used outside airport and mall beacon networks.",
    "risk": "Bluetooth scanning positions you indoors where GPS cannot reach.",
    "recommend": "Revoke it.",
    "aliases": [
      "nearby devices",
      "bluetooth",
  ...
  },
  {
    ...
    "tier": "restricted",
    "necessity": "unnecessary",
    "why": "Document uploads go through the system picker.",
  ...
  },
  {
    ...
    "tier": "low",
    "necessity": "unnecessary",
    "why": "Joins where you travel to advertising profiles held outside the app.",
...
export function resultToText(result, appName = "Ride hailing app") {
  if (!result || result.error) return "";
  const name = String(appName || "Ride hailing app").trim() || "Ride hailing app";
  const lines = [
