...
import { Check, Copy, RotateCcw, ShieldCheck, TriangleAlert, Ghost } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Snapchat Privacy Settings Checklist</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Snapchat's defaults put you on a live map, offer you to strangers in Quick Add and keep more than the disappearing-message reputation suggests. These 25 controls fix that, ranked by how much each one actually hides.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Choosing the 3-hour or 24-hour Ghost Mode and forgetting that it silently puts you back on the map when it expires.</li>
          <li>Turning on Ghost Mode but still sending snaps with a location filter, which names the place anyway.</li>
          <li>Leaving Contact Me on &lsquo;Friends and Contacts&rsquo;, which lets anyone in your phone book message you without being added.</li>
          <li>Assuming snaps disappear everywhere &mdash; Memories, My AI conversations and the recipient&rsquo;s screenshots all persist.</li>
          <li>Setting a My Eyes Only passcode with no way to remember it; it cannot be recovered and the snaps go with it.</li>
        </ul>
      </section>
