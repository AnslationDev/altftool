  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-[var(--foreground)] sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Telegram 2FA Setup Guide</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
          Telegram signs you in with a code sent to your phone number, so without the two-step cloud password a SIM swap is the whole attack. Tick each control as you set it; the score weights them accordingly.
        </p>
      </header>
      ...
      <section className="mt-6 rounded-xl bg-[var(--card)] p-5 ring-1 ring-[var(--border)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--muted-foreground)]">
          <li>Skipping the recovery email while setting the cloud password, then having no way back if you forget it.</li>
          <li>Assuming ordinary Telegram chats are end-to-end encrypted &mdash; only Secret Chats are.</li>
          <li>Leaving desktop sessions signed in forever, because Telegram sessions do not expire by themselves.</li>
          <li>Accepting a call from an unknown account with peer-to-peer enabled, which hands over your IP address.</li>
        </ul>
      </section>
