...
export default function AdRail({ ad, toolSlug, placement = "tool_detail_rail_right" }) {
  ...
  return (
    <a
      ...
      className="relative block h-[500px] w-[250px] overflow-hidden rounded-lg border border-(--border) bg-(--muted) shadow-sm transition-colors hover:border-(--border-strong) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--primary)"
    >
