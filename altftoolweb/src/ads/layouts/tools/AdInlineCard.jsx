  ...
  return (
    <div ref={impressionRef} className={`flex justify-center ${className}`}>
      <a
        ...
        className="relative block h-[250px] w-[300px] overflow-hidden rounded-lg border border-(--border) bg-(--muted) shadow-sm transition-colors hover:border-(--border-strong) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--primary)"
      >
