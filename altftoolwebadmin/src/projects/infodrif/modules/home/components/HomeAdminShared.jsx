...
/**
 * Intra-module chrome for the Infodrif Home admin pages.
 *
...
const HOME_HUB_ROUTE = "/infodrif/home";

/** Sticky save/reset bar shown at the top of every Home section page. */
    ...
    <div className="sticky top-0 z-20 -mx-6 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--background)_92%,transparent)] px-6 py-4 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <Link
            href={HOME_HUB_ROUTE}
            aria-label="Back to the Home hub"
 ...
 * fixed vocabulary, so free text would silently render nothing.
 */
