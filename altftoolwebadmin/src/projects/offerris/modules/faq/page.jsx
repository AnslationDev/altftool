      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Offerris FAQ</h1>
              <p className="text-sm text-gray-500">Manage the sitewide frequently asked questions shown on the home page.</p>
            </div>
          </div>
    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50">
      <div className="p-6">
        <div className="text-center">
          <p className="text-[11px] uppercase tracking-[0.2em] text-gray-500">Questions</p>
          <h3 className="mx-auto mt-3 max-w-md text-2xl font-semibold leading-tight text-gray-900">
            Everything you&rsquo;re wondering before you reach out.
          </h3>
        </div>
                ...
                return (
                  <div key={item.id}>
                    <div className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left">
                      ...
                      <span aria-hidden="true" className="shrink-0 text-lg text-gray-500">
                        {isOpen ? "−" : "+"}
                      </span>
                    </div>
                    {isOpen ? (
                      <p className="px-5 pb-5 text-sm leading-relaxed text-gray-500">{item.answer}</p>
                    ) : null}
                  </div>
                );
              })}
