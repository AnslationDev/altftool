      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Offerris Privacy Policy</h1>
              <p className="text-sm text-gray-500">Manage the privacy policy title, last-updated date, and sections.</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
              ...
              <>
                <Card eyebrow="Header" title="Page header">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <Field label="Last Updated"><input value={data.lastUpdated || ""} onChange={(event) => setField("lastUpdated", event.target.value)} className={inputClass} placeholder="July 1, 2026" /></Field>
                  </div>
                </Card>
