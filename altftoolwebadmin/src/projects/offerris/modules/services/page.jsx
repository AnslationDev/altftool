...
import { ImageField, SettingsCard } from "../_shared/AdminSectionShared";
import {
...
const EMPTY_SERVICE = {
  ...
  workflow: [],
  technologies: "",
  pricingCta: { headline: "", subcopy: "", ctaLabel: "", ctaHref: "" },
  faq: [],
  relatedSlugs: [],
  order: 0,
  active: true,
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Offerris Services</h1>
        ...
        <SettingsCard
          ...
          fields={[
            { key: "badgeSuffix", label: "Badge Suffix", type: "text", hint: 'Badge renders as "{service count} {suffix}", e.g. "8 Core Services".' },
      ...
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-6">
          ...
          <ImageField
            ...
            hint="Shown on the services grid card and footer lists. Leave empty to fall back to the icon tile."
          />
          ...
          <div className="rounded-xl border border-gray-200 p-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Headline"><input value={form.pricingCta.headline} onChange={(event) => setPricingCta("headline", event.target.value)} className={inputClass} placeholder="Websites start at $9,500." /></Field>
              <Field label="Subcopy"><input value={form.pricingCta.subcopy} onChange={(event) => setPricingCta("subcopy", event.target.value)} className={inputClass} placeholder="Scoped in a 20-minute call." /></Field>
              <Field label="Button Label"><input value={form.pricingCta.ctaLabel} onChange={(event) => setPricingCta("ctaLabel", event.target.value)} className={inputClass} placeholder="Get a Quote" /></Field>
              <Field label="Button Href"><input value={form.pricingCta.ctaHref} onChange={(event) => setPricingCta("ctaHref", event.target.value)} className={inputClass} placeholder="/contact" /></Field>
            </div>
          </div>
