  ...
  return (
    <div className="flex items-center gap-2 bg-danger-soft border border-danger rounded-xl px-3 py-2 mt-2">
      ...
      <button onClick={onConfirm} disabled={loading}
        className="flex items-center gap-1 text-xs font-semibold text-white bg-danger hover:bg-danger px-2.5 py-1 rounded-lg transition disabled:opacity-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-surface rounded-2xl border border-border shadow-sm p-5 space-y-3">
              ...
              <button onClick={() => router.push(`/altftool/blogs/edit-blog/${blog.id}`)}
                className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-semibold bg-primary hover:bg-primary text-white rounded-xl transition shadow-sm">
