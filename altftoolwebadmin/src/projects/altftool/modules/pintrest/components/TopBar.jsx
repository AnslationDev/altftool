  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-gray-900 tracking-tight">AltF Pintrest</h1>
          <p className="text-sm text-gray-500 mt-0.5">See all your pinned content in one place</p>
        </div>
