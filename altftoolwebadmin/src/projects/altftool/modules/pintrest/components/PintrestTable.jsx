...
export default function DataTable({ items, onEdit, refresh }) {
  ...
  const columns = useMemo(() => [
    ...
    //   accessorKey: "img",
    //   header: "Image",
    //   size: 60, minSize: 60, maxSize: 60, enableSorting: false,
    //   cell: ({ getValue }) => {
    //     const img = getValue();
    //     return img ? <img src={img} alt="Image" className="w-8 h-8 rounded-lg object-cover border border-gray-100 shrink-0 bg-gray-50" /> : null;
    //   },
    // },
    {
      id: "item",
