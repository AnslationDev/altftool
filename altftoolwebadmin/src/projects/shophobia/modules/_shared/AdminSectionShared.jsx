...
/**
 * Shophobia — shared admin section primitives.
 *
 * Several Shophobia admin pages (home, about-us) are single pages
 ...
 * Offerris's `modules/_shared/AdminSectionShared.jsx`.
 *
...
/* -------------------------------------------------------------------------- */
/* Shophobia preview theme (dark, chrome pink/violet/cyan — mirrors the live   */
/* site's #0d0b14 void background + Y2K tokens; preview only, no real styling) */
/* -------------------------------------------------------------------------- */
export const HEX = {
  bg: "#0d0b14",
  raised: "#1a1526",
...
/** Renders a heading the way the Shophobia frontend does. */
...
export function PrimaryBtn({ children }) {
  return (
    <span
      ...
      style={{ background: `linear-gradient(90deg, ${HEX.accentAlt}, ${HEX.violet})`, color: HEX.fg }}
    >
      {children}
    </span>
  );
