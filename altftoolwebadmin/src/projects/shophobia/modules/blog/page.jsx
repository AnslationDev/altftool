...
export default function ShophobiaBlogPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Shophobia Blog</h1>
        ...
        <SettingsCard
          ...
          fields={[
            { key: "badge", label: "Badge", type: "text", placeholder: "The Studio Blog" },
            { key: "heroHeadline", label: "Hero Headline", type: "text", required: true },
            { key: "heroSubcopy", label: "Hero Subcopy", type: "textarea", rows: 3 },
            { key: "relatedHeading", label: "Detail Related Heading", type: "text", placeholder: "More From The Studio" },
          ]}
        />
      ...
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Category"><input value={form.category} onChange={(event) => setField("category", event.target.value)} className={inputClass} placeholder="Design" /></Field>
            <Field label="Author"><input value={form.author} onChange={(event) => setField("author", event.target.value)} className={inputClass} placeholder="Mika Solano" /></Field>
