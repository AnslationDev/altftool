...
export default function ShophobiaTeamPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Shophobia Team</h1>
        ...
        <SettingsCard
          ...
          fields={[
            { key: "badge", label: "Badge", type: "text", placeholder: "The Collective" },
            { key: "heroHeadline", label: "Hero Headline", type: "text", required: true },
            { key: "heroSubcopy", label: "Hero Subcopy", type: "textarea", rows: 3 },
            { key: "relatedHeading", label: "Detail Related Heading", type: "text", placeholder: "Rest Of The Collective" },
            { key: "relatedAllCtaLabel", label: "Related: All CTA", type: "text", half: true },
            { key: "relatedWorkCtaLabel", label: "Related: Work CTA", type: "text", half: true },
          ]}
        />
      ...
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-5">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Slug" error={errors.slug}><input value={form.slug} onChange={(event) => setSlug(event.target.value)} className={inputClass} placeholder="mika-solano" /></Field>
          ...
          <ListEditor
            ...
            onChange={(value) => setField("expertise", value)}
          ...
          <div className="rounded-xl border border-gray-200 p-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <Field label="LinkedIn"><input value={form.social.linkedin} onChange={(event) => setSocial("linkedin", event.target.value)} className={inputClass} placeholder="https://..." /></Field>
              <Field label="X"><input value={form.social.x} onChange={(event) => setSocial("x", event.target.value)} className={inputClass} placeholder="https://..." /></Field>
              <Field label="Instagram"><input value={form.social.instagram} onChange={(event) => setSocial("instagram", event.target.value)} className={inputClass} placeholder="https://..." /></Field>
            </div>
          </div>
