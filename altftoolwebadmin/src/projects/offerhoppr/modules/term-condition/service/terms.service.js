...
export const DEFAULT_TERMS = {
  ...
  sections: [
    ...
    { title: "4. Affiliate Relationships", body: "Offerhoppr may earn a commission when you click through and make a purchase using a link on our site. This does not affect the price you pay and does not influence which offers we choose to feature." },
    { title: "5. Intellectual Property", body: "All content on this website — including copy, visual design, and code — is the property of Offerhoppr unless otherwise noted, and may not be reproduced or distributed without written consent." },
    { title: "6. Limitation of Liability", body: "Offerhoppr is not liable for any indirect, incidental, or consequential damages arising from use of this website or reliance on any offer listed here, to the fullest extent permitted by law." },
    ...
    { title: "9. Contact Us", body: "Questions about these terms can be sent to hello@offerhoppr.com." },
  ],
};
