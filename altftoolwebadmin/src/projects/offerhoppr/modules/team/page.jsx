      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Offerhoppr Team</h1>
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 overflow-x-auto rounded-xl border border-gray-200">
            <div className="min-w-[720px]">
              <div className="grid grid-cols-[70px_1fr_1fr_90px_80px_120px] bg-gray-50 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-gray-400">
                <span>Image</span><span>Name</span><span>Role</span><span>Experience</span><span>Status</span><span>Actions</span>
              </div>
              {loading ? (
                ...
                <div key={member.id} className="grid grid-cols-[70px_1fr_1fr_90px_80px_120px] items-center gap-3 border-t border-gray-100 px-3 py-3 text-sm">
                  ...
                  <p className="truncate text-xs font-semibold text-gray-500">{member.experience}</p>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <Field label="Experience"><input value={form.experience} onChange={(event) => setField("experience", event.target.value)} className={inputClass} placeholder="5+" /></Field>
            ...
            <Field label="Specialties (one per line)"><textarea value={form.specialties} onChange={(event) => setField("specialties", event.target.value)} rows={4} className={textareaClass} placeholder={"Paid Search\nSEO Strategy\nContent Marketing"} /></Field>
            <div className="grid gap-3 sm:grid-cols-2">
