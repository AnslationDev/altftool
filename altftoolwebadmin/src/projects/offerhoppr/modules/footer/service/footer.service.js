...
/* ------------------------------ resources -------------------------------- */
/* Maps to data/nav.json's `footerResources` array. The footer's quick-links
   column reuses `navbarPrimary` (data/nav.json `footerQuickLinks`) — there is
   intentionally no separate quick-links collection in this module. */
