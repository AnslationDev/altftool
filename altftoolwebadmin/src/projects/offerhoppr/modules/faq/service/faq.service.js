...
/**
 * Offerhoppr — FAQ module data layer.
 *
 * Collection `projects/offerhoppr/faqs`. This is the SITEWIDE faq shown on
 * the home page — distinct from each service's own embedded faq array
 * inside the `services` module. Every doc carries a numeric `order` and a
