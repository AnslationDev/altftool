...
/**
 * ExclusInsider — Blog module data layer.
 *
 * Doc `projects/exclusinsider/blog/settings` holds the list-page hero copy.
 * Collection `projects/exclusinsider/blogArticles` holds the articles.
 * `category` and `author` are plain free-text strings — the frontend derives
 * its category filter dynamically from whatever distinct category strings
 * exist across posts.
 */
