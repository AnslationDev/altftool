...
/**
 * ExclusInsider — shared admin section primitives.
 *
 * Several ExclusInsider admin pages (home, about-us) are single pages
...
/* -------------------------------------------------------------------------- */
/* ExclusInsider preview theme (dark, brass accent — mirrors the live site's   */
/* midnight/burgundy/brass tokens; preview only, no effect on real styling)    */
/* -------------------------------------------------------------------------- */
export const HEX = {
  bg: "#0f1115",
  raised: "#181b21",
...
/** Renders a heading the way the ExclusInsider frontend does. */
