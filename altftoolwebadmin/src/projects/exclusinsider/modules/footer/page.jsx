...
export default function ExclusinsiderFooterPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">ExclusInsider Footer</h1>
              <p className="text-sm text-gray-500">Manage the newsletter copy, quick links, resource links, and copyright label.</p>
            </div>
          </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <h2 className="mt-1 text-base font-bold text-gray-900">Newsletter & copyright</h2>
                </div>
              ...
              {loading ? (
                ...
                <div className="mt-5 space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <Field label="Newsletter Heading"><input value={settings.newsletterHeading || ""} onChange={(event) => setSetting("newsletterHeading", event.target.value)} className={inputClass} placeholder="Off The Record" /></Field>
                    <Field label="Newsletter Input Placeholder"><input value={settings.newsletterPlaceholder || ""} onChange={(event) => setSetting("newsletterPlaceholder", event.target.value)} className={inputClass} placeholder="Your email" /></Field>
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-orange-100 bg-orange-50/60 p-6">
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div>
          ...
          <p className="mt-4 max-w-sm text-xs leading-relaxed text-gray-600">
            {settings.newsletterHeading || "Off The Record"}
          </p>
          <div className="mt-3 flex max-w-xs items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2">
            <span className="flex-1 truncate text-xs text-gray-400">{settings.newsletterPlaceholder || "Your email"}</span>
      ...
      <div className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t border-orange-100 pt-4">
        <p className="text-[10px] text-gray-500">© {new Date().getFullYear()} ExclusInsider. {settings.copyrightSuffix || "All rights reserved."}</p>
      </div>
    </div>
  );
}
