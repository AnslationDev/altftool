...
export const DEFAULT_FOOTER_SETTINGS = {
  newsletterHeading: "Off The Record",
...
/* ----------------------------- quick links -------------------------------- */
/* Promotes Footer.jsx's hardcoded `quickLinks` array. */
...
/* ------------------------------ resources -------------------------------- */
/* Promotes Footer.jsx's hardcoded `resources` array. The footer's services
   column stays derived from the `services` module — there is intentionally
   no separate services collection here. */
