...
export default function AnslicTeamPage() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "settings",
        summary: "Updated Anslic team page copy",
        route: "/anslic/team",
      });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Anslic Team</h1>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="lg:col-span-2">
              <Field label="Subtitle" error={settingsErrors.subtitle}>
                <textarea
                  ...
                  placeholder="The strategists, designers, and engineers behind Anslic."
                />
              </Field>
            </div>
            ...
            <Field label="SEO title" error={settingsErrors.seoTitle}>
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none transition focus:border-gray-900 focus:ring-2 focus:ring-gray-900/10"
                placeholder="Meet the Anslic Team"
              />
            </Field>
            ...
            <Field label="SEO description" error={settingsErrors.seoDescription}>
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none transition focus:border-gray-900 focus:ring-2 focus:ring-gray-900/10"
                placeholder="Get to know the people behind Anslic."
              />
            </Field>
          </div>
                  ...
                  <tr>
                    <td colSpan={5} className="px-4 py-14 text-center">
                      ...
                      <p className="mt-1 text-xs text-gray-400">
                        Add the first Anslic team member.
                      </p>
                    </td>
                  </tr>
                )}
      ...
      {deleteTarget ? (
        <DeleteConfirmModal
          ...
          message={`Delete "${deleteTarget.name}" from the Anslic team?`}
          confirmText="Delete"
