...
export default function AnslicNavbarPage() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "settings",
        summary: "Updated Anslic navbar settings",
        route: "/anslic/navbar",
      });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Anslic Navbar</h1>
                      ...
                      <tr>
                        <td colSpan={5} className="px-4 py-14 text-center">
                          ...
                          <p className="mt-1 text-xs text-gray-400">
                            Add the first Anslic navigation item.
                          </p>
                        </td>
                      </tr>
                    )}
      ...
      {deleteTarget ? (
        <DeleteConfirmModal
          ...
          message={`Delete "${deleteTarget.title}" from the Anslic navbar?`}
          confirmText="Delete"
