...
export const DEFAULT_SERVICES_SETTINGS = {
  ...
  seoTitle: "Our Services | Anslic",
  seoDescription: "Explore Anslic's full-funnel marketing and product services for growth-stage brands.",
};

/**
 * Fixed icon set the public frontend's ServiceCard.js looks up by string key.
 * Keep in sync with the iconMap in anslic/src/components/ServiceCard.js.
 */
