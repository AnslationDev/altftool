...
export default function AnslicServicesPage() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "settings",
        summary: "Updated Anslic services page copy",
        route: "/anslic/services",
      });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Anslic Services</h1>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <Field label="SEO title" error={settingsErrors.seoTitle}>
              <input
                ...
                className={inputClass}
                placeholder="Our Services | Anslic"
              />
            </Field>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-4 py-14 text-center">
                      ...
                      <p className="mt-1 text-xs text-gray-400">Add the first Anslic service.</p>
                    </td>
                  </tr>
                )}
              </tbody>
      ...
      {deleteTarget ? (
        <DeleteConfirmModal
          ...
          message={`Delete "${deleteTarget.title}" from Anslic services?`}
          confirmText="Delete"
