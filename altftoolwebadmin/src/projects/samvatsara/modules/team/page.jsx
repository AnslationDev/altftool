...
const EMPTY_MEMBER = {
  ...
  experience: "",
  skills: "",
  social: { linkedin: "", twitter: "", instagram: "", dribbble: "" },
  order: 0,
  active: true,
};
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Samvatsara Team</h1>
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Field label="Badge"><input value={settingsDraft.badge || ""} onChange={(event) => updateSettingsDraft("badge", event.target.value)} className={inputClass} placeholder="The people" /></Field>
            <Field label="Heading Lead"><input value={settingsDraft.headingLead || ""} onChange={(event) => updateSettingsDraft("headingLead", event.target.value)} className={inputClass} placeholder="Small studio," /></Field>
            <Field label="Heading Italic"><input value={settingsDraft.headingItalic || ""} onChange={(event) => updateSettingsDraft("headingItalic", event.target.value)} className={inputClass} placeholder="big care." /></Field>
          </div>
          <div className="mt-4">
      ...
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-4">
            ...
            <Field label="Skills (one per line)"><textarea value={form.skills} onChange={(event) => setField("skills", event.target.value)} rows={4} className={textareaClass} placeholder={"Brand Strategy\nCreative Direction\nClient Partnership"} /></Field>
            <div className="grid gap-3 sm:grid-cols-2">
