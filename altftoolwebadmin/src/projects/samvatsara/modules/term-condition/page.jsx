      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Samvatsara Terms & Conditions</h1>
              <p className="text-sm text-gray-500">Manage the terms hero, sections, and contact block.</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
