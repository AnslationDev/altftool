      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">DailyHnt FAQ</h1>
              <p className="text-sm text-gray-500">Manage the frequently asked questions shown on the DailyHnt site.</p>
            </div>
          </div>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#262626] bg-[#0a0a0a]">
      <div className="p-6">
        <div className="text-center">
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-[#c6f135]">FAQ</p>
          <h3 className="mx-auto mt-3 max-w-md text-2xl font-medium leading-tight text-[#ededed]">
        ...
        <div className="mt-8">
          {activeItems.length ? (
                ...
                return (
                  <div key={item.id}>
                    <div className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left">
                      <span className="text-base font-medium text-[#ededed]">{item.question}</span>
                      <span aria-hidden="true" className="shrink-0 font-mono text-lg text-[#c6f135]">
                        {isOpen ? "−" : "+"}
                      </span>
                    </div>
                    {isOpen ? (
                      <p className="px-5 pb-5 text-sm leading-relaxed text-[#8a8a8a]">{item.answer}</p>
                    ) : null}
                  </div>
                );
              })}
            ...
            <div className="border border-[#262626] bg-[#111111] p-8 text-center text-sm text-[#8a8a8a]">
              No active FAQs yet.
            </div>
          )}
        </div>
