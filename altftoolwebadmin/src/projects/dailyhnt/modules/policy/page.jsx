      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">DailyHnt Privacy Policy</h1>
      ...
      <div className="flex flex-col gap-6 p-6">
        {sections.length ? (
          sections.map((section, index) => (
            <div key={index}>
              <h4 className="text-base font-bold leading-snug" style={{ color: DH.text }}>
                {section.title || `Section ${index + 1}`}
              </h4>
              <p className="mt-2 text-sm leading-relaxed" style={{ color: DH.dim }}>
                {section.body}
              </p>
            </div>
          ))
