...
const ROUTE = "/campaignastra/home/testimonials";
...
export default function CampaignastraHomeTestimonialsPage() {
  ...
  async function saveSettings() {
    ...
    try {
      ...
      logAuditEvent({
        ...
        summary: "Updated Campaignastra home testimonials settings",
        changes: draft,
        route: ROUTE,
      });
    } catch (error) {
                ...
                {itemsLoading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-4 py-14 text-center">
                      ...
                      <p className="mt-1 text-xs text-gray-400">Add the first Campaignastra testimonial.</p>
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="mt-5 space-y-4">
          <Field label="Quote" error={errors.quote}>
            <textarea
              ...
              placeholder="Campaignastra completely transformed our pipeline."
            />
          </Field>
