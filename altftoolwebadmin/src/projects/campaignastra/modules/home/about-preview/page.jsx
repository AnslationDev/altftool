...
const ROUTE = "/campaignastra/home/about-preview";

export default function CampaignastraHomeAboutPreviewPage() {
  ...
  async function save() {
    ...
    try {
      ...
      logAuditEvent({
        ...
        summary: "Updated Campaignastra home about preview section",
        changes: cleanDraft,
        route: ROUTE,
      });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 pb-6">
      <ActionHeader
        ...
        description="Edit the “why choose Campaignastra” summary and bullet points."
