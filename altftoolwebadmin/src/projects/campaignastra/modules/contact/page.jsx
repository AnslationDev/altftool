...
export default function CampaignastraContactPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "settings",
        summary: "Updated Campaignastra contact settings",
        route: "/campaignastra/contact",
      });
    } catch (error) {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Campaignastra Contact</h1>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/campaignastra/contact/leads"
            ...
            <div className="space-y-4">
              <Field label="Email" error={errors.email}>
                <input
                  ...
                  className={inputClass}
                  placeholder="hello@campaignastra.com"
                />
              </Field>
