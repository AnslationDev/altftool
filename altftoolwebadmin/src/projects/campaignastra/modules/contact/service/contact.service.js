...
export const DEFAULT_CONTACT_SETTINGS = {
  ...
  seoTitle: "Contact Campaignastra — Let's Build Your Growth System",
  seoDescription:
    "Reach out to the Campaignastra team about partnerships, product questions, or new projects. We reply within one business day.",
};
