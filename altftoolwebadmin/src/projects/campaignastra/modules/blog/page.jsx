...
export default function CampaignastraBlogPage() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "settings",
        summary: "Updated Campaignastra blog page copy",
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Campaignastra Blog</h1>
          ...
          <Link
            href="/campaignastra/blog/add-article"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Field label="Subtitle">
              <input
                ...
                className={inputClass}
                placeholder="Playbooks and perspectives from the Campaignastra team."
              />
            </Field>
            <Field label="SEO title">
              <input
                ...
                className={inputClass}
                placeholder="Blog | Campaignastra"
              />
            </Field>
                    ...
                    <tr key={article.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-end gap-1">
                          <Link
                            href={`/campaignastra/blog/edit-article/${encodeURIComponent(article.id)}`}
                  ...
                  <tr>
                    <td colSpan={7} className="px-4 py-14 text-center">
                      ...
                      <p className="mt-1 text-xs text-gray-400">
                        Add the first Campaignastra blog article.
                      </p>
                    </td>
                  </tr>
                )}
      ...
      {deleteTarget ? (
        <DeleteConfirmModal
          ...
          message={`Delete "${deleteTarget.title}" from the Campaignastra blog?`}
          confirmText="Delete"
