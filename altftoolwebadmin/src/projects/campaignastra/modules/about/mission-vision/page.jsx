...
export default function CampaignastraAboutMissionVisionPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        summary: "Updated Campaignastra About mission & vision section",
        changes: draft,
        route: "/campaignastra/about/mission-vision",
      });
    } catch (error) {
