...
export default function CampaignastraAboutValuesPage() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "values",
        summary: "Updated Campaignastra About values section settings",
        changes: settingsDraft,
        route: "/campaignastra/about/values",
      });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
                  ...
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={5} className="px-4 py-14 text-center">
                        ...
                        <p className="mt-1 text-xs text-gray-400">Add the first Campaignastra value card.</p>
                      </td>
                    </tr>
                  )}
                </tbody>
      ...
      {deleteTarget ? (
        <DeleteConfirmModal
          ...
          message={`Delete "${deleteTarget.title}" from the Campaignastra About values?`}
          confirmText="Delete"
