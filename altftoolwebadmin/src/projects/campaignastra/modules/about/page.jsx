...
export default function CampaignastraAboutPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Campaignastra About</h1>
          ...
          {ABOUT_SECTIONS.map((section) => {
            ...
            return (
              <div key={section.key} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <Link
                  href={`/campaignastra/about/${section.key}`}
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-sm font-bold text-gray-900">projects / campaignastra / about</p>
