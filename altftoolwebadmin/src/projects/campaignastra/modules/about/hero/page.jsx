...
export default function CampaignastraAboutHeroPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logAuditEvent({
        ...
        entityId: "hero",
        summary: "Updated Campaignastra About hero section",
        changes: draft,
        route: "/campaignastra/about/hero",
      });
    } catch (error) {
            ...
            <div className="mt-5 space-y-4">
              <Field label="Eyebrow" error={errors.eyebrow}>
                <input
                  ...
                  placeholder="About Campaignastra"
                />
              </Field>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label="SEO description" error={errors.seoDescription}>
                  <input
                    ...
                    className={inputClass}
                    placeholder="Learn about Campaignastra's growth team"
                  />
                </Field>
              </div>
