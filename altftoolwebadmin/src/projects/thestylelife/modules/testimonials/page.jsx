...
export default function ThestylelifeTestimonialsPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">TheStyleLife Testimonials</h1>
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <CollectionManager
            ...
            fields={[
              ...
              { key: "role", label: "Role / Company", type: "text", half: true, placeholder: "CMO, Fielding & Co." },
