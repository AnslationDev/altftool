...
/**
 * TheStyleLife — Testimonials module data layer.
 *
 * Pure collection CRUD at `projects/thestylelife/testimonials`. Fields are
 * `name`/`role`/`quote`/`rating`, matching `data/testimonials.json` exactly
