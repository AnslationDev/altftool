...
export default function ThestylelifeFaqPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">TheStyleLife FAQ</h1>
            <p className="text-sm text-gray-500">Manage the sitewide questions in the home-page accordion. The section heading lives in the Home module.</p>
          </div>
        </div>
