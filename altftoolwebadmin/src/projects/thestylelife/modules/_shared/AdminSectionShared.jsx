...
/**
 * TheStyleLife — shared admin section primitives.
 *
 * Several TheStyleLife admin pages (home, about-us) are single pages
 ...
 * Shophobia's `modules/_shared/AdminSectionShared.jsx`.
 *
...
/* -------------------------------------------------------------------------- */
/* TheStyleLife preview theme (light editorial — paper/ink + single coral     */
/* accent, mirrors the live site's monochrome-plus-one-color palette; preview */
/* only, no real styling)                                                     */
/* -------------------------------------------------------------------------- */
export const HEX = {
  bg: "#fafaf7",
  raised: "#ffffff",
...
/** Renders a heading the way the TheStyleLife frontend does. */
