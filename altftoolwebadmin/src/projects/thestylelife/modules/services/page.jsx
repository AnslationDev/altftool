...
const EMPTY_SERVICE = {
  ...
  workflow: [],
  technologies: "",
  pricingCta: { title: "", description: "", ctaLabel: "" },
  faq: [],
  relatedSlugs: [],
  order: 0,
  active: true,
...
export default function ThestylelifeServicesPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">TheStyleLife Services</h1>
        ...
        <SettingsCard
          ...
          fields={[
            { key: "badge", label: "Badge", type: "text", placeholder: "The Services File" },
            ...
            { key: "heroSubcopy", label: "Hero Subcopy", type: "textarea", rows: 3 },
            {
              ...
              type: "image",
              upload: uploadServicesHeroImage,
              hint: "Shown beside the /services page hero copy.",
            },
            { key: "heroPrimaryCtaLabel", label: "Hero Primary CTA", type: "text", half: true },
            { key: "heroSecondaryCtaLabel", label: "Hero Secondary CTA", type: "text", half: true },
            { key: "detailHeroCtaLabel", label: "Detail Hero CTA", type: "text", half: true, placeholder: "Start Your Story" },
      ...
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 p-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Title"><input value={form.pricingCta.title} onChange={(event) => setPricingCta("title", event.target.value)} className={inputClass} placeholder="Ready to redesign your first impression?" /></Field>
              ...
              <Field label="CTA Label"><input value={form.pricingCta.ctaLabel} onChange={(event) => setPricingCta("ctaLabel", event.target.value)} className={inputClass} placeholder="Get a Proposal" /></Field>
            </div>
          </div>
