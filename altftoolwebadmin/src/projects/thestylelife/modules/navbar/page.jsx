...
export default function ThestylelifeNavbarPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">TheStyleLife Navbar</h1>
          ...
          <section className="space-y-5">
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              {loading ? (
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <Field label="CTA Label" error={errors.ctaLabel}><input value={settings.ctaLabel || ""} onChange={(event) => setSetting("ctaLabel", event.target.value)} className={inputClass} placeholder="Start Your Story" /></Field>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-3 text-xs text-gray-400">
                Falls back to the bundled Home / About / Services / Blog / Team / Contact Us links when empty.
              </p>
            </div>
          </section>
    ...
    <div className="overflow-hidden rounded-xl border" style={{ borderColor: HEX.border, background: HEX.bg }}>
      <div className="flex items-center justify-between gap-4 border-b px-5 py-4" style={{ borderColor: HEX.border }}>
        ...
        <span className="rounded-full px-3 py-1.5 text-[11px] font-semibold" style={{ background: HEX.accent, color: "#ffffff" }}>
          {settings.ctaLabel || "Start Your Story"}
        </span>
      </div>
    </div>
  );
