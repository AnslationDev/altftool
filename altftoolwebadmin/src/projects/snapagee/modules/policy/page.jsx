...
export default function SnapageePolicyPage() {
  return (
    <LegalDocPage
      icon={ScrollText}
      title="Snapagee Privacy Policy"
 ...
 *
 * NOTE: Snapagee's shape carries `subcopy` (the PageHeader description line
 * rendered directly under the page title) instead of a `lastUpdated` field —
              ...
              <>
                <Card eyebrow="Header" title="Page header">
                  <div className="flex flex-col gap-4">
                    ...
                    <Field label="Subcopy" hint="Appears directly under the page title on the live site, e.g. &quot;Last updated January 2026. ...&quot;">
