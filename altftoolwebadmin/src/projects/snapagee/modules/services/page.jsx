...
const EMPTY_SERVICE = {
  ...
  workflow: [],
  technologies: "",
  pricingCta: { title: "", description: "", buttonLabel: "" },
  faq: [],
  relatedSlugs: [],
  order: 0,
  active: true,
...
export default function SnapageeServicesPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Snapagee Services</h1>
              <p className="text-sm text-gray-500">Manage the service disciplines shown across the site.</p>
            </div>
          </div>
        ...
        <SettingsCard
          ...
          title="Page header, FAQ intro & shared detail headings"
          defaults={DEFAULT_SERVICES_SETTINGS}
          subscribe={subscribeServicesSettings}
          save={saveServicesSettings}
          errorLabel="services page settings"
          fields={[
            { key: "pageEyebrow", label: "Page Eyebrow", type: "text", half: true, placeholder: "What We Do" },
            { key: "pageHeading", label: "Page Heading", type: "text", half: true, required: true },
            { key: "pageDescription", label: "Page Description", type: "textarea", rows: 3 },
            { key: "listFaqEyebrow", label: "List FAQ Eyebrow", type: "text", half: true, placeholder: "Questions" },
            { key: "listFaqHeading", label: "List FAQ Heading", type: "text", half: true },
            { key: "listFaqDescription", label: "List FAQ Description", type: "textarea", rows: 2 },
            ...
            { key: "stackLabel", label: "Stack Label", type: "text", half: true, placeholder: "Tools & Technologies" },
      ...
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-6">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Slug" error={errors.slug}><input value={form.slug} onChange={(event) => setSlug(event.target.value)} className={inputClass} placeholder="web-design-development" /></Field>
            <Field label="Icon">
          ...
          <div className="rounded-xl border border-gray-200 p-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Title"><input value={form.pricingCta.title} onChange={(event) => setPricingCta("title", event.target.value)} className={inputClass} placeholder="Ready to get started?" /></Field>
              <Field label="Description"><input value={form.pricingCta.description} onChange={(event) => setPricingCta("description", event.target.value)} className={inputClass} placeholder="Every engagement starts with a working session, not a boilerplate quote." /></Field>
              <Field label="Button Label"><input value={form.pricingCta.buttonLabel} onChange={(event) => setPricingCta("buttonLabel", event.target.value)} className={inputClass} placeholder="Get a Proposal" /></Field>
            </div>
          </div>
