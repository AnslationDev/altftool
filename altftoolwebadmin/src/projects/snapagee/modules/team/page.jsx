...
export default function SnapageeTeamPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Snapagee Team</h1>
        ...
        <SettingsCard
          ...
          fields={[
            ...
            { key: "relatedEyebrow", label: "Related Eyebrow", type: "text", half: true, placeholder: "The Rest of the Team" },
            { key: "relatedHeading", label: "Related Heading", type: "text", half: true, placeholder: "More senior operators" },
            { key: "detailCtaLabel", label: "Detail Page CTA Label", type: "text", placeholder: "Start a Project" },
          ]}
        />
      ...
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 space-y-5">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Slug" error={errors.slug}><input value={form.slug} onChange={(event) => setSlug(event.target.value)} className={inputClass} placeholder="jordan-blake" /></Field>
            ...
            <Field label="Initials" hint="Avatar fallback shown when no portrait is set."><input value={form.initials} onChange={(event) => setField("initials", event.target.value)} className={inputClass} placeholder="JB" /></Field>
