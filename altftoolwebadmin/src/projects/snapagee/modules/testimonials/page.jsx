...
export default function SnapageeTestimonialsPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Snapagee Testimonials</h1>
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <CollectionManager
            ...
            fields={[
              ...
              { key: "role", label: "Role", type: "text", half: true, placeholder: "Founder" },
              { key: "company", label: "Company", type: "text", half: true, placeholder: "Northwind Co." },
            ]}
            columns={[
      ...
      <div className="flex flex-col items-center gap-3 px-6 py-8 text-center">
        {first ? (
          <>
            ...
            <p className="text-[10px] uppercase tracking-wide" style={{ color: HEX.dim }}>
              {[first.role, first.company].filter(Boolean).join(", ")}
            </p>
