...
/**
 * Snapagee — shared admin section primitives.
 *
 * Several Snapagee admin pages (home) are single pages composed of multiple
 * sections, each either a singleton settings document or a settings document
 * paired with an ordered collection. This file centralizes the config-driven
 * `SettingsCard` / `CollectionManager` pattern so those pages don't each
 * hand-roll the same table/modal code — mirrors thestylelife's
 * `modules/_shared/AdminSectionShared.jsx`.
 *
...
/* -------------------------------------------------------------------------- */
/* Snapagee preview theme (ink/paper + indigo/lime accents, mirrors the live  */
/* site's `app/globals.css` tokens; preview only, no real styling dependency) */
/* -------------------------------------------------------------------------- */
export const HEX = {
  bg: "#f4f4f8",
  raised: "#ffffff",
...
/** Renders a heading the way the Snapagee frontend does. */
