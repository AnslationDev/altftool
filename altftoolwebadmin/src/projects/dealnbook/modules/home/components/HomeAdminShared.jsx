...
/**
 * Dealnbook — Home admin shared primitives.
 *
 * The Dealnbook home page is a single admin page composed of several
 * sections (12 total). Each section is either a singleton settings document
 ...
 * used across the other admin modules (adapted from offerhoppr's home module).
 *
 ...
 * rows) for simple `string[]` fields such as hero headline lines or about
