      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Dealnbook Blog</h1>
      ...
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[260px_1fr]">
          <div>
            ...
            <div className="mt-3">
              <Field label="Cover Gradient (optional)"><input value={form.coverGradient} onChange={(event) => setField("coverGradient", event.target.value)} className={inputClass} placeholder="from-orange-400 to-amber-500" /></Field>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Category"><input value={form.category} onChange={(event) => setField("category", event.target.value)} className={inputClass} placeholder="Travel Deals" /></Field>
            ...
            <Field label="Tags (one per line)"><textarea value={form.tags} onChange={(event) => setField("tags", event.target.value)} rows={3} className={textareaClass} placeholder={"Coupons\nHotels"} /></Field>
          </div>
        </div>
