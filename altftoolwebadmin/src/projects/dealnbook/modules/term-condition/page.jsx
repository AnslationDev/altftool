...
import { ArrowDown, ArrowUp, Eye, Handshake, Loader2, Plus, Save, Trash2 } from "lucide-react";
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Dealnbook Terms & Conditions</h1>
              <p className="text-sm text-gray-500">Manage the terms title, effective date, and sections.</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
