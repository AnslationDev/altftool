      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Dealnbook Testimonials</h1>
              <p className="text-sm text-gray-500">Manage the customer testimonials shown on the Dealnbook site.</p>
            </div>
          </div>
            ...
            <div className="mt-4 overflow-x-auto rounded-xl border border-gray-200">
              <div className="min-w-[620px]">
                <div className="grid grid-cols-[1fr_1fr_100px_80px_120px] bg-gray-50 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-gray-400">
                  <span>Name</span><span>Role / Company</span><span>Rating</span><span>Status</span><span>Actions</span>
                </div>
                {loading ? (
                  ...
                  <div key={item.id} className="grid grid-cols-[1fr_1fr_100px_80px_120px] items-center gap-3 border-t border-gray-100 px-3 py-3 text-sm">
                    ...
                    <p className="truncate text-xs font-semibold text-gray-500">{[item.role, item.company].filter(Boolean).join(" · ")}</p>
