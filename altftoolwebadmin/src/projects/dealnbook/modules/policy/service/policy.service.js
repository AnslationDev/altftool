...
export const DEFAULT_POLICY = {
  ...
  sections: [
    { title: "1. What We Collect", body: "When you browse Dealnbook, sign up for our newsletter, or submit the contact form, we collect the information you provide directly — typically your name and email address — along with standard, aggregated analytics data such as pages visited and general location." },
    ...
    { title: "3. Cookies & Tracking", body: "Dealnbook uses cookies and similar technologies to remember your preferences, measure traffic, and track when coupon codes are used. You can disable cookies through your browser settings at any time, though some features may not work as intended." },
    { title: "4. Affiliate Disclosure", body: "Some links on Dealnbook are affiliate links. If you make a purchase or booking through one of these links, we may earn a commission at no extra cost to you. This never affects which offers we choose to feature." },
    ...
    { title: "9. Contact Us", body: "Questions about this policy can be sent to hello@dealnbook.com — we'll get back to you personally." },
  ],
};
