    ...
    <PageShell>
      <Stack gap="lg">
        <PageHeader
          ...
          meta={<StatusBadge tone="success">Shared</StatusBadge>}
          actions={
            <ThemeModeSelector
              value={themeMode}
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            ...
            <Card className="p-5">
              <Stack>
                ...
                <Field label="API endpoint" error="Enter a valid HTTPS URL.">
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            <Stack>
              ...
              <Alert tone="success" title="Healthy">
                Public and admin applications resolve the same foundation.
              </Alert>
