  ...
  if (loading) {
    return (
      <div className="h-screen flex items-center justify-center" style={{ background: "var(--background)" }}>
        <div className="card px-5 py-3 flex items-center gap-2.5 text-sm" style={{ color: "var(--muted)" }}>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8" style={{ boxShadow: "var(--shadow-md)" }}>
          ...
          <button
            ...
            disabled={busy}
            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 text-sm font-medium transition-colors disabled:opacity-50"
            style={{
          ...
          <form onSubmit={login} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={busy}
              className="btn btn-primary w-full py-2.5 mt-1 disabled:opacity-50"
            >
              {submitting ? (
